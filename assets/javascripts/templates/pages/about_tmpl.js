...
<p>DevDocs is free and <a href="https://github.com/khulnasoft/devtools">open source</a>. It was created by <a href="https://thibaut.me">Thibaut Courouble</a> and is operated by <a href="https://www.freecodecamp.org/">freeCodeCamp</a>.
<p>To keep up-to-date with the latest news:
<ul>
  <li>Follow <a href="https://twitter.com/DevDocs">@DevDocs</a> on Twitter
  <li>Watch the repository on <a href="https://github.com/khulnasoft/devtools/subscription">GitHub</a> <iframe class="_github-btn" src="https://ghbtns.com/github-btn.html?user=freeCodeCamp&repo=devdocs&type=watch&count=true" allowtransparency="true" frameborder="0" scrolling="0" width="100" height="20" tabindex="-1"></iframe>
  <li>Join the <a href="https://discord.gg/PRyKn3Vbay">Discord</a> chat room
</ul>

<h2 class="_block-heading" id="copyright">Copyright and License</h2>
<p class="_note">
  <strong>Copyright 2013&ndash;2024 Thibaut Courouble and <a href="https://github.com/khulnasoft/devtools/graphs/contributors">other contributors</a></strong><br>
  This software is licensed under the terms of the Mozilla Public License v2.0.<br>
  You may obtain a copy of the source code at <a href="https://github.com/khulnasoft/devtools">github.com/khulnasoft/devtools</a>.<br>
  For more information, see the <a href="https://github.com/khulnasoft/devtools/blob/devdocs/COPYRIGHT">COPYRIGHT</a>
  and <a href="https://github.com/khulnasoft/devtools/blob/devdocs/LICENSE">LICENSE</a> files.
...
<dl>
  ...
  <dd>You can suggest and vote for new docs on the <a href="https://trello.com/b/6BmTulfx/devdocs-documentation">Trello board</a>.<br>
      If you have a specific feature request, add it to the <a href="https://github.com/khulnasoft/devtools/issues">issue tracker</a>.<br>
      Otherwise, come talk to us in the <a href="https://discord.gg/PRyKn3Vbay">Discord</a> chat room.
  <dt>Where can I report bugs?
  <dd>In the <a href="https://github.com/khulnasoft/devtools/issues">issue tracker</a>. Thanks!
</dl>
