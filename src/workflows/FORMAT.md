...
_Compatibility Note_: DevTools is still in Beta and this format is subject to change.
...
-----
The description of the argument. This is surfaced in both commands.dev and DevTools to help users fill in Workflow arguments. Optional
