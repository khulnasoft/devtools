...
<p align="center">
  <a href="https://enclosed.khulnasoft.com">Demo</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="https://devtools.khulnasoft.com/enclosed-docs">Docs</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="https://www.npmjs.com/package/@khulnasoft.com/enclosed">CLI</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="https://devtools.khulnasoft.com/enclosed-docs/self-hosting/docker">Self-hosting</a>
</p>
...
A live instance is available at [enclosed.khulnasoft.com](https://enclosed.khulnasoft.com).

[![Enclosed](./.github/enclosed-mockup.png)](https://enclosed.khulnasoft.com)
...
Please refer to the [self-hosting documentation](https://devtools.khulnasoft.com/enclosed-docs/self-hosting/docker) for more information on how to configure and run the application.
For example:

- [Setup persistent storage](https://devtools.khulnasoft.com/enclosed-docs/self-hosting/docker#docker-with-volume-persistence)
- [Use rootless image](https://devtools.khulnasoft.com/enclosed-docs/self-hosting/docker#rootless-and-non-rootless-docker-images)
- [Use Docker Compose](https://devtools.khulnasoft.com/enclosed-docs/self-hosting/docker-compose)

### Configuration

You can refer to the [configuration documentation](https://devtools.khulnasoft.com/enclosed-docs/self-hosting/configuration) for more information on how to configure the application.
...
```bash
# with npm
npm install -g @khulnasoft.com/enclosed

# with yarn
yarn global add @khulnasoft.com/enclosed

# with pnpm
pnpm add -g @khulnasoft.com/enclosed
```
...
```bash
# By default, the CLI uses the public instance at enclosed.khulnasoft.com
enclosed config set instance-url https://enclosed.khulnasoft.com
```
...
You can find easy-to-pick-up tasks with the [`good first issue` label](https://github.com/khulnasoft/devtools/issues?q=sort%3Aupdated-desc+is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22).
...
[![Contributors](https://contrib.rocks/image?repo=khulnasoft/devtools)](https://github.com/khulnasoft/devtools/graphs/contributors)
...
The [live instance](https://enclosed.khulnasoft.com) of Enclosed is hosted on [Cloudflare Pages](https://pages.cloudflare.com/) using [Cloudflare KV](https://developers.cloudflare.com/kv/) for storage.
