...
describe('helpers', () => {
  ...
  describe('getRepoUrlFromLocationAnnotation', () => {
    it.each`
      ...
      ${'https://github.com/khulnasoft/devtools'}                                | ${'https://github.com/khulnasoft/devtools'}                                | ${undefined}
      ${'https://github.com/khulnasoft/devtools/tree/main/examples/techdocs/'}   | ${'https://github.com/khulnasoft/devtools/tree/main/examples/techdocs/'}   | ${'https://github.com/khulnasoft/devtools/edit/main/examples/techdocs/docs'}
      ${'https://github.com/khulnasoft/devtools/tree/main/examples/techdocs'}    | ${'https://github.com/khulnasoft/devtools/tree/main/examples/techdocs'}    | ${'https://github.com/khulnasoft/devtools/edit/main/examples/techdocs/docs'}
      ${'https://github.com/khulnasoft/devtools/tree/main/'}                     | ${'https://github.com/khulnasoft/devtools/tree/main/'}                     | ${'https://github.com/khulnasoft/devtools/edit/main/docs'}
      ${'https://gitlab.com/khulnasoft/devtools'}                                | ${'https://gitlab.com/khulnasoft/devtools'}                                | ${undefined}
      ${'https://gitlab.com/khulnasoft/devtools/-/blob/main/examples/techdocs/'} | ${'https://gitlab.com/khulnasoft/devtools/-/blob/main/examples/techdocs/'} | ${'https://gitlab.com/khulnasoft/devtools/-/edit/main/examples/techdocs/docs'}
      ${'https://gitlab.com/khulnasoft/devtools/-/blob/main/'}                   | ${'https://gitlab.com/khulnasoft/devtools/-/blob/main/'}                   | ${'https://gitlab.com/khulnasoft/devtools/-/edit/main/docs'}
    ...
    it.each`
      url                                                                        | repo_url                                                                   | edit_uri
      ${'https://github.com/khulnasoft/devtools/tree/main/examples/techdocs/'}   | ${'https://github.com/khulnasoft/devtools/tree/main/examples/techdocs/'}   | ${'https://github.com/khulnasoft/devtools/edit/main/examples/techdocs/custom/folder'}
      ${'https://github.com/khulnasoft/devtools/tree/main/'}                     | ${'https://github.com/khulnasoft/devtools/tree/main/'}                     | ${'https://github.com/khulnasoft/devtools/edit/main/custom/folder'}
      ${'https://gitlab.com/khulnasoft/devtools/-/blob/main/examples/techdocs/'} | ${'https://gitlab.com/khulnasoft/devtools/-/blob/main/examples/techdocs/'} | ${'https://gitlab.com/khulnasoft/devtools/-/edit/main/examples/techdocs/custom/folder'}
      ${'https://gitlab.com/khulnasoft/devtools/-/blob/main/'}                   | ${'https://gitlab.com/khulnasoft/devtools/-/blob/main/'}                   | ${'https://gitlab.com/khulnasoft/devtools/-/edit/main/custom/folder'}
    `(
    ...
    it.each`
      url
      ${'https://bitbucket.org/khulnasoft/devtools/src/master/examples/techdocs/'}
      ${'https://bitbucket.org/khulnasoft/devtools/src/master/'}
  ...
  describe('patchMkdocsYmlPreBuild', () => {
    ...
    it('should add edit_uri to mkdocs.yml', async () => {
      const parsedLocationAnnotation: ParsedLocationAnnotation = {
        type: 'url',
        target: 'https://github.com/khulnasoft/devtools',
      };
      ...
      expect(updatedMkdocsYml.toString()).toContain(
        'repo_url: https://github.com/khulnasoft/devtools',
      );
    });
    ...
    it('should not override existing edit_uri in mkdocs.yml', async () => {
      ...
      expect(updatedMkdocsYml.toString()).toContain(
        'edit_uri: https://github.com/khulnasoft/devtools/edit/main/docs',
      );
      expect(updatedMkdocsYml.toString()).not.toContain(
