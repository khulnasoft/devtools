...
describe('OpenStackSwiftPublish', () => {
  ...
  describe('fetchTechDocsMetadata', () => {
      ...
      mockDir.setContent({
        [entityRootDir]: {
          'techdocs_metadata.json':
            '{"site_name": "devtools", "site_description": "site_content", "etag": "etag", "build_timestamp": 612741599}',
        },
      });
    ...
    it('should return tech docs metadata when json encoded with single quotes', async () => {
      ...
      mockDir.setContent({
        [entityRootDir]: {
          'techdocs_metadata.json': `{'site_name': 'devtools', 'site_description': 'site_content', 'etag': 'etag', 'build_timestamp': 612741599}`,
        },
      });
