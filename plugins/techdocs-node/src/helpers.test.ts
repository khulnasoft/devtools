...
import { Entity, getEntitySourceLocation } from '@devtools/catalog-model';
import { ConfigReader } from '@devtools/config';
import { ScmIntegrations } from '@devtools/integration';
import os from 'os';
import path from 'path';
import { Readable } from 'stream';
import { TECHDOCS_ANNOTATION } from '@devtools/plugin-techdocs-common';
import {
...
jest.mock('@devtools/catalog-model', () => ({
  ...jest.requireActual('@devtools/catalog-model'),
...
const goodAnnotation = {
  annotations: {
    [TECHDOCS_ANNOTATION]:
      'url:https://github.com/khulnasoft/devtools/blob/master/subfolder/',
  },
};
...
describe('parseReferenceAnnotation', () => {
  it('should parse annotation', () => {
    ...
    expect(parsedLocationAnnotation.target).toBe(
      'https://github.com/khulnasoft/devtools/blob/master/subfolder/',
    );
  });
