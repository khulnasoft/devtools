...
import { CatalogIcon, Link } from '@devtools/core-components';
import { TestApiProvider, wrapInTestApp } from '@devtools/test-utils';
import { createPlugin, createRouteRef } from '@devtools/core-plugin-api';
import { SearchQuery, SearchResultSet } from '@devtools/plugin-search-common';
