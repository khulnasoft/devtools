  ...
  proxy?: {
    ...
    endpoints?: {
      [key: string]:
        ...
        | {
             ...
             *
             * - 'require': Callers must provide Devtools user or service
             *   credentials with each request. The credentials are not
             *   forwarded to the proxy target.
             * - 'forward': Callers must provide Devtools user or service
             *   credentials with each request, and those credentials are
             *   forwarded to the proxy target.
             * - 'dangerously-allow-unauthenticated': No Devtools credentials
             ...
             *   block non-Devtools-blessed callers.
             *
    ...
    [key: string]:
      ...
      | {
           ...
           *   credentials with each request, and those credentials are
           *   forwarded to the proxy target.
           * - 'dangerously-allow-unauthenticated': No Devtools credentials are
