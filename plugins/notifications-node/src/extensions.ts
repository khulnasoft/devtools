...
} from '@devtools/plugin-notifications-common';
 ...
 * 5. Notification is saved to the database and sent to the Devtools UI
...
export interface NotificationProcessor {
  ...
  /**
   * Pre-process notification before sending it to Devtools UI.
   *
   * Can be used to send the notification to external services or to decorate the notification with additional
   * information. The notification is saved to database and sent to Devtools UI after all pre-process functions
   ...
   * notification BEFORE the notification has been sent to the Devtools UI.
   *
  ...
  /**
   * Post process notification after sending it to Devtools UI.
   *
   ...
   * broadcast notification AFTER the notification has been sent to the Devtools UI.
   *
   * @param notification - The notification to send
   * @param options - The options to send the notification
   */
...
/**
 * @public
 * @deprecated Please import from `@devtools/plugin-notifications-common` instead
 */
