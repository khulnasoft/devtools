...
import { RELATION_OWNED_BY, CompoundEntityRef } from '@devtools/catalog-model';
import { Header, HeaderLabel } from '@devtools/core-components';
import { useRouteRef, configApiRef, useApi } from '@devtools/core-plugin-api';
 ...
 *
 * @public
 * @deprecated No need to pass down properties anymore. The component consumes data from `TechDocsReaderPageContext` instead. Use the {@link @devtools/plugin-techdocs-react#useTechDocsReaderPage} hook for custom header.
 */
...
export const TechDocsReaderPageHeader = (
  ...
  const appTitle = configApi.getOptional('app.title') || 'Devtools';
