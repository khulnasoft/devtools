...
import { Page } from '@devtools/core-components';
import {
  configApiRef,
  discoveryApiRef,
  fetchApiRef,
...
jest.mock('@devtools/core-components', () => ({
  ...jest.requireActual('@devtools/core-components'),
  Page: jest.fn(),
}));
...
describe('<TechDocsReaderPage />', () => {
  ...
  beforeEach(() => {
    const realPage = jest.requireActual('@devtools/core-components').Page;
