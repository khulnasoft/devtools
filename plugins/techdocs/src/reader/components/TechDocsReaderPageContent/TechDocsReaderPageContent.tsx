...
import { Content, ErrorPage, Progress } from '@devtools/core-components';
...
export type TechDocsReaderPageContentProps = {
  /**
   * @deprecated No need to pass down entityRef as property anymore. Consumes the entityName from `TechDocsReaderPageContext`. Use the {@link @devtools/plugin-techdocs-react#useTechDocsReaderPage} hook for custom reader page content.
   */
