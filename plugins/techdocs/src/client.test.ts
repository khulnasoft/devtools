...
import { mockApis, MockFetchApi } from '@devtools/test-utils';
...
describe('TechDocsStorageClient', () => {
  const mockBaseUrl = 'http://devtools:9191/api/techdocs';
  ...
  describe('syncEntityDocs', () => {
    it('should create eventsource with fetch', async () => {
      ...
      expect(mockFetchEventSource).toHaveBeenCalledWith(
        'http://devtools:9191/api/techdocs/sync/default/Component/test-component',
        {
