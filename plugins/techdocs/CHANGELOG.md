...
- Updated dependencies
  ...
  - @devtools/plugin-techdocs-react@0.1.0-next.0
...
- c689d7a94c: Switched to using `CatalogFilterLayout` from `@devtools/plugin-catalog-react`.
...
- 45e1706328: Continuation of [#9569](https://github.com/khulnasoft/devtools/pull/9569), fix Tech Docs Reader search position to be the same width as content.
...
- 742434a6ba: Fixed a bug where links to files within a TechDocs site that use the `download` attribute would result in a 404 in cases where the TechDocs backend and Devtools frontend application are on the same host.
...
- aecfe4f403: Make `TechDocsClient` and `TechDocsStorageClient` use the `FetchApi`. You now
  ...
  ```diff
  +import { fetchApiRef } from '@devtools/core-plugin-api';
...
- 1628ca3f49: Fix an issue where the TechDocs sidebar is hidden when the Devtools sidebar is pinned at smaller screen sizes
- Updated dependencies
...
- Updated dependencies
  - @devtools/plugin-search@0.5.3
  - @devtools/plugin-catalog@0.7.6
...
- d90dad84b0: Switch to using `LogViewer` component from `@devtools/core-components` to display build logs.
...
- 434dfc5d4: Display [metadata.title](https://devtools.khulnasoft.com/docs/features/software-catalog/descriptor-format#title-optional) for components on the TechDocs homepage, if defined; otherwise fall back to `metadata.name` as displayed before.
- Updated dependencies
...
- 11c370af2: Optimize load times by only fetching entities with the `devtools.khulnasoft.com/techdocs-ref` annotation
...
- 94a54dd47: Added a `migrateDocsCase()` method to TechDocs publishers, along with
  ...
  See [#4367](https://github.com/khulnasoft/devtools/issues/4367) for details.
...
- bebd1c4fe: Remove the `@devtools/techdocs-common` dependency to not pull in backend config schemas in the frontend.
...
- Updated dependencies [4e0b5055a]
  ...
  - @devtools/techdocs-common@0.4.5
...
- Updated dependencies [ca4a904f6]
  - @devtools/techdocs-common@0.4.4
...
- Updated dependencies [61299519f]
  ...
  - @devtools/techdocs-common@0.4.3
  - @devtools/core@0.7.0
...
- Updated dependencies [2c1f2a7c2]
  ...
  - @devtools/techdocs-common@0.4.2
...
- Updated dependencies [688b73110]
  - @devtools/core@0.6.2
  - @devtools/techdocs-common@0.4.1
...
- Updated dependencies [08142b256]
- Updated dependencies [b51ee6ece]
  - @devtools/techdocs-common@0.4.0
...
- Updated dependencies [11cb5ef94]
  - @devtools/techdocs-common@0.3.7
  - @devtools/core@0.6.0
...
- Updated dependencies [a93f42213]
  ...
  - @devtools/techdocs-common@0.3.5
...
- a6f9dca0d: Remove dependency on `@devtools/core-api`. No plugin should ever depend on that package; it's an internal concern whose important bits are re-exported by `@devtools/core` which is the public facing dependency to use.
...
- Updated dependencies [147fadcb9]
  - @devtools/techdocs-common@0.3.3
  - @devtools/catalog-model@0.6.1
  - @devtools/plugin-catalog@0.2.11
  - @devtools/core@0.4.4
...
- Updated dependencies [27f2af935]
  - @devtools/core-api@0.2.8
  - @devtools/core@0.4.3
  - @devtools/plugin-catalog@0.2.9
  - @devtools/techdocs-common@0.3.1
...
- Updated dependencies [a8573e53b]
  ...
  - @devtools/techdocs-common@0.3.0
...
- dae4f3983: _Breaking changes_
  ...
  1. Added option to use Google Cloud Storage as a choice to store the static generated files for TechDocs.
     ...
     Step-by-step guide to configure GCS is available here https://devtools.khulnasoft.com/docs/features/techdocs/using-cloud-storage
  ...
  5. Parts of `@devtools/plugin-techdocs-backend` have been moved to a new package `@devtools/techdocs-common` to generate docs. Also to publish docs
     to-and-fro between TechDocs and a storage (either local or external). However, a Devtools app does NOT need to import the `techdocs-common` package -
     app should only import `@devtools/plugin-techdocs` and `@devtools/plugin-techdocs-backend`.

  _Patch changes_

  1. See all of TechDocs config options and its documentation https://devtools.khulnasoft.com/docs/features/techdocs/configuration
...
- Updated dependencies [ac3560b42]
  ...
  - @devtools/techdocs-common@0.2.0
  - @devtools/core@0.4.1
  - @devtools/core-api@0.2.6
...
- 57b54c8ed: While techdocs fetches site name and metadata for the component, the page title was displayed as '[object Object] | Devtools'. This has now been fixed to display the component ID if site name is not present or being fetched.
