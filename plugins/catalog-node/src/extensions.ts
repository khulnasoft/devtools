...
import { Entity, Validators } from '@devtools/catalog-model';
import {
  CatalogProcessor,
...
export interface CatalogLocationsExtensionPoint {
  /**
   * Allows setting custom location types, such as showcased in: https://devtools.khulnasoft.com/docs/features/software-catalog/external-integrations/#creating-a-catalog-data-reader-processor
