...
import { configApiRef, useApi } from '@devtools/core-plugin-api';
...
export const ImportInfoCard = (props: ImportInfoCardProps) => {
  const {
    exampleLocationUrl = 'https://github.com/khulnasoft/devtools/blob/master/catalog-info.yaml',
    exampleRepositoryUrl = 'https://github.com/khulnasoft/devtools',
  } = props;

  const configApi = useApi(configApiRef);
  const appTitle = configApi.getOptionalString('app.title') || 'Devtools';
  ...
  return (
    <InfoCard
      ...
      deepLink={{
        ...
        link: 'https://devtools.khulnasoft.com/docs/features/software-catalog/',
      }}
    >
