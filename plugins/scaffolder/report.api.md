## API Report File for "@devtools/plugin-scaffolder"
...
import { createScaffolderFieldExtension as createScaffolderFieldExtension_2 } from '@devtools/plugin-scaffolder-react';
import { createScaffolderLayout as createScaffolderLayout_2 } from '@devtools/plugin-scaffolder-react';
import { CustomFieldExtensionSchema as CustomFieldExtensionSchema_2 } from '@devtools/plugin-scaffolder-react';
import { CustomFieldValidator as CustomFieldValidator_2 } from '@devtools/plugin-scaffolder-react';
...
import { FieldExtensionComponent as FieldExtensionComponent_2 } from '@devtools/plugin-scaffolder-react';
import { FieldExtensionComponentProps as FieldExtensionComponentProps_2 } from '@devtools/plugin-scaffolder-react';
import { FieldExtensionOptions as FieldExtensionOptions_2 } from '@devtools/plugin-scaffolder-react';
import { FieldSchema as FieldSchema_2 } from '@devtools/plugin-scaffolder-react';
import { FieldValidation } from '@rjsf/utils';
import { FormProps } from '@devtools/plugin-scaffolder-react';
import { IdentityApi } from '@devtools/core-plugin-api';
import { JSX as JSX_2 } from 'react';
import { LayoutOptions as LayoutOptions_2 } from '@devtools/plugin-scaffolder-react';
import { LayoutTemplate as LayoutTemplate_2 } from '@devtools/plugin-scaffolder-react';
import { ListActionsResponse as ListActionsResponse_2 } from '@devtools/plugin-scaffolder-react';
import { LogEvent as LogEvent_2 } from '@devtools/plugin-scaffolder-react';
import { Observable } from '@devtools/types';
import { PathParams } from '@devtools/core-plugin-api';
...
import { ScaffolderApi as ScaffolderApi_2 } from '@devtools/plugin-scaffolder-react';
import { ScaffolderDryRunOptions as ScaffolderDryRunOptions_2 } from '@devtools/plugin-scaffolder-react';
import { ScaffolderDryRunResponse as ScaffolderDryRunResponse_2 } from '@devtools/plugin-scaffolder-react';
import { ScaffolderGetIntegrationsListOptions as ScaffolderGetIntegrationsListOptions_2 } from '@devtools/plugin-scaffolder-react';
import { ScaffolderGetIntegrationsListResponse as ScaffolderGetIntegrationsListResponse_2 } from '@devtools/plugin-scaffolder-react';
import { ScaffolderOutputLink } from '@devtools/plugin-scaffolder-react';
import { ScaffolderScaffoldOptions as ScaffolderScaffoldOptions_2 } from '@devtools/plugin-scaffolder-react';
import { ScaffolderScaffoldResponse as ScaffolderScaffoldResponse_2 } from '@devtools/plugin-scaffolder-react';
import { ScaffolderStreamLogsOptions as ScaffolderStreamLogsOptions_2 } from '@devtools/plugin-scaffolder-react';
import { ScaffolderTask as ScaffolderTask_2 } from '@devtools/plugin-scaffolder-react';
import { ScaffolderTaskOutput as ScaffolderTaskOutput_2 } from '@devtools/plugin-scaffolder-react';
import { ScaffolderTaskStatus as ScaffolderTaskStatus_2 } from '@devtools/plugin-scaffolder-react';
import { ScaffolderUseTemplateSecrets as ScaffolderUseTemplateSecrets_2 } from '@devtools/plugin-scaffolder-react';
...
import { TemplateListPageProps } from '@devtools/plugin-scaffolder/alpha';
import { TemplateParameterSchema as TemplateParameterSchema_2 } from '@devtools/plugin-scaffolder-react';
import { TemplateWizardPageProps } from '@devtools/plugin-scaffolder/alpha';
import { z } from 'zod';
...
// @public
export const scaffolderPlugin: DevtoolsPlugin<
  {
