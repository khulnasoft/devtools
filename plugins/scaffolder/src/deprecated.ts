...
/**
 * @public
 * @deprecated use import from `{@link @devtools/plugin-scaffolder#scaffolderPlugin}.routes.root` instead.
 */
export const rootRouteRef = rootRouteRefTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#createScaffolderFieldExtension} instead as this has now been moved.
 */
export const createScaffolderFieldExtension =
  createScaffolderFieldExtensionTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderFieldExtensions} instead as this has now been moved.
 */
export const ScaffolderFieldExtensions = ScaffolderFieldExtensionsTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#useTemplateSecrets} instead as this has now been moved.
 */
export const useTemplateSecrets = useTemplateSecretsTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#scaffolderApiRef} instead as this has now been moved.
 */
export const scaffolderApiRef = scaffolderApiRefTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderApi} instead as this has now been moved.
 */
export type ScaffolderApi = ScaffolderApiTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderUseTemplateSecrets} instead as this has now been moved.
 */
export type ScaffolderUseTemplateSecrets = ScaffolderUseTemplateSecretsTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#TemplateParameterSchema} instead as this has now been moved.
 */
export type TemplateParameterSchema = TemplateParameterSchemaTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#CustomFieldExtensionSchema} instead as this has now been moved.
 */
export type CustomFieldExtensionSchema = CustomFieldExtensionSchemaTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#CustomFieldValidator} instead as this has now been moved.
 */
export type CustomFieldValidator<TReturnFieldData> =
  CustomFieldValidatorTemp<TReturnFieldData>;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#FieldExtensionOptions} instead as this has now been moved.
 */
export type FieldExtensionOptions = FieldExtensionOptionsTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#FieldExtensionComponentProps} instead as this has now been moved.
 */
...
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#FieldExtensionComponent} instead as this has now been moved.
 */
export type FieldExtensionComponent<_TReturnValue, _TInputProps> =
  FieldExtensionComponentTemp<_TReturnValue, _TInputProps>;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ListActionsResponse} instead as this has now been moved.
 */
export type ListActionsResponse = ListActionsResponseTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#LogEvent} instead as this has now been moved.
 */
export type LogEvent = LogEventTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderDryRunOptions} instead as this has now been moved.
 */
export type ScaffolderDryRunOptions = ScaffolderDryRunOptionsTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderDryRunResponse} instead as this has now been moved.
 */
export type ScaffolderDryRunResponse = ScaffolderDryRunResponseTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderGetIntegrationsListOptions} instead as this has now been moved.
 */
export type ScaffolderGetIntegrationsListOptions =
  ScaffolderGetIntegrationsListOptionsTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderGetIntegrationsListResponse} instead as this has now been moved.
 */
export type ScaffolderGetIntegrationsListResponse =
  ScaffolderGetIntegrationsListResponseTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderOutputlink} instead as this has now been moved.
 */
export type ScaffolderOutputlink = ScaffolderOutputLinkTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderScaffoldOptions} instead as this has now been moved.
 */
export type ScaffolderScaffoldOptions = ScaffolderScaffoldOptionsTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderScaffoldResponse} instead as this has now been moved.
 */
export type ScaffolderScaffoldResponse = ScaffolderScaffoldResponseTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderStreamLogsOptions} instead as this has now been moved.
 */
export type ScaffolderStreamLogsOptions = ScaffolderStreamLogsOptionsTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderTask} instead as this has now been moved.
 */
export type ScaffolderTask = ScaffolderTaskTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderTaskOutput} instead as this has now been moved.
 */
export type ScaffolderTaskOutput = ScaffolderTaskOutputTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderTaskStatus} instead as this has now been moved.
 */
export type ScaffolderTaskStatus = ScaffolderTaskStatusTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#createScaffolderLayout} instead as this has now been moved.
 */
export const createScaffolderLayout = createScaffolderLayoutTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#ScaffolderLayouts} instead as this has now been moved.
 */
export const ScaffolderLayouts = ScaffolderLayoutsTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#LayoutTemplate} instead as this has now been moved.
 */
export type LayoutTemplate = LayoutTemplateTemp;
/**
 * @public
 * @deprecated use import from {@link @devtools/plugin-scaffolder-react#LayoutOptions} instead as this has now been moved.
 */
