...
import { useApp, useRouteRef } from '@devtools/core-plugin-api';
...
import { parseEntityRef, stringifyEntityRef } from '@devtools/catalog-model';
...
export const TemplateListPage = (props: TemplateListPageProps) => {
  ...
  const additionalLinksForEntity = useCallback(
    (template: TemplateEntityV1beta3) => {
      ...
      return template.metadata.annotations?.['devtools.khulnasoft.com/techdocs-ref'] &&
        viewTechDocsLink
        ? [
            {
