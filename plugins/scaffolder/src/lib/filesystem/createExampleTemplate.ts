...
# https://devtools.khulnasoft.com/docs/features/software-catalog/descriptor-format#kind-template
kind: Template
metadata:
...
spec:
  ...
  'skeleton/catalog-info.yaml': `apiVersion: devtools.khulnasoft.com/v1alpha1
kind: Component
metadata:
