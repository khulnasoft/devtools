...
import { FieldSchema as FieldSchemaType } from '@devtools/plugin-scaffolder-react';

/**
 * @public
 * @deprecated - import from {@link @devtools/plugin-scaffolder-react#FieldSchema} instead
 */
