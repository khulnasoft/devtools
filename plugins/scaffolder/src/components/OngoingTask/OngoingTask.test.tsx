...
import { scaffolderApiRef } from '@devtools/plugin-scaffolder-react';
...
jest.mock('@devtools/plugin-scaffolder-react', () => ({
  ...jest.requireActual('@devtools/plugin-scaffolder-react'),
  useTaskEventStream: () => ({
    cancelled: false,
    loading: true,
    stepLogs: {},
