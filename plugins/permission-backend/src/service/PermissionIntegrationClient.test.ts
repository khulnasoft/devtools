...
describe('PermissionIntegrationClient', () => {
  describe('applyConditions', () => {
    ...
    const mockBaseUrl = 'http://devtools:9191';
    ...
    beforeAll(() => {
      ...
      server.use(
        rest.post(
          `${mockBaseUrl}/plugin-1/.well-known/devtools/permissions/apply-conditions`,
  ...
  describe('integration with @devtools/plugin-permission-node', () => {
    let server: Server;
