  ...
  public async run({
    ...
    if (cookieCutterInstalled) {
      ...
      await this.containerRunner.runContainer({
        imageName: imageName ?? 'spotify/devtools-cookiecutter',
        command: 'cookiecutter',
 ...
 * @remarks
 *
 * See {@link https://cookiecutter.readthedocs.io/} and {@link https://devtools.khulnasoft.com/docs/features/software-templates/writing-custom-actions}.
      ...
      input: {
        ...
        properties: {
          ...
          extensions: {
            ...
            description:
              "Jinja2 extensions to add filters, tests, globals or extend the parser. Extensions must be installed in the container or on the host where Cookiecutter executes. See the contrib directory in Devtools's repo for more information",
            type: 'array',
            items: {
              type: 'string',
            },
          ...
          imageName: {
            ...
            description:
              "Specify a custom Docker image to run cookiecutter, to override the default: 'spotify/devtools-cookiecutter'. This can be used to execute cookiecutter with Template Extensions. Used only when a local cookiecutter is not found.",
            type: 'string',
          },
        },
      },
