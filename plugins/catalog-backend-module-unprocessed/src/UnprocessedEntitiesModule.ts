...
import { unprocessedEntitiesDeletePermission } from '@devtools/plugin-catalog-unprocessed-entities-common';
import { NotAllowedError } from '@devtools/errors';
import { createLegacyAuthAdapters } from '@devtools/backend-common';
