## API Report File for "@devtools/plugin-kubernetes-backend"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts
import { AuthenticationStrategy as AuthenticationStrategy_2 } from '@devtools/plugin-kubernetes-node';
import { AuthMetadata as AuthMetadata_2 } from '@devtools/plugin-kubernetes-node';
...
import { ClusterDetails as ClusterDetails_2 } from '@devtools/plugin-kubernetes-node';
import { Config } from '@devtools/config';
import { CustomResource as CustomResource_2 } from '@devtools/plugin-kubernetes-node';
...
import { KubernetesClustersSupplier as KubernetesClustersSupplier_2 } from '@devtools/plugin-kubernetes-node';
import { KubernetesCredential as KubernetesCredential_2 } from '@devtools/plugin-kubernetes-node';
import { KubernetesFetcher as KubernetesFetcher_2 } from '@devtools/plugin-kubernetes-node';
import { KubernetesObjectsProvider as KubernetesObjectsProvider_2 } from '@devtools/plugin-kubernetes-node';
...
import { KubernetesServiceLocator as KubernetesServiceLocator_2 } from '@devtools/plugin-kubernetes-node';
import { Logger } from 'winston';
import { LoggerService } from '@devtools/backend-plugin-api';
import { ObjectToFetch as ObjectToFetch_2 } from '@devtools/plugin-kubernetes-node';
