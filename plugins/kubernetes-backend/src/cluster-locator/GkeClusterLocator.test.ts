...
import { ANNOTATION_KUBERNETES_AUTH_PROVIDER } from '@devtools/plugin-kubernetes-common';
import '@devtools/backend-common';
import { ConfigReader, Config } from '@devtools/config';
  ...
  describe('listClusters', () => {
    ...
    it('constructs ClusterManagerClient with identifying metadata', async () => {
      ...
      expect(container.v1.ClusterManagerClient).toHaveBeenCalledWith({
        libName: 'devtools/kubernetes-backend.GkeClusterLocator',
