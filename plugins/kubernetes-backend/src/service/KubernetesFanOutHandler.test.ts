...
describe('KubernetesFanOutHandler', () => {
  ...
  const mockCredentials: DevtoolsCredentials = {
  ...
  const entity = {
    ...
    metadata: {
      name: 'test-component',
      annotations: {
        'devtools.khulnasoft.com/kubernetes-labels-selector':
          'devtools.khulnasoft.com/test-label=test-component',
      },
    },
    spec: {
      type: 'service',
              ...
              errors: [
                {
                  ...
                  message:
                    'request to https://fails/api/v1/pods?labelSelector=devtools.khulnasoft.com%2Fkubernetes-id%3Dtest-component failed, reason: socket error',
                },
              ],
            },
          ],
