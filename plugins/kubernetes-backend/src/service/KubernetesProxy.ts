 ...
 * @public
 */
export const HEADER_KUBERNETES_CLUSTER: string = 'Devtools-Kubernetes-Cluster';
...
export const HEADER_KUBERNETES_AUTH: string =
  'Devtools-Kubernetes-Authorization';
...
export class KubernetesProxy {
      ...
      middleware = createProxyMiddleware({
        ...
        router: async req => {
          ...
          if (typeof authHeader === 'string') {
            ...
            // Map Devtools-Kubernetes-Authorization-X-X headers to a KubernetesRequestAuth object
  ...
  private static authHeadersToKubernetesRequestAuth(
    ...
    return Object.keys(originalHeaders)
      .filter(header => header.startsWith('devtools-kubernetes-authorization'))
      .map(header =>
