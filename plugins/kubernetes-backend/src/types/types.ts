...
import type { KubernetesRequestBody } from '@devtools/plugin-kubernetes-common';
import * as k8sTypes from '@devtools/plugin-kubernetes-node';
...
/**
 * @public @deprecated Import it from \@devtools/plugin-kubernetes-node instead
 */
...
/**
 * @public
 * @deprecated Import it from \@devtools/plugin-kubernetes-node instead
 */
