## API Report File for "@devtools/plugin-scaffolder-common"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts
import { Entity } from '@devtools/catalog-model';
import type { EntityMeta } from '@devtools/catalog-model';
import type { JsonArray } from '@devtools/types';
import { JsonObject } from '@devtools/types';
import type { JsonValue } from '@devtools/types';
import { KindValidator } from '@devtools/catalog-model';
