...
/**
 * Devtools catalog Template kind Entity. Templates are used by the Scaffolder
...
export interface TemplateEntityStepV1beta3 extends JsonObject {
  ...
  input?: JsonObject;
  if?: string | boolean;
  'devtools:permissions'?: TemplatePermissionsV1beta3;
}
...
export const isTemplateEntityV1beta3 = (
  ...
  entity.apiVersion === 'scaffolder.devtools.khulnasoft.com/v1beta3' &&
