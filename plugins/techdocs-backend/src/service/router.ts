...
import { CatalogApi, CatalogClient } from '@devtools/catalog-client';
 ...
 * Please {@link https://devtools.khulnasoft.com/docs/backend-system/building-backends/migrating | migrate } to use the new backend system and follow these {@link https://devtools.khulnasoft.com/docs/features/techdocs/getting-started#new-backend-system | instructions } to install the user settings backend plugin.
 */
