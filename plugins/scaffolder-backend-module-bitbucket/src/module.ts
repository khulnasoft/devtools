 ...
 * @public
 * @deprecated use module by \@devtools/plugin-scaffolder-backend-module-bitbucket-cloud or \@devtools/plugin-scaffolder-backend-module-bitbucket-server instead
 */
