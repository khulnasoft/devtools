 ...
 * @public
 * @deprecated in favor of "createPublishBitbucketCloudAction" by \@devtools/plugin-scaffolder-backend-module-bitbucket-cloud and "createPublishBitbucketServerAction" by \@devtools/plugin-scaffolder-backend-module-bitbucket-server
 */
