...
} from '@devtools/plugin-signals-node';
...
To allow connections from the frontend, you should also install the `@devtools/plugin-signals-backend`.
...
To receive this message in the frontend, check the documentation of `@devtools/plugin-signals` and
