 ...
 * NotFoundErrorPage (see {@link @devtools/core-app-api#AppComponents}).
 *
 * @public
 * @deprecated This component no longer works with the most recent version of `@devtools/core-app-api` and react-router v6, use {@link RequirePermission} instead.
 */
