...
export class MicrosoftGraphOrgReaderProcessor implements CatalogProcessor {
  ...
  constructor(options: {
    ...
    options.logger.warn(
      'MicrosoftGraphOrgReaderProcessor is deprecated. Please use MicrosoftGraphOrgEntityProvider instead. More info at https://github.com/khulnasoft/devtools/blob/master/plugins/catalog-backend-module-msgraph/CHANGELOG.md#040-next1',
    );
