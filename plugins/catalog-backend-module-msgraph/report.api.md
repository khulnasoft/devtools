...
import { GroupTransformer as GroupTransformer_2 } from '@devtools/plugin-catalog-backend-module-msgraph';
import { LocationSpec } from '@devtools/plugin-catalog-common';
import { LoggerService } from '@devtools/backend-plugin-api';
import * as MicrosoftGraph from '@microsoft/microsoft-graph-types';
import { OrganizationTransformer as OrganizationTransformer_2 } from '@devtools/plugin-catalog-backend-module-msgraph';
import { ProviderConfigTransformer as ProviderConfigTransformer_2 } from '@devtools/plugin-catalog-backend-module-msgraph';
...
import { UserTransformer as UserTransformer_2 } from '@devtools/plugin-catalog-backend-module-msgraph';
