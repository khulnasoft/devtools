## API Report File for "@devtools/plugin-auth-backend"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts
import { AuthOwnershipResolver } from '@devtools/plugin-auth-node';
import { AuthProviderConfig as AuthProviderConfig_2 } from '@devtools/plugin-auth-node';
import { AuthProviderFactory as AuthProviderFactory_2 } from '@devtools/plugin-auth-node';
import { AuthProviderRouteHandlers as AuthProviderRouteHandlers_2 } from '@devtools/plugin-auth-node';
import { AuthResolverCatalogUserQuery as AuthResolverCatalogUserQuery_2 } from '@devtools/plugin-auth-node';
import { AuthResolverContext as AuthResolverContext_2 } from '@devtools/plugin-auth-node';
import { AuthService } from '@devtools/backend-plugin-api';
import { AwsAlbResult as AwsAlbResult_2 } from '@devtools/plugin-auth-backend-module-aws-alb-provider';
...
import { DevtoolsSignInResult } from '@devtools/plugin-auth-node';
import { CacheService } from '@devtools/backend-plugin-api';
import { CatalogApi } from '@devtools/catalog-client';
import { ClientAuthResponse } from '@devtools/plugin-auth-node';
import { cloudflareAccessSignInResolvers } from '@devtools/plugin-auth-backend-module-cloudflare-access-provider';
import { Config } from '@devtools/config';
import { CookieConfigurer as CookieConfigurer_2 } from '@devtools/plugin-auth-node';
...
import { encodeOAuthState } from '@devtools/plugin-auth-node';
import { Entity } from '@devtools/catalog-model';
import express from 'express';
import { GcpIapResult as GcpIapResult_2 } from '@devtools/plugin-auth-backend-module-gcp-iap-provider';
import { GcpIapTokenInfo as GcpIapTokenInfo_2 } from '@devtools/plugin-auth-backend-module-gcp-iap-provider';
import { HttpAuthService } from '@devtools/backend-plugin-api';
import { LoggerService } from '@devtools/backend-plugin-api';
import { OAuth2ProxyResult as OAuth2ProxyResult_2 } from '@devtools/plugin-auth-backend-module-oauth2-proxy-provider';
import { OAuthEnvironmentHandler as OAuthEnvironmentHandler_2 } from '@devtools/plugin-auth-node';
import { OAuthState as OAuthState_2 } from '@devtools/plugin-auth-node';
import { OidcAuthResult as OidcAuthResult_2 } from '@devtools/plugin-auth-backend-module-oidc-provider';
import { prepareDevtoolsIdentityResponse as prepareDevtoolsIdentityResponse_2 } from '@devtools/plugin-auth-node';
import { Profile } from 'passport';
import { ProfileInfo as ProfileInfo_2 } from '@devtools/plugin-auth-node';
import { RootConfigService } from '@devtools/backend-plugin-api';
import { SignInInfo as SignInInfo_2 } from '@devtools/plugin-auth-node';
import { SignInResolver as SignInResolver_2 } from '@devtools/plugin-auth-node';
import { TokenManager } from '@devtools/backend-common';
import { TokenParams as TokenParams_2 } from '@devtools/plugin-auth-node';
import { UserEntity } from '@devtools/catalog-model';
import { WebMessageResponse as WebMessageResponse_2 } from '@devtools/plugin-auth-node';
...
// @public @deprecated (undocumented)
export const prepareDevtoolsIdentityResponse: typeof prepareDevtoolsIdentityResponse_2;
