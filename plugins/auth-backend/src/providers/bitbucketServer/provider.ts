...
} from '@devtools/plugin-auth-backend-module-bitbucket-server-provider';
...
/**
 * @public
 * @deprecated The Bitbucket Server auth provider was extracted to `@devtools/plugin-auth-backend-module-bitbucket-server-provider`.
 */
