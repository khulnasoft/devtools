...
} from '@devtools/plugin-auth-backend-module-bitbucket-provider';
import {
  SignInResolver,
...
/**
 * @public
 * @deprecated The Bitbucket auth provider was extracted to `@devtools/plugin-auth-backend-module-bitbucket-provider`.
 */
