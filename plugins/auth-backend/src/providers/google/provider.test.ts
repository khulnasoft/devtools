...
import { googleAuthenticator } from '@devtools/plugin-auth-backend-module-google-provider';
import { createOAuthProviderFactory } from '@devtools/plugin-auth-node';
import { google } from './provider';

jest.mock('@devtools/plugin-auth-node', () => ({
  ...jest.requireActual('@devtools/plugin-auth-node'),
