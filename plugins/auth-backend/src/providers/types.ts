...
/**
 * @public
 * @deprecated Use `createOAuthAuthenticator` from `@devtools/plugin-auth-node` instead
 */
...
/**
 * @public
 * @deprecated import `ClientAuthResponse` from `@devtools/plugin-auth-node` instead
 */
