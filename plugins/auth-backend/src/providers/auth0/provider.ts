...
import { auth0Authenticator } from '@devtools/plugin-auth-backend-module-auth0-provider';

/**
 * @public
 * @deprecated The Auth0 auth provider was extracted to `@devtools/plugin-auth-backend-module-auth0-provider`.
 */
