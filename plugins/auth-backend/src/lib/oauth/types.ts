...
/**
 * @public
 * @deprecated Use `OAuthAuthenticatorResult<PassportProfile>` from `@devtools/plugin-auth-node` instead
 */
...
/**
 * @public
 * @deprecated Use `ClientAuthResponse` from `@devtools/plugin-auth-node` instead
 */
export type OAuthResponse = {
  profile: ProfileInfo;
  providerInfo: OAuthProviderInfo;
  devtoolsIdentity?: DevtoolsSignInResult;
};
...
/**
 * @public
 * @deprecated import from `@devtools/plugin-auth-node` instead
 */
