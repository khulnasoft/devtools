...
export class PuppetDbEntityProvider implements EntityProvider {
   ...
   * @param logger - The instance of a {@link @devtools/backend-plugin-api#LoggerService}.
   * @param taskRunner - The instance of {@link @devtools/backend-plugin-api#SchedulerServiceTaskRunner}.
  ...
  /** {@inheritdoc @devtools/plugin-catalog-node#EntityProvider.connect} */
  async connect(connection: EntityProviderConnection): Promise<void> {
    this.connection = connection;
    await this.scheduleFn();
  }

  /** {@inheritdoc @devtools/plugin-catalog-node#EntityProvider.getProviderName} */
