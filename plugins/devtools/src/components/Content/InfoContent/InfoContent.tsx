...
import { Progress } from '@devtools/core-components';
...
import { DevtoolsLogoIcon } from './DevtoolsLogoIcon';
      ...
      <Paper className={classes.paperStyle}>
        <List className={classes.flexContainer}>
          ...
          <ListItem>
            ...
            <ListItemText
              primary="Devtools Version"
              secondary={about?.devtoolsVersion}
            />
          </ListItem>
        </List>
