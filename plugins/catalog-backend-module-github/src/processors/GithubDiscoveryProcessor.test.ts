...
describe('GithubDiscoveryProcessor', () => {
  ...
  describe('handles repositories', () => {
    ...
    it('output all repositories', async () => {
      const location: LocationSpec = {
        type: 'github-discovery',
        target: 'https://github.com/khulnasoft/*/blob/master/catalog.yaml',
      };
      mockGetOrganizationRepositories.mockResolvedValueOnce({
        repositories: [
          ...
          {
            name: 'demo',
            url: 'https://github.com/khulnasoft/demo',
            repositoryTopics: { nodes: [] },
            isArchived: false,
            isFork: false,
            defaultBranchRef: {
      ...
      expect(emitter).toHaveBeenCalledWith({
        ...
        location: {
          type: 'url',
          target:
            'https://github.com/khulnasoft/devtools/blob/master/catalog.yaml',
          presence: 'optional',
        },
      });
      expect(emitter).toHaveBeenCalledWith({
        ...
        location: {
          type: 'url',
          target: 'https://github.com/khulnasoft/demo/blob/master/catalog.yaml',
          presence: 'optional',
        },
      });
    });
    ...
    it('output repositories with wildcards default branch option', async () => {
      const location: LocationSpec = {
        type: 'github-discovery',
        target: 'https://github.com/khulnasoft/*/blob/-/catalog.yaml',
      };
      mockGetOrganizationRepositories.mockResolvedValueOnce({
        repositories: [
          {
            name: 'devtools',
            url: 'https://github.com/khulnasoft/tech-docs',
            repositoryTopics: { nodes: [] },
            isArchived: false,
            isFork: false,
            defaultBranchRef: {
      ...
      expect(emitter).toHaveBeenCalledWith({
        ...
        location: {
          type: 'url',
          target:
            'https://github.com/khulnasoft/tech-docs/blob/main/catalog.yaml',
          presence: 'optional',
        },
      });
    });
    ...
    it('output repositories with wildcards default branch option without catalog-info patch or branch match', async () => {
      const location: LocationSpec = {
        type: 'github-discovery',
        target: 'https://github.com/khulnasoft',
      };
      mockGetOrganizationRepositories.mockResolvedValueOnce({
        repositories: [
          {
    ...
    it('output repositories with wildcards', async () => {
      ...
      mockGetOrganizationRepositories.mockResolvedValueOnce({
        repositories: [
          ...
          {
            name: 'techdocs-cli',
            url: 'https://github.com/khulnasoft/techdocs-cli',
            repositoryTopics: { nodes: [] },
            isArchived: false,
            isFork: false,
            defaultBranchRef: {
          ...
          },
          {
            ...
            url: 'https://github.com/khulnasoft/techdocs-container',
            repositoryTopics: { nodes: [] },
            isArchived: false,
            isFork: false,
            defaultBranchRef: {
          ...
          {
            name: 'techdocs-durp',
            url: 'https://github.com/khulnasoft/techdocs-durp',
            repositoryTopics: { nodes: [] },
            isArchived: false,
            isFork: false,
            defaultBranchRef: null,
      ...
      expect(emitter).toHaveBeenCalledWith({
        ...
        location: {
          type: 'url',
          target:
            'https://github.com/khulnasoft/techdocs-cli/blob/master/catalog.yaml',
          presence: 'optional',
        },
      });
      expect(emitter).toHaveBeenCalledWith({
        ...
        location: {
          type: 'url',
          target:
            'https://github.com/khulnasoft/techdocs-container/blob/master/catalog.yaml',
          presence: 'optional',
        },
      });
    });
    ...
    it('filter unrelated and archived repositories', async () => {
      const location: LocationSpec = {
        type: 'github-discovery',
        target: 'https://github.com/khulnasoft/test/blob/master/catalog.yaml',
      };
      mockGetOrganizationRepositories.mockResolvedValueOnce({
        repositories: [
          {
            name: 'abstest',
            url: 'https://github.com/khulnasoft/abctest',
            isArchived: false,
            isFork: false,
            repositoryTopics: { nodes: [] },
            defaultBranchRef: {
          ...
          {
            name: 'test',
            url: 'https://github.com/khulnasoft/test',
            isArchived: false,
            isFork: false,
            repositoryTopics: { nodes: [] },
            defaultBranchRef: {
          ...
          {
            name: 'testxyz',
            url: 'https://github.com/khulnasoft/testxyz',
            repositoryTopics: { nodes: [] },
            isArchived: false,
            isFork: false,
            defaultBranchRef: {
