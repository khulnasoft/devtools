...
import { Entity, isGroupEntity } from '@devtools/catalog-model';
...
import { EventParams, EventsService } from '@devtools/plugin-events-node';
...
export interface GithubOrgEntityProviderOptions {
   ...
   *
   * @example "https://github.com/khulnasoft"
   */
  orgUrl: string;
