...
export class GithubEntityProvider implements EntityProvider, EventSubscriber {
  ...
  /** {@inheritdoc @devtools/plugin-events-node#EventSubscriber.onEvent} */
  ...
  /** {@inheritdoc @devtools/plugin-events-node#EventSubscriber.supportsEventTopics} */
...
export function parseUrl(urlString: string): {
  ...
  // /devtools/techdocs-*/blob/master/catalog-info.yaml
  // can also be
  // /devtools
