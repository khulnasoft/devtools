...
describe('GithubOrgEntityProvider', () => {
          ...
          },
          {
            entity: {
              ...
              metadata: {
                annotations: {
                  'devtools.khulnasoft.com/managed-by-location':
                    'url:https://https://github.com/orgs/devtools/teams/team',
                  'devtools.khulnasoft.com/managed-by-origin-location':
                    'url:https://https://github.com/orgs/devtools/teams/team',
  ...
  describe('withLocations', () => {
    it('should set location for user', () => {
      ...
      expect(withLocations('https://github.com', 'devtools', entity)).toEqual({
        apiVersion: 'devtools.khulnasoft.com/v1alpha1',
        kind: 'User',
        metadata: {
          name: 'user-name',
    ...
    it('should set location for group', () => {
      const entity: GroupEntity = {
        ...
        metadata: {
          name: 'group-name',
          annotations: {
            'github.com/team-slug': 'devtools/mygroup',
          },
        },
        spec: {
          type: 'team',
      ...
      expect(withLocations('https://github.com', 'devtools', entity)).toEqual({
        ...
        metadata: {
          ...
          annotations: {
            'devtools.khulnasoft.com/managed-by-location':
              'url:https://github.com/orgs/devtools/teams/mygroup',
            'devtools.khulnasoft.com/managed-by-origin-location':
              'url:https://github.com/orgs/devtools/teams/mygroup',
            'github.com/team-slug': 'devtools/mygroup',
          },
          ...
          },
          {
            ...
            entity: {
              metadata: {
                annotations: {
                  'devtools.khulnasoft.com/managed-by-location':
                    'url:https://github.com/orgs/devtools/teams/team',
                  'devtools.khulnasoft.com/managed-by-origin-location':
                    'url:https://github.com/orgs/devtools/teams/team',
                  'github.com/team-slug': 'blah/team',
                },
        ...
        removed: [
          {
            ...
            entity: {
              metadata: {
                annotations: {
                  'devtools.khulnasoft.com/managed-by-location':
                    'url:https://github.com/orgs/devtools/teams/mygroup-with-spaces',
                  'devtools.khulnasoft.com/managed-by-origin-location':
                    'url:https://github.com/orgs/devtools/teams/mygroup-with-spaces',
                },
