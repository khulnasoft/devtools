...
import { decodeOAuthState } from '@devtools/plugin-auth-node';
...
describe('authModuleOidcProvider', () => {
  ...
  beforeEach(async () => {
    ...
    const backend = await startTestBackend({
      features: [
        ...
        import('@devtools/plugin-auth-backend'),
  ...
  it('should start', async () => {
    const agent = request.agent(devtoolsServer);
