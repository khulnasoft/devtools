...
import { AppIcon } from '@devtools/core-components';

import {
  EntityCardBlueprint,
  EntityContentBlueprint,
} from '@devtools/plugin-catalog-react/alpha';
...
const apiDocsHasApisEntityCard = EntityCardBlueprint.make({
  ...
  params: {
    ...
    // See: https://github.com/khulnasoft/devtools/pull/22619#discussion_r1477333252
    filter: entity => {
      return (
