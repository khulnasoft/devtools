...
import { ApiEntity, RELATION_PROVIDES_API } from '@devtools/catalog-model';
      ...
      emptyContent={
        <div style={{ textAlign: 'center' }}>
          ...
          <Typography variant="body2">
            <Link
              to="https://devtools.khulnasoft.com/docs/features/software-catalog/descriptor-format#specprovidesapis-optional"
              externalLinkIcon
            >
