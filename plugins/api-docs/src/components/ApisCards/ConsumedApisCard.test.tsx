...
import { Entity, RELATION_CONSUMES_API } from '@devtools/catalog-model';
import {
  catalogApiRef,
  EntityProvider,
  entityRouteRef,
...
describe('<ConsumedApisCard />', () => {
  ...
  it('shows empty list if no relations', async () => {
    ...
    expect(externalLink).toHaveAttribute(
      'href',
      'https://devtools.khulnasoft.com/docs/features/software-catalog/descriptor-format#specconsumesapis-optional',
    );
