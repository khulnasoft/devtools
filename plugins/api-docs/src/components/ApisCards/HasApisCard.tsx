...
import { ApiEntity, RELATION_HAS_PART } from '@devtools/catalog-model';
      ...
      emptyContent={
        <div style={{ textAlign: 'center' }}>
          ...
          <Typography variant="body2">
            <Link to="https://devtools.khulnasoft.com/docs/features/software-catalog/descriptor-format#kind-api">
