...
import { Entity, RELATION_PROVIDES_API } from '@devtools/catalog-model';
import {
  catalogApiRef,
  EntityProvider,
  entityRouteRef,
...
describe('<ProvidedApisCard />', () => {
  ...
  it('shows empty list if no relations', async () => {
    ...
    expect(externalLink).toHaveAttribute(
      'href',
      'https://devtools.khulnasoft.com/docs/features/software-catalog/descriptor-format#specprovidesapis-optional',
    );
