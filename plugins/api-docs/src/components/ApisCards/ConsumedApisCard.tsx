...
import { ApiEntity, RELATION_CONSUMES_API } from '@devtools/catalog-model';
      ...
      emptyContent={
        <div style={{ textAlign: 'center' }}>
          ...
          <Typography variant="body2">
            <Link
              to="https://devtools.khulnasoft.com/docs/features/software-catalog/descriptor-format#specconsumesapis-optional"
              externalLinkIcon
            >
