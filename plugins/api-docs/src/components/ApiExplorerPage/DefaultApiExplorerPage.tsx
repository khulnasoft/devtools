...
import { configApiRef, useApi, useRouteRef } from '@devtools/core-plugin-api';
import { CatalogTable, CatalogTableRow } from '@devtools/plugin-catalog';
import {
  EntityKindPicker,
...
export const DefaultApiExplorerPage = (props: DefaultApiExplorerPageProps) => {
  ...
  const generatedSubtitle = `${
    configApi.getOptionalString('organization.name') ?? 'Devtools'
  } API Explorer`;
