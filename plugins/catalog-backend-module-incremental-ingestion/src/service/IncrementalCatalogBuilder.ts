...
import { CatalogBuilder as CoreCatalogBuilder } from '@devtools/plugin-catalog-backend';
import { createDeferred } from '@devtools/types';
...
import { EventParams, EventSubscriber } from '@devtools/plugin-events-node';

/**
 * @public
 * @deprecated Please migrate to the new backend system and import `@devtools/plugin-catalog-backend-module-incremental-ingestion` as a module, and add providers to the `incrementalIngestionProvidersExtensionPoint` instead
 */
