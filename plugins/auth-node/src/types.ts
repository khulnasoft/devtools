...
import { EntityFilterQuery } from '@devtools/catalog-client';
...
/**
 * A representation of a successful Devtools sign-in.
 *
 * Compared to the {@link DevtoolsIdentityResponse} this type omits
 * the decoded identity information embedded in the token.
 *
 * @public
 */
export interface DevtoolsSignInResult {
  /**
...
/**
 * Response object containing the {@link DevtoolsUserIdentity} and the token
 * from the authentication provider.
 *
 * @public
 */
export interface DevtoolsIdentityResponse extends DevtoolsSignInResult {
  /**
...
/**
 * User identity information within Devtools.
 *
 * @public
 */
export type DevtoolsUserIdentity = {
  /**
...
/**
 * Parameters used to issue new Devtools Tokens
 *
 * @public
 */
export type TokenParams = {
   ...
   * `iat`, and `exp`. The Devtools team also maintains the right add new claims in the future
...
export type AuthResolverContext = {
  /**
   * Issues a Devtools token using the provided parameters.
   */
 ...
 * authentication. Must return a valid {@link @devtools/plugin-auth-node#DevtoolsSignInResult}.
 *
 * @public
 */
 ...
 *
 * It is also temporarily used as the profile of the signed-in user's Devtools
...
export const tokenTypes = Object.freeze({
  user: Object.freeze({
    typParam: 'vnd.devtools.user',
    audClaim: 'devtools',
  }),
  limitedUser: Object.freeze({
    typParam: 'vnd.devtools.limited-user',
  }),
  plugin: Object.freeze({
    typParam: 'vnd.devtools.plugin',
  }),
});
