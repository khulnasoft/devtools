...
import { prepareDevtoolsIdentityResponse } from '../identity';
    ...
    async frameHandler(
      ...
      try {
        ...
        const response: ClientOAuthResponse = {
          ...
          ...(signInResult && {
            devtoolsIdentity: prepareDevtoolsIdentityResponse(signInResult),
          }),
        };
      ...
      try {
        ...
        if (signInResolver) {
          ...
          response.devtoolsIdentity =
            prepareDevtoolsIdentityResponse(identity);
        }
