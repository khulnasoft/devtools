## API Report File for "@devtools/plugin-auth-node"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts
import { DevtoolsIdentityResponse as DevtoolsIdentityResponse_2 } from '@devtools/plugin-auth-node';
import { DevtoolsSignInResult as DevtoolsSignInResult_2 } from '@devtools/plugin-auth-node';
...
export class DefaultIdentityClient implements IdentityApi {
  // @deprecated
  authenticate(token: string | undefined): Promise<DevtoolsIdentityResponse>;
...
export function prepareDevtoolsIdentityResponse(
  result: DevtoolsSignInResult_2,
): DevtoolsIdentityResponse_2;
