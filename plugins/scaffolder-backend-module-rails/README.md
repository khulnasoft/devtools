...
```bash
# From your Devtools root directory
yarn --cwd packages/backend add @devtools/plugin-scaffolder-backend-module-rails
```
...
backend.add(import('@devtools/plugin-scaffolder-backend-module-rails'));
```
...
We have a [Dockerfile](https://github.com/khulnasoft/devtools/blob/master/plugins/scaffolder-backend-module-rails/Rails.dockerfile) that you can use to build your image.
