...
`@devtools/plugin-search-backend` based on Postgres.
...
See [Devtools documentation](https://devtools.khulnasoft.com/docs/features/search/search-engines#postgres)
for details on how to setup Postgres based search for your Devtools instance.
