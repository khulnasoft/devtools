...
import {
  ...
  IndexableResultSet,
  SearchQuery,
} from '@devtools/plugin-search-common';
...
import { MissingIndexError } from '@devtools/plugin-search-backend-node';
...
export class ElasticSearchSearchEngine implements SearchEngine {
   ...
   *
   * ```ts
   * import { isOpenSearchCompatible } from '@devtools/plugin-search-backend-module-elasticsearch';
  ...
  async getIndexer(type: string) {
    ...
    // todo(@devtools/search-maintainers): Consider introducing a more
