...
import { EntityCardBlueprint } from '@devtools/plugin-catalog-react/alpha';
import { catalogGraphRouteRef, catalogEntityRouteRef } from './routes';
import { Direction } from '@devtools/plugin-catalog-graph';
...
const CatalogGraphEntityCard = EntityCardBlueprint.makeWithOverrides({
  ...
  config: {
    schema: {
      ...
      // For more details, see this comment: https://github.com/khulnasoft/devtools/pull/22619#discussion_r1477333252
