 ...
 * may wish to protect.
 *
 * To evaluate authorization, a permission is paired with a Devtools identity (the "who") and
 ...
 * @public
 * @deprecated Use {@link @devtools/plugin-permission-common#PermissionEvaluator} instead
 */
