...
import { JsonPrimitive } from '@devtools/types';
...
/**
 * A definitive decision returned by the {@link @devtools/plugin-permission-node#PermissionPolicy}.
 *
 * @remarks
 *
...
/**
 * A conditional decision returned by the {@link @devtools/plugin-permission-node#PermissionPolicy}.
 *
 * @remarks
 *
...
/**
 * A decision returned by the {@link @devtools/plugin-permission-node#PermissionPolicy}.
 *
 * @public
 */
 ...
 * {@link @devtools/plugin-permission-node#PermissionPolicy} interface and the permission backend
...
export interface PermissionEvaluator {
   ...
   * {@link @devtools/plugin-permission-node#PermissionPolicy}. This method is useful when the
