# @devtools/plugin-catalog-backend-module-azure
...
- b8884fd579: Add a new provider `AzureDevOpsEntityProvider` as replacement for `AzureDevOpsDiscoveryProcessor`.
  ...
  **After:**
  ...
  Visit [https://devtools.khulnasoft.com/docs/integrations/azure/discovery](https://devtools.khulnasoft.com/docs/integrations/azure/discovery) for more details and options on configuration.
