...
import { AlphaEntity } from '@devtools/catalog-model/alpha';
...
import { CopyTextButton } from '@devtools/core-components';
    ...
    <>
      ...
      <div className={classes.root}>
          ...
          {!!Object.keys(metadata.annotations || {}).length && (
            <List
              ...
              subheader={
                <ListSubheader>
                  Annotations
                  <HelpIcon to="https://devtools.khulnasoft.com/docs/features/software-catalog/well-known-annotations" />
                </ListSubheader>
              }
            >
        ...
        {!!relations.length && (
          <Container
            title="Relations"
            helpLink="https://devtools.khulnasoft.com/docs/features/software-catalog/well-known-relations"
          >
        ...
        {!!status.items?.length && (
          <Container
            title="Status"
            helpLink="https://devtools.khulnasoft.com/docs/features/software-catalog/well-known-statuses"
          >
