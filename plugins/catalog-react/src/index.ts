...
/**
 * A frontend library that helps other Devtools plugins interact with the catalog
 *
 * @packageDocumentation
 */

export type { CatalogApi } from '@devtools/catalog-client';
export { CATALOG_FILTER_EXISTS } from '@devtools/catalog-client';
