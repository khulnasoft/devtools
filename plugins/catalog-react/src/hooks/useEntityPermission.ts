 ...
 * {@link @devtools/plugin-permission-react#usePermission} hook which uses the
 * current entity in context to make an authorization request for the given
 * {@link @devtools/plugin-catalog-common#CatalogEntityPermission}.
 *
...
export function useEntityPermission(
  ...
  // https://github.com/khulnasoft/devtools/pull/10128 is fixed.
