...
import { catalogEntityDeletePermission } from '@devtools/plugin-catalog-common/alpha';
...
jest.mock('@devtools/plugin-permission-react', () => ({
  ...jest.requireActual('@devtools/plugin-permission-react'),
