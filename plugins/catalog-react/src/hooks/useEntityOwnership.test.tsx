...
import { ComponentEntity, RELATION_OWNED_BY } from '@devtools/catalog-model';
import { identityApiRef } from '@devtools/core-plugin-api';
import { TestApiProvider, mockApis } from '@devtools/test-utils';
