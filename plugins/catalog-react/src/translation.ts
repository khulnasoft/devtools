...
export const catalogReactTranslationRef = createTranslationRef({
  ...
  messages: {
    ...
    unregisterEntityDialog: {
      ...
      bootstrapState: {
        title:
          'You cannot unregister this entity, since it originates from a protected Devtools configuration (location "{{location}}"). If you believe this is in error, please contact the {{appTitle}} integrator.',
        advancedDescription:
