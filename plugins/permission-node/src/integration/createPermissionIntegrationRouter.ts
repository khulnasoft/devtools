...
import { NotImplementedError } from '@devtools/errors';
 ...
 *
 * @public
 * @deprecated Please import from `@devtools/plugin-permission-common` instead.
 */
 ...
 * integration between the permission backend and other Devtools backend
 ...
 * @remarks
 *
 * To make this concrete, we can use the Devtools software catalog as an
 ...
 * {@link @devtools/catalog-model#EntityRef}. For other plugins, this can be
...
>(
  ...
  router.get('/.well-known/devtools/permissions/metadata', (_, res) => {
  ...
  router.post(
    '/.well-known/devtools/permissions/apply-conditions',
