...
import { durationToMilliseconds, HumanDuration } from '@devtools/types';
...
/**
 * Default implementation of the {@link @devtools/plugin-catalog-react#EntityPresentationApi}.
 *
 * @public
 */
export class DefaultEntityPresentationApi implements EntityPresentationApi {
  ...
  /** {@inheritdoc @devtools/plugin-catalog-react#EntityPresentationApi.forEntity} */
  forEntity(
