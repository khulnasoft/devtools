...
import { isTemplateEntityV1beta3 } from '@devtools/plugin-scaffolder-common';
import { useEntityPermission } from '@devtools/plugin-catalog-react/alpha';
...
import { taskCreatePermission } from '@devtools/plugin-scaffolder-common/alpha';
...
const TECHDOCS_ANNOTATION = 'devtools.khulnasoft.com/techdocs-ref';

const TECHDOCS_EXTERNAL_ANNOTATION = 'devtools.khulnasoft.com/techdocs-entity';
