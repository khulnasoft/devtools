...
import { RELATION_OWNED_BY } from '@devtools/catalog-model';
...
describe('<AboutCard />', () => {
  ...
  it('renders "view source" link', async () => {
      ...
      metadata: {
        ...
        annotations: {
          'devtools.khulnasoft.com/source-location':
            'url:https://github.com/khulnasoft/devtools/blob/master/software.yaml',
        },
      },
      spec: {
        owner: 'guest',
    ...
    expect(screen.getByText('View Source').closest('a')).toHaveAttribute(
      'href',
      'https://github.com/khulnasoft/devtools/blob/master/software.yaml',
    );
  });
      ...
      metadata: {
        ...
        annotations: {
          'devtools.khulnasoft.com/edit-url':
            'https://github.com/khulnasoft/devtools/edit/master/software.yaml',
        },
      },
      spec: {
        owner: 'guest',
  ...
  it('renders "create something similar" button', async () => {
    const entity = {
      ...
      metadata: {
        name: 'software',
        annotations: {
          'devtools.khulnasoft.com/source-template': 'template:default/foo-template',
        },
      },
      spec: {
        owner: 'guest',
  ...
  it('should not render "create something similar" button if template does not exist', async () => {
    const entity = {
      ...
      metadata: {
        name: 'software',
        annotations: {
          'devtools.khulnasoft.com/source-template': 'template:default/gone-template',
        },
      },
      spec: {
        owner: 'guest',
  ...
  it.each([
    'url:https://devtools.khulnasoft.com/catalog-info.yaml',
    ...
    const entity = {
      ...
      metadata: {
        annotations: {
          'devtools.khulnasoft.com/managed-by-location': location,
        },
        name: 'software',
      },
      spec: {
  ...
  it.each([
    ...
    {
      testName: 'apiVersion is not scaffolder.devtools.khulnasoft.com/v1beta3',
      entity: {
        apiVersion: 'v1',
        kind: 'Template',
        metadata: {
