...
import { ComponentEntity, RELATION_HAS_PART } from '@devtools/catalog-model';
import {
  InfoCardVariants,
  TableColumn,
  TableOptions,
...
export function HasSubcomponentsCard(props: HasSubcomponentsCardProps) {
  ...
  return (
    <RelatedEntitiesCard
      ...
      emptyHelpLink="https://devtools.khulnasoft.com/docs/features/software-catalog/descriptor-format#specsubcomponentof-optional"
      tableOptions={tableOptions}
    />
  );
}
