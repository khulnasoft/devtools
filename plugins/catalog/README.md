# Devtools Catalog Frontend

This is the React frontend for the default Devtools [software catalog](http://devtools.khulnasoft.com/docs/features/software-catalog/).
...
This `@devtools/plugin-catalog` package comes installed by default in any
...
`@devtools/plugin-catalog`. The instructions below walk through restoring the
...
yarn --cwd packages/app add @devtools/plugin-catalog
```
...
+    in the main repo or the output of @devtools/create-app for an example
+  */}
+    {entityPage}
+  </Route>
  ...
...
- [catalog-backend](https://github.com/khulnasoft/devtools/tree/master/plugins/catalog-backend)
