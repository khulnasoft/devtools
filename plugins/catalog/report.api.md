## API Report File for "@devtools/plugin-catalog"
...
import { CatalogApi } from '@devtools/plugin-catalog-react';
import { ComponentEntity } from '@devtools/catalog-model';
import { CompoundEntityRef } from '@devtools/catalog-model';
import { DomainEntity } from '@devtools/catalog-model';
import { Entity } from '@devtools/catalog-model';
import { EntityListContextProps } from '@devtools/plugin-catalog-react';
import { EntityListPagination } from '@devtools/plugin-catalog-react';
import { EntityOwnerPickerProps } from '@devtools/plugin-catalog-react';
import { EntityPresentationApi } from '@devtools/plugin-catalog-react';
import { EntityRefPresentation } from '@devtools/plugin-catalog-react';
import { EntityRefPresentationSnapshot } from '@devtools/plugin-catalog-react';
...
import { SearchResultListItemExtensionProps } from '@devtools/plugin-search-react';
import { StarredEntitiesApi } from '@devtools/plugin-catalog-react';
import { StorageApi } from '@devtools/core-plugin-api';
import { StyleRules } from '@material-ui/core/styles/withStyles';
import { SystemEntity } from '@devtools/catalog-model';
import { TableColumn } from '@devtools/core-components';
import { TableOptions } from '@devtools/core-components';
import { TableProps } from '@devtools/core-components';
import { TabProps } from '@material-ui/core/Tab';
import { UserListFilterKind } from '@devtools/plugin-catalog-react';
...
// @public (undocumented)
export const catalogPlugin: DevtoolsPlugin<
  {
