...
function addProcessorAttributes(
  ...
  span.setAttribute('devtools.catalog.processor.stage', stage);
  span.setAttribute(
    'devtools.catalog.processor.name',
  ...
  implements CatalogProcessingOrchestrator
{
  ...
  private async runPreProcessStep(
    ...
    return await withActiveSpan(tracer, 'ProcessingStage', async stageSpan => {
      ...
      stageSpan.setAttribute('devtools.catalog.processor.stage', 'preProcess');
      let res = entity;
  ...
  private async runPolicyStep(entity: Entity): Promise<Entity> {
    return await withActiveSpan(tracer, 'ProcessingStage', async stageSpan => {
      ...
      stageSpan.setAttribute(
        'devtools.catalog.processor.stage',
        'enforcePolicy',
      );
  ...
  private async runValidateStep(
    ...
    return await withActiveSpan(tracer, 'ProcessingStage', async stageSpan => {
      addEntityAttributes(stageSpan, entity);
      stageSpan.setAttribute('devtools.catalog.processor.stage', 'validate');
