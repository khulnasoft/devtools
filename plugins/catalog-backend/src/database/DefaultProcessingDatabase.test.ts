...
import { Entity, stringifyEntityRef } from '@devtools/catalog-model';
      ...
      async databaseId => {
        ...
        await db.transaction(tx =>
          db.updateProcessedEntity(tx, {
            ...
            refreshKeys: [
              {
                key: `url:https://example.com/foo-bar-test-group/very-long-group-name-that-exceeds-255-characters-just-to-test-the-limits-of-url-length-in-the-catalog-info-yaml-file-and-see-how-the-devtools-system-handles-it-making/test-this-alright-1/-/blob/main/catalog-info.yaml`,
              },
            ],
          }),
        );
