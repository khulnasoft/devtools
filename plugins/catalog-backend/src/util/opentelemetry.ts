...
export const TRACER_ID = 'devtools-plugin-catalog-backend';
...
export function addEntityAttributes(span: Span, entity: Entity) {
  setAttributeIfDefined(span, 'devtools.entity.apiVersion', entity.apiVersion);
  setAttributeIfDefined(span, 'devtools.entity.kind', entity.kind);
  setAttributeIfDefined(
    span,
    'devtools.entity.metadata.namespace',
    entity.metadata?.namespace,
  );
  setAttributeIfDefined(
    span,
    'devtools.entity.metadata.name',
