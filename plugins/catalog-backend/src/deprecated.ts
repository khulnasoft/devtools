...
} from '@devtools/plugin-catalog-common';
import {
...
} from '@devtools/plugin-search-backend-module-catalog';

/**
 * @public
 * @deprecated import from `@devtools/plugin-catalog-node` instead
 */
 ...
 *
 * @public
 * @deprecated use the same type from `@devtools/plugin-catalog-common` instead
 */
...
/**
 * @public
 * @deprecated import from `@devtools/plugin-search-backend-module-catalog` instead
 */
