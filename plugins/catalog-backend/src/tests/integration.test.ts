    ...
    await harness.setInputEntities([
      {
        ...
        metadata: {
          name: 'test',
          annotations: {
            'devtools.khulnasoft.com/managed-by-location': 'url:.',
            'devtools.khulnasoft.com/managed-by-origin-location': 'url:.',
          },
        },
      },
    ]);
  ...
  it('leaves behind orphaned cycles without orphan markers', async () => {
    ...
    expect(
      (await harness.getOutputEntities())['component:default/b'].metadata
        .annotations!['devtools.khulnasoft.com/orphan'],
    ).toBeUndefined();
    expect(
    ...
    await harness.setInputEntities([
      {
        ...
        metadata: {
          ...
          annotations: {
            'devtools.khulnasoft.com/managed-by-location': 'url:.',
            'devtools.khulnasoft.com/managed-by-origin-location': 'url:.',
            'devtools.khulnasoft.com/view-url': '       javascript:bad()',
            'devtools.khulnasoft.com/edit-url': '       javascript:alert()',
          },
        },
      },
    ]);
        ...
        metadata: expect.objectContaining({
          ...
          annotations: expect.objectContaining({
            'devtools.khulnasoft.com/view-url':
              'https://devtools.khulnasoft.com/annotation-rejected-for-security-reasons',
    ...
    await harness.setInputEntities([
      {
        ...
        metadata: {
          name: 'test',
          annotations: {
            'devtools.khulnasoft.com/managed-by-location': 'url:javascript:bad()',
            'devtools.khulnasoft.com/managed-by-origin-location': 'url:javascript:alert()',
          },
        },
      },
    ]);
