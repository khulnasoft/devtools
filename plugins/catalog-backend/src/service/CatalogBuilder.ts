...
import { Config, readDurationFromConfig } from '@devtools/config';
...
import { EventBroker, EventsService } from '@devtools/plugin-events-node';
import { durationToMilliseconds } from '@devtools/types';
import {
  AuthService,
  DatabaseService,
  DiscoveryService,
...
export class CatalogBuilder {
   ...
   * {@link @devtools/plugin-permission-node#Permission}.
   *
   ...
   * {@link @devtools/plugin-permission-node#PermissionRule}.
   *
  ...
  private checkMissingExternalProcessors(processors: CatalogProcessor[]) {
    const skipCheckVarName = 'DEVTOOLS_CATALOG_SKIP_MISSING_PROCESSORS_CHECK';
    ...
    check(
      ...
      'https://devtools.khulnasoft.com/docs/integrations',
    );
    check(
      's3-discovery',
    ...
    check(
      ...
      'https://devtools.khulnasoft.com/docs/integrations/bitbucket/discovery',
    );
    check(
      'github-discovery',
    ...
    check(
      ...
      'https://devtools.khulnasoft.com/docs/integrations/github/org',
    );
    check(
      'gitlab-discovery',
    ...
    check(
      ...
      'https://devtools.khulnasoft.com/docs/integrations/ldap/org',
    );
    check(
      'microsoft-graph-org',
      'MicrosoftGraphOrgReaderProcessor',
      'https://devtools.khulnasoft.com/docs/integrations/azure/org',
    );
  }
