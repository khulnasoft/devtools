  ...
  describe('createLocation', () => {
    it('should support dry run', async () => {
      ...
      await locationService.createLocation(
        { type: 'url', target: 'https://devtools.khulnasoft.com/catalog-info.yaml' },
        true,
      );
      ...
      expect(orchestrator.process).toHaveBeenCalledWith({
        entity: {
          ...
          spec: {
            target: 'https://devtools.khulnasoft.com/catalog-info.yaml',
            type: 'url',
          },
        },
    ...
    it('should return default InputError for failed processed entities in dryRun mode', async () => {
      ...
      await expect(
        locationService.createLocation(
          {
            type: 'url',
            target: 'https://devtools.khulnasoft.com/wrong-url/catalog-info.yaml',
          },
          true,
        ),
      ).rejects.toThrow(InputError);
