      ...
      filter: {
        ...
        examples: {
          ...
          'Get orphaned components': {
            value: [
              'kind=component,metadata.annotations.devtools.khulnasoft.com/orphan=true',
            ],
          },
        },
      },
        ...
        requestBody: {
          ...
          content: {
            'application/json': {
              ...
              examples: {
                'Fetch Devtools entities': {
                  value: {
                    entityRefs: [
                      'component:default/devtools',
                      'api:default/devtools',
                    ],
                  },
                },
                'Fetch annotations for devtools entity': {
                  value: {
                    entityRefs: ['component:default/devtools'],
