...
export interface Config {
  ...
  catalog?: {
     ...
     * that regular users of Devtools are permitted to register locations
     ...
     * components to a running devtools instance.
     */
    readonly?: boolean;
     ...
     * that are defined by the Devtools operators at an organization, rather
