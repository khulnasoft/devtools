...
import { useEntityList } from '@devtools/plugin-catalog-react';
import {
  isTemplateEntityV1beta3,
  TemplateEntityV1beta3,
} from '@devtools/plugin-scaffolder-common';
import { Progress, Link } from '@devtools/core-components';
import Typography from '@material-ui/core/Typography';
import { errorApiRef, IconComponent, useApi } from '@devtools/core-plugin-api';
import { TemplateGroupFilter } from '@devtools/plugin-scaffolder-react';
  ...
  if (!entities || !entities.length) {
    return (
      <Typography variant="body2">
        ...
        <Link to="https://devtools.khulnasoft.com/docs/features/software-templates/adding-templates">
          adding templates
        </Link>
        .
      </Typography>
