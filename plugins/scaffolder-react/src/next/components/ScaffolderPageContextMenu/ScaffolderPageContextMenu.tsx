...
import { taskReadPermission } from '@devtools/plugin-scaffolder-common/alpha';
import { templateManagementPermission } from '@devtools/plugin-scaffolder-common/alpha';
