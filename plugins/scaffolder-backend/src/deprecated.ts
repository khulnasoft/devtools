...
import { ScaffolderEntitiesProcessor as ScaffolderEntitiesProcessorModule } from '@devtools/plugin-catalog-backend-module-scaffolder-entity-model';

/**
 * @public
 * @deprecated Import from {@link @devtools/plugin-scaffolder-node#ActionContext} instead
 */
...
/**
 * @public
 * @deprecated Use `createTemplateAction` from `@devtools/plugin-scaffolder-node` instead
 */
export const createTemplateAction = createTemplateActionNode;

/**
 * @public
 * @deprecated Use `TaskSecrets` from `@devtools/plugin-scaffolder-node` instead
 */
export type TaskSecrets = TaskSecretsNode;

/**
 * @public
 * @deprecated Use `TemplateAction` from `@devtools/plugin-scaffolder-node` instead
 */
 ...
 *
 * @public
 * @deprecated Use `ExecuteShellCommandOptions` from `@devtools/plugin-scaffolder-node` instead
 */
 ...
 *
 * @public
 * @deprecated Use `executeShellCommand` from `@devtools/plugin-scaffolder-node` instead
 */
 ...
 *
 * @public
 * @deprecated Use `fetchContents` from `@devtools/plugin-scaffolder-node` instead
 */
 ...
 *
 * @public
 * @deprecated Import from `@devtools/plugin-catalog-backend-module-scaffolder-entity-model` instead
 */
