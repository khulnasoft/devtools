...
import { InputError, NotFoundError, stringifyError } from '@devtools/errors';
import { ScmIntegrations } from '@devtools/integration';
import { HumanDuration, JsonObject, JsonValue } from '@devtools/types';
import {
  TaskSpec,
...
import {
  AutocompleteHandler,
  WorkspaceProvider,
} from '@devtools/plugin-scaffolder-node/alpha';
...
function isSupportedTemplate(entity: TemplateEntityV1beta3) {
  return entity.apiVersion === 'scaffolder.devtools.khulnasoft.com/v1beta3';
}
 ...
 * until someone explicitly passes an IdentityApi. When we have reasonable confidence that most devtools deployments
