 ...
 * ...
 * import { createScaffolderPolicyDecision } from '@devtools/plugin-scaffolder-backend';
 * import { RESOURCE_TYPE_SCAFFOLDER_TEMPLATE } from '@devtools/plugin-scaffolder-common';
 *
