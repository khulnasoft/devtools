...
import { TaskContext } from '@devtools/plugin-scaffolder-node';
...
export class DevtoolsLoggerTransport extends Transport {
  constructor(
    private readonly devtoolsLogger: LoggerService,
  ...
  log(info: TransformableInfo, callback: VoidFunction) {
    ...
    switch (level) {
      case 'error':
        this.devtoolsLogger.error(String(message), ...splat);
        break;
      case 'warn':
        this.devtoolsLogger.warn(String(message), ...splat);
        break;
      case 'info':
        this.devtoolsLogger.info(String(message), ...splat);
        break;
      case 'debug':
        this.devtoolsLogger.debug(String(message), ...splat);
        break;
      default:
        this.devtoolsLogger.info(String(message), ...splat);
    }
