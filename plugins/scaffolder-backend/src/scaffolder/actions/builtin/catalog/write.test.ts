...
import { ANNOTATION_ORIGIN_LOCATION } from '@devtools/catalog-model';
...
describe('catalog:write', () => {
  ...
  it('should add devtools.khulnasoft.com/source-template if provided', async () => {
    const entity = {
      apiVersion: 'devtools.khulnasoft.com/v1alpha1',
      kind: 'Component',
      metadata: {
    ...
    expectedEntity.metadata.annotations = {
      'devtools.khulnasoft.com/source-template': 'template:default/test-skeleton',
    };
