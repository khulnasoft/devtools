 ...
 */
import * as github from '@devtools/plugin-scaffolder-backend-module-github';
import * as gitlab from '@devtools/plugin-scaffolder-backend-module-gitlab';
import * as azure from '@devtools/plugin-scaffolder-backend-module-azure';
import * as bitbucket from '@devtools/plugin-scaffolder-backend-module-bitbucket';
...
import * as gerrit from '@devtools/plugin-scaffolder-backend-module-gerrit';

/**
 * @public
 * @deprecated use import from `@devtools/plugin-scaffolder-backend-module-github` instead
 */
...
/**
 * @public @deprecated use "createPublishBitbucketCloudAction" from \@devtools/plugin-scaffolder-backend-module-bitbucket-cloud or "createPublishBitbucketServerAction" from \@devtools/plugin-scaffolder-backend-module-bitbucket-server instead
 */
...
/**
 * @public
 * @deprecated use import from `@devtools/plugin-scaffolder-backend-module-bitbucket-cloud` instead
 */
...
/**
 * @public
 * @deprecated use import from `@devtools/plugin-scaffolder-backend-module-bitbucket-server` instead
 */
...
/**
 * @public
 * @deprecated use import from `@devtools/plugin-scaffolder-backend-module-azure` instead
 */
export const createPublishAzureAction = azure.createPublishAzureAction;

/**
 * @public
 * @deprecated use import from `@devtools/plugin-scaffolder-backend-module-gerrit` instead
 */
...
/**
 * @public
 * @deprecated use import from `@devtools/plugin-scaffolder-backend-module-gitlab` instead
 */
