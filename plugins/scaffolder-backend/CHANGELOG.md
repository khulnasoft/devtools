...
- 2f3d3a1eae: build(deps): bump `@gitbeaker/core` from 34.6.0 to 35.6.0
- Updated dependencies
  - @devtools/plugin-catalog-backend@1.1.0-next.2
...
- f9c7bdd899: **BREAKING**:
  ...
  - Removed the `createFetchCookiecutterAction` export, please use the `@devtools/plugin-scaffolder-backend-module-cookiecutter` package explicitly (see [its README](https://github.com/khulnasoft/devtools/tree/master/plugins/scaffolder-backend-module-cookiecutter) for installation instructions).
...
- 5c7f2343ea: Applied fix from version 0.17.2 of this package, which is part of the v0.69.2 release of Devtools.
...
- c7f6424a26: Applied fix from `v0.17.1` of this package which is part of the `v0.69.1` release of Devtools.
...
- Updated dependencies
  ...
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.2.3
...
- 9d9b2bab47: - **BREAKING** - Removed the re-export of types `TaskSpec` `TaskSpecV1Beta2` and `TaskSpecV1Beta3` these should now be import from `@devtools/plugin-scaffolder-common` directly.
  - **BREAKING** - Removed the `observe` method from the `TaskBroker` interface, this has now been replaced with an `Observable` implementation under `event# @devtools/plugin-scaffolder-backend.
...
- 67a7c02d26: Remove usages of `EntityRef` and `parseEntityName` from `@devtools/catalog-model`
...
- 6981ac4ad2: - **DEPRECATED** - The `containerRunner` option passed to `createBuiltinActions` has now been deprecated.
  ...
  The `fetch:cookiecutter` action will soon be removed from the default list of actions that are provided out of the box from the scaffolder plugin. It will still be supported, and maintained by the community, so you can install the package (`@devtools/plugin-scaffolder-backend-module-cookiecutter`) and pass it in as a custom action. Or you can migrate your templates to use [`fetch:template`](https://devtools.khulnasoft.com/docs/features/software-templates/builtin-actions#migrating-from-fetchcookiecutter-to-fetchtemplate) with the `cookiecutterCompat` option.
...
- Updated dependencies
  ...
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.2.2
...
- Updated dependencies
  ...
  - @devtools/plugin-catalog-backend@0.21.5
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.2.1
...
- 8db2b671c6: **BREAKING**: `ctx.token` is now `ctx.secrets.devtoolsToken` in Actions. Please update any of your Actions that might call out to Devtools API's with this token.
...
- 7d3471db94: Remove the previously deprecated `scaffolder.provider` config for all providers.
  This config is no longer used anywhere, and adopters should use [`integrations` config](https://devtools.khulnasoft.com/docs/integrations) instead.
...
- Updated dependencies
  ...
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.2.0
...
- Updated dependencies
  ...
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.11
...
- Updated dependencies
  ...
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.11-next.0
...
- c95df1631e: Added support for templating secrets into actions input, and also added an extra `token` input argument to all publishers to provide a token that would override the `integrations.config`.
  You can find more information over at [Writing Templates](https://devtools.khulnasoft.com/docs/features/software-templates/writing-templates#using-the-users-oauth-token)
- Updated dependencies
  - @devtools/plugin-catalog-backend@0.21.2
  - @devtools/backend-common@0.10.6
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.10
...
- Updated dependencies
  ...
  - @devtools/plugin-catalog-backend@0.21.2-next.1
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.10-next.1
...
- Updated dependencies
  ...
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.10-next.0
...
- ac2f1eeec0: This change is for adding the option of inputs on the `github:actions:dispatch` Devtools Action. This will allow users to pass data from Devtools to the GitHub Action.
- 0d5e846a78: Expose a new option to provide additional template filters via `@devtools/scaffolder-backend`'s `createRouter()` function.
- Updated dependencies
  - @devtools/plugin-catalog-backend@0.21.1
...
- b05d303226: Added the ability to support supplying secrets when creating tasks in the `scaffolder-backend`.
  ...
  **deprecation**: Deprecated `ctx.token` from actions in the `scaffolder-backend`. Please move to using `ctx.secrets.devtoolsToken` instead.

  **deprecation**: Deprecated `task.token` in `TaskSpec` in the `scaffolder-backend`. Please move to using `task.secrets.devtoolsToken` instead.
...
- Updated dependencies
  ...
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.9
  - @devtools/plugin-scaffolder-common@0.1.3
...
- Updated dependencies
  ...
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.9-next.0
  - @devtools/plugin-scaffolder-common@0.1.3-next.0
...
- Updated dependencies
  ...
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.8
...
- Updated dependencies
  ...
  - @devtools/plugin-catalog-backend@0.19.4
  - @devtools/plugin-scaffolder-common@0.1.2
  - @devtools/integration@0.7.0
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.7
...
- Updated dependencies
  ...
  - @devtools/plugin-catalog-backend@0.19.3
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.6
...
- Updated dependencies
  - @devtools/plugin-catalog-backend@0.19.2
...
- Updated dependencies
  ...
  - @devtools/plugin-catalog-backend@0.19.1
...
- Updated dependencies
  ...
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.5
...
- Updated dependencies
  ...
  - @devtools/plugin-catalog-backend@0.17.4
...
- b45a34fb15: Adds a new endpoint for consuming logs from the Scaffolder that uses long polling instead of Server Sent Events.
  ...
  This is useful if Devtools is accessed from an environment that doesn't support SSE correctly, which happens in combination with certain enterprise HTTP Proxy servers.
...
- Updated dependencies
  ...
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.4
...
- Updated dependencies
  ...
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.3
  - @devtools/plugin-scaffolder-common@0.1.1
...
- 18083d1821: Introduce the new `scaffolder.devtools.khulnasoft.com/v1beta3` template kind with nunjucks support 🥋
- Updated dependencies
...
- 618143c3c7: Action needed: If you are using the templates located at https://github.com/khulnasoft/devtools/tree/master/ in your Devtools app directly using the URL via the `app-config.yaml`, you should copy over the templates inside your org and import from there. The templates have now been moved to https://github.com/khulnasoft/software-templates. See https://github.com/khulnasoft/devtools/issues/6415 for explanation.
...
- 3f9dd1759: GitHub create repository webhook action: `github:webhook` for Devtools plugin Scaffolder has been added.
...
- Updated dependencies
  ...
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.2
...
- Updated dependencies
  ...
  - @devtools/plugin-scaffolder-backend-module-cookiecutter@0.1.1
...
- Updated dependencies
  - @devtools/catalog-client@0.3.17
...
- 31de5f27f: Add new `fetch:template` action which handles the same responsibilities as `fetch:cookiecutter` without the external dependency on `cookiecutter`. For information on migrating from `fetch:cookiecutter` to `fetch:template`, see the [migration guide](https://devtools.khulnasoft.com/docs/features/software-templates/builtin-actions#migrating-from-fetch-cookiecutter-to-fetch-template) in the docs.
...
- d7245b733: Remove runDockerContainer, and start using the utility function provided by @devtools/backend-common
...
- a5f42cf66: # Stateless scaffolding
  ...
  As well as adding the `@devtools/catalog-client` packages as a dependency of your backend package.
...
- ffffea8e6: Minor updates to reflect the changes in `@devtools/integration` that made the fields `apiBaseUrl` and `apiUrl` mandatory.
...
- 26a3a6cf0: Honor the branch ref in the url when cloning.
  ...
  catalog:
    locations:
      - type: url
        target: https://github.com/khulnasoft/devtools/blob/other/plugins/scaffolder-backend/sample-templates/docs-template/template.yaml
  ```
...
- 59166e5ec: `createRouter` of scaffolder backend will now require additional option as `entityClient` which could be generated by `CatalogEntityClient` in `plugin-scaffolder-backend` package. Here is example to generate `entityClient`.
  ...
  ```js
  import { CatalogEntityClient } from '@devtools/plugin-scaffolder-backend';
  import { SingleHostDiscovery } from '@devtools/backend-common';
