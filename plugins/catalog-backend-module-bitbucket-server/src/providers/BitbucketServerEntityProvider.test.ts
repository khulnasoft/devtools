    ...
    const expectedEntities = [
      {
        entity: {
          ...
          metadata: {
            annotations: {
              'devtools.khulnasoft.com/managed-by-location': `url:${url}`,
              'devtools.khulnasoft.com/managed-by-origin-location': `url:${url}`,
            },
    ...
    const expectedEntities = [
      {
        entity: {
          ...
          metadata: {
            annotations: {
              'devtools.khulnasoft.com/managed-by-location': `url:https://${host}/projects/project-test/repos/repo-test/browse/catalog-info.yaml`,
              'devtools.khulnasoft.com/managed-by-origin-location': `url:https://${host}/projects/project-test/repos/repo-test/browse/catalog-info.yaml`,
            },
            name: 'generated-77f4323822420990f8c3e3c981d38c2dec4ae3a6',
          },
          spec: {
      ...
      },
      {
        entity: {
          ...
          metadata: {
            annotations: {
              'devtools.khulnasoft.com/managed-by-location': `url:https://${host}/projects/other-project/repos/other-repo/browse/catalog-info.yaml`,
              'devtools.khulnasoft.com/managed-by-origin-location': `url:https://${host}/projects/other-project/repos/other-repo/browse/catalog-info.yaml`,
            },
