...
import { assertError, InputError, NotFoundError } from '@devtools/errors';
import {
...
export async function getOctokitOptions(options: {
  ...
  if (!credentialProviderToken) {
    throw new InputError(
      `No token available for host: ${host}, with owner ${owner}, and repo ${repo}. Make sure GitHub auth is configured correctly. See https://devtools.khulnasoft.com/docs/auth/github/provider for more details.`,
    );
  }
