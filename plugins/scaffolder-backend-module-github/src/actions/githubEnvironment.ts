...
export function createGithubEnvironmentAction(options: {
  ...
  //   https://devtools.khulnasoft.com/docs/features/software-templates/writing-custom-actions
  return createTemplateAction<{
      ...
      input: {
        ...
        properties: {
          ...
          reviewers: {
            ...
            type: 'array',
            description:
              'Reviewers for this environment. Must be a list of Devtools entity references.',
            items: {
              type: 'string',
            },
          },
    ...
    async handler(ctx) {
      ...
      })) ?? { token: ctx.secrets?.devtoolsToken };
