...
import { CustomErrorBase, InputError } from '@devtools/errors';
...
export interface CreateGithubPullRequestActionOptions {
  /**
   * An instance of {@link @devtools/integration#ScmIntegrationRegistry} that will be used in the action.
   */
  integrations: ScmIntegrationRegistry;
  /**
   * An instance of {@link @devtools/integration#GithubCredentialsProvider} that will be used to get credentials for the action.
   */
  ...
  >;
  /**
   * An instance of {@link @devtools/config#Config} that will be used in the action.
   */
  config?: Config;
}
      ...
      input: {
        ...
        properties: {
          ...
          gitAuthorEmail: {
            ...
            description:
              "Sets the default author email for the commit. The default value is the authenticated user or 'scaffolder@devtools.khulnasoft.com'",
          },
          forceEmptyGitAuthor: {
            type: 'boolean',
            ...
            if (Array.isArray(createOptions.changes)) {
              createOptions.changes = createOptions.changes.map(change => ({
                ...
                author: {
                  ...
                  email: gitAuthorInfo.email || 'scaffolder@devtools.khulnasoft.com',
                },
              }));
            } else {
