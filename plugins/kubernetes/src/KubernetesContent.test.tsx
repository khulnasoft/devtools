...
import { useKubernetesObjects } from '@devtools/plugin-kubernetes-react';
...
jest.mock('@devtools/plugin-kubernetes-react', () => ({
  ...jest.requireActual('@devtools/plugin-kubernetes-react'),
