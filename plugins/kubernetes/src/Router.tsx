...
const KUBERNETES_ANNOTATION = 'devtools.khulnasoft.com/kubernetes-id';
  ...
  return (
    <>
      ...
      <Button
        variant="contained"
        color="primary"
        href="https://devtools.khulnasoft.com/docs/features/kubernetes/configuration#surfacing-your-kubernetes-components-as-part-of-an-entity"
      >
