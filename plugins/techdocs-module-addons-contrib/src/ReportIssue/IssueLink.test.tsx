...
const defaultGitlabProps = {
  repository: {
    type: 'gitlab',
    name: 'devtoolsSubgroup/devtools',
    owner: 'devtools',
    protocol: 'https',
    resource: 'gitlab.com',
  },
...
describe('FeedbackLink', () => {
  ...
  it('Should open new Github issue tab', async () => {
    ...
    expect(link).toHaveAttribute(
      'href',
      `https://github.com/khulnasoft/devtools/issues/new?title=${encodedTitle}&body=${encodedBody}`,
    );
  });
  ...
  it('Should open new Gitlab issue tab', async () => {
    ...
    expect(link).toHaveAttribute(
      'href',
      `https://gitlab.com/khulnasoft/devtoolsSubgroup/devtools/issues/new?issue[title]=${encodedTitle}&issue[description]=${encodedBody}`,
    );
  });
