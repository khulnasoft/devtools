...
import { scmIntegrationsApiRef } from '@devtools/integration-react';
...
describe('ReportIssue', () => {
  ...
  it('renders github link without exploding', async () => {
                  ...
                  <div className="md-content">
                    <article>
                      <a
                        ...
                        href="https://github.com/khulnasoft/devtools/issues/new"
                      >
                        Leave feedback
                      </a>
                      <a
                        title="Edit this page"
                        href="https://github.com/khulnasoft/devtools/edit/master/docs/README.md"
                      >
                        Edit page
                      </a>
                    </article>
    ...
    await waitFor(() => {
      ...
      expect(link).toHaveAttribute(
        'href',
        'https://github.com/khulnasoft/devtools/issues/new?title=Documentation%20feedback%3A%20his%20&body=%23%23%20Documentation%20Feedback%20%F0%9F%93%9D%0A%0A%20%23%23%23%23%20The%20highlighted%20text%3A%20%0A%0A%20%3E%20his%0A%0A%20%23%23%23%23%20The%20comment%20on%20the%20text%3A%20%0A%20_%3Ereplace%20this%20line%20with%20your%20comment%3C_%0A%0A%20___%0ADevtools%20URL%3A%20%3Chttp%3A%2F%2Flocalhost%2F%3E%20%0AMarkdown%20URL%3A%20%3Chttps%3A%2F%2Fgithub.com%2Fdevtools%2Fdevtools%2Fblob%2Fmaster%2Fdocs%2FREADME.md%3E',
      );
    });
  });
  ...
  it('renders gitlab link without exploding', async () => {
                ...
                <div data-md-component="main">
                  <div className="md-content">
                    <article>
                      <a
                        title="Leave feedback for this page"
                        href="https://gitlab.com/khulnasoft/devtools/issues/new"
                      >
                        Leave feedback
                      </a>
                      <a
                        title="Edit this page"
                        href="https://gitlab.com/khulnasoft/devtools/-/edit/master/docs/README.md"
                      >
                        Edit page
                      </a>
                    </article>
    ...
    await waitFor(() => {
      ...
      expect(link).toHaveAttribute(
        'href',
        'https://gitlab.com/khulnasoft/devtools/issues/new?issue[title]=Documentation%20feedback%3A%20his%20&issue[description]=%23%23%20Documentation%20Feedback%20%F0%9F%93%9D%0A%0A%20%23%23%23%23%20The%20highlighted%20text%3A%20%0A%0A%20%3E%20his%0A%0A%20%23%23%23%23%20The%20comment%20on%20the%20text%3A%20%0A%20_%3Ereplace%20this%20line%20with%20your%20comment%3C_%0A%0A%20___%0ADevtools%20URL%3A%20%3Chttp%3A%2F%2Flocalhost%2F%3E%20%0AMarkdown%20URL%3A%20%3Chttps%3A%2F%2Fgitlab.com%2Fdevtools%2Fdevtools%2F-%2Fblob%2Fmaster%2Fdocs%2FREADME.md%3E',
      );
    });
  });
  ...
  it('renders using a custom template builder', async () => {
    ...
    await waitFor(() => {
      ...
      expect(link).toHaveAttribute(
        'href',
        'https://gitlab.com/khulnasoft/devtools/issues/new?issue[title]=Custom&issue[description]=his',
      );
    });
  });
});
