 ...
 * import { ExpandableNavigation } from '@devtools/plugin-techdocs-module-addons-contrib';
 *
 *
 * const AppRoutes = () => {
 *   <FlatRoutes>
 ...
 *
 * @remarks
 * Before using it, you should set up an `edit_uri` for your pages as explained {@link https://devtools.khulnasoft.com/docs/features/techdocs/faqs#is-it-possible-for-users-to-suggest-changes-or-provide-feedback-on-a-techdocs-page | here} and remember, it only works for Github or Gitlab.
 *
 * @example
 * Here's a simple example:
 * ```
