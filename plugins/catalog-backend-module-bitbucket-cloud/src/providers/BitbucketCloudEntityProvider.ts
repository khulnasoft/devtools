...
import { LocationEntity } from '@devtools/catalog-model';
...
import {
  ...
  Events,
  Models,
} from '@devtools/plugin-bitbucket-cloud-common';
import {
  DeferredEntity,
  EntityProvider,
...
export class BitbucketCloudEntityProvider implements EntityProvider {
  ...
  /** {@inheritdoc @devtools/plugin-catalog-backend#EntityProvider.getTaskId} */
  getTaskId(): string {
