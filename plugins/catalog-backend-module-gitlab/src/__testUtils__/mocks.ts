 ...
 */
import { locationSpecToMetadataName } from '@devtools/plugin-catalog-node';
    ...
    .map(project => {
      ...
      return {
        entity: {
          ...
          metadata: {
            annotations: {
              'devtools.khulnasoft.com/managed-by-location': `url:${targetUrl}`,
              'devtools.khulnasoft.com/managed-by-origin-location': `url:${targetUrl}`,
            },
...
export const expected_group_entity: MockObject[] = [
  {
    entity: {
      ...
      metadata: {
        annotations: {
          'devtools.khulnasoft.com/managed-by-location': 'url:https://example.com/group3',
...
export const expected_group_user_entity: MockObject[] = [
  {
    entity: {
      ...
      metadata: {
        annotations: {
          'devtools.khulnasoft.com/managed-by-location': 'url:https://example.com/group1',
          'devtools.khulnasoft.com/managed-by-origin-location':
...
export const expected_single_user_entity: MockObject[] = [
  {
    entity: {
      ...
      metadata: {
        annotations: {
          'devtools.khulnasoft.com/managed-by-location': 'url:https://example.com/JohnDoe',
          'devtools.khulnasoft.com/managed-by-origin-location':
...
export const expected_full_org_scan_entities: MockObject[] = [
  ...
  },
  {
    entity: {
      ...
      metadata: {
        annotations: {
          'devtools.khulnasoft.com/managed-by-location': 'url:https://example.com/JaneDoe',
          'devtools.khulnasoft.com/managed-by-origin-location':
