...
import { SchedulerServiceTaskScheduleDefinitionConfig } from '@devtools/backend-plugin-api';
    ...
    providers?: {
      ...
      awsS3?:
        | {
             ...
             * @see https://github.com/khulnasoft/devtools/blob/master/packages/integration-aws-node/README.md
             */
            accountId?: string;
            /**
