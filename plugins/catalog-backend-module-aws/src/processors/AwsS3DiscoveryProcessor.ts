 ...
 *
 * @public
 * @deprecated Use the `AwsS3EntityProvider` instead (see https://github.com/khulnasoft/devtools/blob/master/plugins/catalog-backend-module-aws/CHANGELOG.md#014).
 */
