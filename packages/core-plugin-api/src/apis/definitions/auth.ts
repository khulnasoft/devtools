...
export type AuthProviderInfo = {
  /**
   * The ID of the auth provider. This should match with ID of the provider in the `@devtools/auth-backend`.
   */
  id: string;
...
export type OAuthApi = {
   ...
   * it is best to log out the Devtools session and then visit your plugin page directly, as
...
export type OpenIdConnectApi = {
   ...
   *
   * If the user has not yet logged in to Google inside Devtools, the user will be prompted
...
/**
 * This API provides access to the user's identity within Devtools.
 *
 * @remarks
 *
 * An auth provider that implements this interface can be used to sign-in to devtools. It is
 ...
 * @public
 */
export type DevtoolsIdentityApi = {
  /**
   * Get the user's identity within Devtools. This should normally not be called directly,
 ...
 * @public
 */
export type DevtoolsIdentityResponse = {
  /**
...
export const githubAuthApiRef: ApiRef<
  OAuthApi & ProfileInfoApi & DevtoolsIdentityApi & SessionApi
> = createApiRef({
  id: 'core.auth.github',
});
