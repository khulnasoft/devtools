...
import { Extension, DevtoolsPlugin } from '../plugin';
 ...
 *
 * See {@link https://devtools.khulnasoft.com/docs/plugins/composability#extensions}.
 *
 * @public
 */
...
>(options: {
   ...
   *
   * If this extension is placed somewhere in the app element tree of a Devtools
