...
const VERSIONS_BASE_URL = 'https://versions.devtools.khulnasoft.com';
const GITHUB_RAW_BASE_URL =
  'https://raw.githubusercontent.com/devtools/versions/main';

/**
 * Contains mapping between Devtools release and package versions.
 * @public
 */
