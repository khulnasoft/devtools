...
export interface Config {
  ...
  app: {
    ...
    /**
     * The title of the app, as shown in the Devtools web interface.
     * @visibility frontend
     */
    title?: string;

    /**
     * Information about support of this Devtools instance and how to contact the integrator team.
     */
    support?: {
      /**
      ...
      items: Array<{
        ...
        icon?: string;
        /**
         * A list of support links for the Devtools instance inside this grouping.
         */
        links: Array<{
          /** @visibility frontend */
          url: string;
