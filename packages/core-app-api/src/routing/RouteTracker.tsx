 ...
 * Devtools route objects.
 */
const getExtensionContext = (
  pathname: string,
  routes: DevtoolsRouteObject[],
) => {
  try {
    ...
    // the DevtoolsRouteObject that contains a routeRef. Filtering by routeRef
    ...
    let plugin: DevtoolsPlugin | undefined;
