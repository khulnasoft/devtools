...
type CompatiblePlugin =
  | DevtoolsPlugin
  | (Omit<DevtoolsPlugin, 'getFeatureFlags'> & {
...
export class AppManager implements DevtoolsApp {
  ...
  getPlugins(): DevtoolsPlugin[] {
    return Array.from(this.plugins) as DevtoolsPlugin[];
  }
...
DEPRECATION WARNING: React Router Beta is deprecated and support for it will be removed in a future release.
                     ...
                     See https://devtools.khulnasoft.com/docs/tutorials/react-router-stable-migration
`);
        }
