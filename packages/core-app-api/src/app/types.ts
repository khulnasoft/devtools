...
/**
 * A set of replaceable core components that are part of every Devtools app.
 *
 * @public
 */
...
export type AppOptions = {
   ...
   * light variant of the default devtools theme, and one dark.
   *
   ...
   *  that was packaged by the devtools-cli and default docker container boot script.
   */
  ...
  __experimentalTranslations?: {
    ...
    resources?: Array<
      ...
      | { $$type: '@devtools/TranslationResource'; id: string }
      | {
...
export type DevtoolsApp = {
   ...
   *
   * @deprecated Use {@link DevtoolsApp.createRoot} instead.
   */
   ...
   *
   * @deprecated Import and use the {@link AppRouter} component from `@devtools/core-app-api` instead
   */
