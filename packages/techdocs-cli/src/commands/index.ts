...
import { TechdocsGenerator } from '@devtools/plugin-techdocs-node';
...
export function registerCommands(program: Command) {
  program
    ...
    .option(
      ...
      'The repository hosting documentation source files e.g. url:https://ghe.mycompany.net.com/org/repo.' +
        '\nThis value is same as the devtools.khulnasoft.com/techdocs-ref annotation of the corresponding Devtools entity.' +
  ...
  program
    ...
    .requiredOption(
      '--publisher-type <TYPE>',
      '(Required always) awsS3 | googleGcs | azureBlobStorage | openStackSwift - same as techdocs.publisher.type in Devtools app-config.yaml',
    )
    .requiredOption(
...
// Humbly taken from devtools-cli's registerCommands
function lazy(
