...
import {
  ...
  TemplateDevtoolsLogo,
  TemplateDevtoolsLogoIcon,
} from '@devtools/plugin-home';
import { wrapInTestApp, TestApiProvider } from '@devtools/test-utils';
import { Content, Page, InfoCard } from '@devtools/core-components';
import {
...
import { HomePageSearchBar, searchPlugin } from '@devtools/plugin-search';
import {
  searchApiRef,
      ...
      <Page themeId="home">
        <Content>
          <Grid container justifyContent="center" spacing={6}>
            <HomePageCompanyLogo
              className={container}
              logo={<TemplateDevtoolsLogo classes={{ svg, path }} />}
            />
