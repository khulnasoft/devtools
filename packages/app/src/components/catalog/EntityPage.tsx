...
import { EmptyState } from '@devtools/core-components';
import {
...
} from '@devtools/plugin-kubernetes-cluster';
import {
  EntityGroupProfileCard,
  EntityMembersListCard,
  EntityOwnershipCard,
  EntityUserProfileCard,
} from '@devtools/plugin-org';
  ...
  <EntitySwitch>
    <EntitySwitch.Case>
      <EmptyState
        ...
        missing="info"
        description="You need to add an annotation to your component if you want to enable CI/CD for it. You can read more about annotations in Devtools by clicking the button below."
        action={
          <Button
            variant="contained"
            color="primary"
            href="https://devtools.khulnasoft.com/docs/features/software-catalog/well-known-annotations"
          >
            Read more
          </Button>
        }
