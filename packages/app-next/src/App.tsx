...
import userSettingsPlugin from '@devtools/plugin-user-settings/alpha';
import homePlugin, {
  titleExtensionDataRef,
} from '@devtools/plugin-home/alpha';
...
import appVisualizerPlugin from '@devtools/plugin-app-visualizer';
import { homePage } from './HomePage';
import { convertLegacyApp } from '@devtools/core-compat-api';
...
import { convertLegacyPlugin } from '@devtools/core-compat-api';
import { convertLegacyPageExtension } from '@devtools/core-compat-api';
import { convertLegacyEntityContentExtension } from '@devtools/plugin-catalog-react/alpha';
...
TODO:
 ...
 - figure out how to resolve configured extension ref to runtime value, e.g. '@devtools/plugin-graphiql#GraphiqlPage'
...
//   return ['@devtools/plugin-graphiql'];
// };
