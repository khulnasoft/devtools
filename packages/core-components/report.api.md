...
// Warning: (ae-forgotten-export) The symbol "DevtoolsComponentsNameToClassKey" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
export type DevtoolsOverrides = Overrides & {
  [Name in keyof DevtoolsComponentsNameToClassKey]?: Partial<
    StyleRules_2<DevtoolsComponentsNameToClassKey[Name]>
  >;
};
...
//
// src/components/DependencyGraph/types.d.ts:22:9 - (ae-unresolved-link) The @link reference could not be resolved: The package "@devtools/core-components" does not have an export "DependencyNode"
// src/components/DependencyGraph/types.d.ts:26:9 - (ae-unresolved-link) The @link reference could not be resolved: The package "@devtools/core-components" does not have an export "DependencyNode"
