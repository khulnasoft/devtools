...
import { useApiHolder, configApiRef } from '@devtools/core-plugin-api';
    ...
    items: [
      {
        ...
        links: [
          {
            // TODO: Update to dedicated support page on devtools.khulnasoft.com/docs
            title: t('supportConfig.default.linkTitle'),
            url: 'https://github.com/khulnasoft/devtools/blob/master/app-config.yaml',
          },
        ],
      },
    ],
