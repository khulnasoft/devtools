 ...
 * various devtools user identity representations.
 *
 * @public
 */
export class UserIdentity implements IdentityApi {
   ...
   * and an auth API that will be used to request devtools tokens.
   *
   * @public
   */
  static create(options: {
    identity: DevtoolsUserIdentity;
    authApi: ProfileInfoApi & DevtoolsIdentityApi & SessionApi;
    /**
     * Passing a profile synchronously allows the deprecated `getProfile` method to be
     * called by consumers of the {@link @devtools/core-plugin-api#IdentityApi}. If you
  ...
  private constructor(
    private readonly identity: DevtoolsUserIdentity,
  ...
  /** {@inheritdoc @devtools/core-plugin-api#IdentityApi.getUserId} */
  getUserId(): string {
  ...
  /** {@inheritdoc @devtools/core-plugin-api#IdentityApi.getIdToken} */
  async getIdToken(): Promise<string | undefined> {
    const identity = await this.authApi.getDevtoolsIdentity();
    return identity!.token;
  }

  /** {@inheritdoc @devtools/core-plugin-api#IdentityApi.getProfile} */
  ...
  /** {@inheritdoc @devtools/core-plugin-api#IdentityApi.getProfileInfo} */
  ...
  /** {@inheritdoc @devtools/core-plugin-api#IdentityApi.getDevtoolsIdentity} */
  async getDevtoolsIdentity(): Promise<DevtoolsUserIdentity> {
    return this.identity;
  }

  /** {@inheritdoc @devtools/core-plugin-api#IdentityApi.getCredentials} */
  async getCredentials(): Promise<{ token?: string | undefined }> {
    const identity = await this.authApi.getDevtoolsIdentity();
    return { token: identity!.token };
  }

  /** {@inheritdoc @devtools/core-plugin-api#IdentityApi.signOut} */
