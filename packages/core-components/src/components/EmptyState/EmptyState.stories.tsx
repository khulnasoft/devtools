...
export const MissingAnnotation = () => (
  <div style={containerStyle}>
    <MissingAnnotationEmptyState
      annotation={['devtools.khulnasoft.com/foo', 'devtools.khulnasoft.com/bar']}
    />
  </div>
);
  ...
  <div style={containerStyle}>
    <EmptyState
      ...
      missing={{
        customImage: (
          <img
            src="https://devtools.khulnasoft.com/animations/devtools-software-catalog-icon-1.gif"
            alt="Devtools example"
          />
        ),
      }}
    />
