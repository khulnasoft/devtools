...
const COMPONENT_YAML_TEMPLATE = `apiVersion: devtools.khulnasoft.com/v1alpha1
kind: Component
metadata:
  name: example
...
const useStyles = makeStyles(
  ...
  { name: 'DevtoolsMissingAnnotationEmptyState' },
);
...
/**
 * @public
 * @deprecated This component is deprecated, please use {@link @devtools/plugin-catalog-react#MissingAnnotationEmptyState} instead
 */
export function MissingAnnotationEmptyState(props: Props) {
  ...
  const url =
    readMoreUrl ||
    'https://devtools.khulnasoft.com/docs/features/software-catalog/well-known-annotations';
