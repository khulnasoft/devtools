...
describe('linkify', () => {
  it('should add links around URLs', async () => {
    ...
    const testText = new AnsiLine(1, [
      {
        text: 'Fetching template content from remote URL: https://github.com/khulnasoft/software-templates/tree/main/scaffolder-templates/react-ssr-template/skeleton',
        modifiers: {},
      },
    ]);
    ...
    const link = await rendered.findByText(
      'https://github.com/khulnasoft/software-templates/tree/main/scaffolder-templates/react-ssr-template/skeleton',
    );
