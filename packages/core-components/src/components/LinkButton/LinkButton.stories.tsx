...
import { createRouteRef, useRouteRef } from '@devtools/core-plugin-api';
  ...
  decorators: [
    (Story: ComponentType<PropsWithChildren<{}>>) =>
      wrapInTestApp(
        <>
          <Typography>
            A collection of buttons that should be used in the Devtools
            interface. These leverage the properties inherited from{' '}
            <Link to="https://material-ui.com/components/buttons/">
              Material UI Button
            </Link>
            , but include an opinionated set that align to the Devtools design.
          </Typography>
  ...
  return (
    <>
      <List>
        ...
        <ListItem>
          <MaterialButton
            href="https://devtools.khulnasoft.com"
            color="default"
            variant="outlined"
          >
            View URL
