...
import { stringifyError } from '@devtools/errors';
...
import appPlugin from '@devtools/plugin-app';
import {
  CreateAppRouteBinder,
  FrontendFeature,
  createSpecializedApp,
} from '@devtools/frontend-app-api';
...
/**
 * Creates a new Devtools frontend app instance. See https://devtools.khulnasoft.com/docs/frontend-system/building-apps/index
 *
 * @public
 */
