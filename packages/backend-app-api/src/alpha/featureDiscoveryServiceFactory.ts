...
import { featureDiscoveryServiceRef } from '@devtools/backend-plugin-api/alpha';
...
/**
 * @alpha
 * @deprecated The `featureDiscoveryServiceFactory` is deprecated in favor of using {@link @devtools/backend-defaults#discoveryFeatureLoader} instead.
 */
