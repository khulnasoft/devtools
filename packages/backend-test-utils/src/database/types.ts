  ...
  Object.freeze({
    POSTGRES_16: {
      ...
      connectionStringEnvironmentVariableName:
        'DEVTOOLS_TEST_DATABASE_POSTGRES16_CONNECTION_STRING',
    },
    POSTGRES_15: {
      name: 'Postgres 15.x',
      driver: 'pg',
      ...
      connectionStringEnvironmentVariableName:
        'DEVTOOLS_TEST_DATABASE_POSTGRES15_CONNECTION_STRING',
    },
    POSTGRES_14: {
      name: 'Postgres 14.x',
      driver: 'pg',
      ...
      connectionStringEnvironmentVariableName:
        'DEVTOOLS_TEST_DATABASE_POSTGRES14_CONNECTION_STRING',
    },
    POSTGRES_13: {
      name: 'Postgres 13.x',
      driver: 'pg',
