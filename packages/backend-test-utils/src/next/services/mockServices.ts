...
import { HostDiscovery } from '@devtools/backend-defaults/discovery';
...
export namespace mockServices {
  ...
  export function userInfo(
    customInfo?: Partial<DevtoolsUserInfo>,
  ): UserInfoService {
   ...
   * {@link @devtools/backend-plugin-api#coreServices.database}. Just returns
  ...
  export namespace database {
     ...
     * {@link @devtools/backend-plugin-api#coreServices.database}, optionally
