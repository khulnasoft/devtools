...
export class MockHttpAuthService implements HttpAuthService {
  #auth: AuthService;
  #defaultCredentials: DevtoolsCredentials;

  constructor(pluginId: string, defaultCredentials: DevtoolsCredentials) {
  ...
  async issueUserCookie(
    res: Response,
    options?: { credentials?: DevtoolsCredentials<DevtoolsUserPrincipal> },
