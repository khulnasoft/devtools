...
import { useVersionedContext } from '@devtools/version-bridge';
 ...
 * from `@devtools/core-plugin-api` to be used in an app from `@devtools/frontend-app-api`,
 * and APIs from `@devtools/frontend-plugin-api` to be used in an app from `@devtools/core-app-api`.
 *
 * @public
 */
