...
// eslint-disable-next-line @devtools/no-relative-monorepo-imports
...
function toNewPlugin(plugin: LegacyDevtoolsPlugin): NewFrontendPlugin {
...
function LegacyAppContextProvider(props: { children: ReactNode }) {
  ...
  const appContext = useMemo(() => {
    ...
    let gatheredPlugins: LegacyDevtoolsPlugin[] | undefined = undefined;
    ...
    return {
      getPlugins(): LegacyDevtoolsPlugin[] {
        if (gatheredPlugins) {
          return gatheredPlugins;
        }

        const pluginSet = new Set<LegacyDevtoolsPlugin>();
