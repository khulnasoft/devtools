...
function convertNewToOld(
  ...
  if (ref.$$type === '@devtools/SubRouteRef') {
  ...
  if (ref.$$type === '@devtools/ExternalRouteRef') {
...
function convertOldToNew(
  ...
  if (type === 'absolute') {
    ...
    return Object.assign(legacyRef, {
      $$type: '@devtools/RouteRef' as const,
      version: 'v1',
      T: newRef.T,
      getParams() {
  ...
  if (type === 'sub') {
    ...
    return Object.assign(legacyRef, {
      $$type: '@devtools/SubRouteRef' as const,
      version: 'v1',
      T: newRef.T,
      getParams() {
        return newRef.getParams();
  ...
  if (type === 'external') {
    ...
    return Object.assign(legacyRef, {
      $$type: '@devtools/ExternalRouteRef' as const,
      version: 'v1',
      T: newRef.T,
      getParams() {
        return newRef.getParams();
