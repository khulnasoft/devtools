...
import { getManifestByVersion } from '@devtools/release-manifests';
...
export const getPackageVersion = async (
  ...
  const devtoolsVersion = getCurrentDevtoolsVersion();
  ...
  if (!manifestEntry) {
    throw new Error(
      `Package ${ident} not found in manifest for Devtools v${devtoolsVersion}. ` +
        `This means the specified package is not included in this Devtools ` +
