...
/**
 * Common options for the default Devtools configuration sources.
 *
 * @public
 */
...
export class ConfigSources {
  ...
  /**
   * Creates the default config source for Devtools.
   *
   * @remarks
   *
   ...
   *
   * @param options - Options
   * @returns The default Devtools config source
   */
  ...
  /**
   * Creates an observable {@link @devtools/config#Config} implementation from a {@link ConfigSource}.
   *
   * @remarks
   *
