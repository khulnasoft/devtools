  ...
  it('should not include schemas for backend-common if theres a backend-defaults package', async () => {
    mockDir.setContent({
      root: {
        'package.json': JSON.stringify({
          name: 'root',
          dependencies: {
            '@devtools/backend-common': '1',
            '@devtools/backend-defaults': '1',
          },
      ...
      node_modules: {
        '@devtools': {
          ...
          'backend-defaults': {
            'package.json': JSON.stringify({
              name: '@devtools/backend-defaults',
              version: '1',
    ...
    await expect(
      ...
      },
      {
        ...
        packageName: '@devtools/backend-defaults',
      },
    ]);
  });
    ...
    mockDir.setContent({
      ...
      node_modules: {
        a: {
          'package.json': JSON.stringify({
            name: 'a',
            dependencies: { b: '0.0.0', '@devtools/mock': '0.0.0' },
          }),
        },
        b: {
          'package.json': JSON.stringify({
