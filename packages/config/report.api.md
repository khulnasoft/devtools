## API Report File for "@devtools/config"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts
import { Config as Config_2 } from '@devtools/config';
import { HumanDuration } from '@devtools/types';
import type { JsonArray as JsonArray_2 } from '@devtools/types';
import { JsonObject as JsonObject_2 } from '@devtools/types';
import type { JsonPrimitive as JsonPrimitive_2 } from '@devtools/types';
import { JsonValue as JsonValue_2 } from '@devtools/types';
