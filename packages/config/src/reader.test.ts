...
describe('ConfigReader', () => {
  ...
  it('should warn when accessing filtered keys in development mode', () => {
    ...
    expect(withLogCollector(() => config.getOptional('a'))).toMatchObject({
      warn: [
        "Failed to read configuration value at 'a' as it is not visible. See https://devtools.khulnasoft.com/docs/conf/defining#visibility for instructions on how to make it visible.",
      ],
    });
    expect(
      ...
      warn: [
        "Failed to read configuration value at 'a2' as it is not visible. See https://devtools.khulnasoft.com/docs/conf/defining#visibility for instructions on how to make it visible.",
      ],
    });
    expect(
      ...
      warn: [
        "Failed to read configuration array at 'b' as it does not have any visible elements. See https://devtools.khulnasoft.com/docs/conf/defining#visibility for instructions on how to make it visible.",
      ],
    });
