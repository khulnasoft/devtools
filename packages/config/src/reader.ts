...
import { JsonValue, JsonObject } from '@devtools/types';
          ...
          if (
            ...
            console.warn(
              `Failed to read configuration value at '${fullKey}' as it is not visible. ` +
                'See https://devtools.khulnasoft.com/docs/conf/defining#visibility for instructions on how to make it visible.',
            );
          }
        }
      }
