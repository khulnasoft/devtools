...
const LanguageSwitcher: Component = () => {
  ...
  return (
    <>
      ...
      <DropdownMenuItem as="a" class="flex items-center gap-2 cursor-pointer" target="_blank" rel="noopener noreferrer" href="https://github.com/khulnasoft/devtools/tree/main/packages/app-client/src/locales">
    ...
    <div class="border-b border-border bg-surface">
      <div class="flex items-center justify-between px-6 py-3 mx-auto max-w-1200px">
        ...
        <div class="flex gap-2 items-center">
          ...
          <Button variant="ghost" class="text-lg px-0 size-9 hidden md:inline-flex" as={A} href="https://github.com/khulnasoft/devtools" target="_blank" rel="noopener noreferrer" aria-label={t('navbar.github-repository')}>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent class="w-46">
              ...
              {/* Mobile only items */}
              <DropdownMenuItem as="a" class="flex items-center gap-2 cursor-pointer md:hidden" target="_blank" href="https://github.com/khulnasoft/devtools" rel="noopener noreferrer">
              ...
              <DropdownMenuItem as="a" class="flex items-center gap-2 cursor-pointer" target="_blank" href="https://github.com/khulnasoft/devtools/issues/new/choose" rel="noopener noreferrer">
  ...
  return (
    <div class="bg-surface border-t border-border py-6 px-6 text-center text-muted-foreground flex flex-col sm:flex-row items-center justify-center gap-1">
      <div>
        {t('footer.crafted-by')}
        {' '}
        <Button variant="link" as="a" href="https://khulnasoft.com" target="_blank" class="p-0 text-muted-foreground underline hover:text-primary transition font-normal h-auto">Md Sulaiman</Button>
        .
      </div>
      <div>
        {t('footer.source-code')}
        {' '}
        <Button variant="link" as="a" href="https://github.com/khulnasoft/devtools" target="_blank" class="p-0 text-muted-foreground underline hover:text-primary transition font-normal h-auto">{t('footer.github')}</Button>
        .
      </div>
      ...
      <div>
        {t('footer.version')}
        {' '}
        <Button variant="link" as="a" href={`https://github.com/khulnasoft/devtools/tree/v${buildTimeConfig.enclosedVersion}`} target="_blank" class="p-0 text-muted-foreground underline hover:text-primary transition font-normal h-auto">
          v
