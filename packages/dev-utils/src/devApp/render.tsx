...
import { TranslationResource } from '@devtools/core-plugin-api/alpha';
import {
  ScmIntegrationsApi,
...
export class DevAppBuilder {
  private readonly plugins = new Array<DevtoolsPlugin>();
   ...
   */
  registerPlugin(...plugins: DevtoolsPlugin[]): DevAppBuilder {
