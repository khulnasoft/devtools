...
/**
 * Devtools specific additions to the material-ui palette.
 *
 * @public
 */
export type DevtoolsPaletteAdditions = {
  status: {
    ok: string;
    warning: string;
    error: string;
...
/**
 * Devtools specific additions to the material-ui theme.
 *
 * @public
 */
export type DevtoolsThemeAdditions = {
  page: PageTheme;
 ...
 * @public
 */
export type DevtoolsTypography = {
  htmlFontSize: number;
  fontFamily: string;
  h1: {
    fontFamily?: string;
