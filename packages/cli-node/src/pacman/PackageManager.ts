...
/**
 * Represents the package manager in use by this instance of Devtools. This
 * interface allows Devtools adopters to change the package manager used by
 * their repo and still use the Devtools CLI, and it's helpful tooling.
 *
 * @public
 */
export interface PackageManager {
  ...
  /**
   * Whether the package manager supports the 'devtools:^' version protocol.
   */
  supportsDevtoolsVersionProtocol(): Promise<boolean>;
