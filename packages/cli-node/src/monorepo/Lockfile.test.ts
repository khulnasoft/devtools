...
"@devtools/app-defaults@workspace:^, @devtools/app-defaults@workspace:packages/app-defaults":
  version: 0.0.0-use.local
  resolution: "@devtools/app-defaults@workspace:packages/app-defaults"
  dependencies:
...
"@devtools/backend-app-api@workspace:^, @devtools/backend-app-api@workspace:packages/backend-app-api":
  version: 0.0.0-use.local
  resolution: "@devtools/backend-app-api@workspace:packages/backend-app-api"
  dependencies:
    "@devtools/backend-common": "^0.25.0"
    "@devtools/backend-plugin-api": "workspace:^"
    "@devtools/backend-tasks": "workspace:^"
    "@devtools/cli": "workspace:^"
