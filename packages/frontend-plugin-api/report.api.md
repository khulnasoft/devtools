## API Report File for "@devtools/frontend-plugin-api"
...
import { ApiRefConfig } from '@devtools/core-plugin-api';
import { AppTheme } from '@devtools/core-plugin-api';
import { AppThemeApi } from '@devtools/core-plugin-api';
import { appThemeApiRef } from '@devtools/core-plugin-api';
...
import { createApiFactory } from '@devtools/core-plugin-api';
...
import { FeatureFlagState } from '@devtools/core-plugin-api';
...
import { IconComponent as IconComponent_2 } from '@devtools/core-plugin-api';
...
import { TranslationMessages } from '@devtools/core-plugin-api/alpha';
import { TranslationMessagesOptions } from '@devtools/core-plugin-api/alpha';
import { TranslationRef } from '@devtools/core-plugin-api/alpha';
import { TranslationRefOptions } from '@devtools/core-plugin-api/alpha';
import { TranslationResource } from '@devtools/core-plugin-api/alpha';
import { TranslationResourceOptions } from '@devtools/core-plugin-api/alpha';
import { TypesToApiRefs } from '@devtools/core-plugin-api';
...
import { withApis } from '@devtools/core-plugin-api';
import { z } from 'zod';
...
export { DevtoolsIdentityApi };

export { DevtoolsIdentityResponse };

export { DevtoolsUserIdentity };
