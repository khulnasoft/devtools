 ...
 * @remarks
 *
 * See {@link https://devtools.khulnasoft.com/docs/plugins/composability#routing-system}.
 *
 * @public
 */
...
> {
  readonly $$type: '@devtools/ExternalRouteRef';
  readonly T: TParams;
}
...
>(resource: ExternalRouteRef<TParams>): InternalExternalRouteRef<TParams> {
  ...
  if (r.$$type !== '@devtools/ExternalRouteRef') {
...
export function isExternalRouteRef(opaque: {
  ...
  return opaque.$$type === '@devtools/ExternalRouteRef';
}
...
{
  readonly $$type = '@devtools/ExternalRouteRef' as any;
