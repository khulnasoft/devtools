 ...
 * ```
 * "apiVersion": {
 *    "enum": ["devtools.khulnasoft.com/v1alpha1", "devtools.khulnasoft.com/v1beta1"]
 * },
 * "kind": {
 *   "enum": ["Group"]
 * },
 ...
 *
 * - `common#<id>`
 * @see {@link https://github.com/khulnasoft/devtools/tree/master/packages/catalog-model/src/schema}
 *
 * @public
 */
