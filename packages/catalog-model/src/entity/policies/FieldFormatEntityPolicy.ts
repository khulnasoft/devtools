  ...
  async enforce(entity: Entity): Promise<Entity> {
    function require(
      ...
      if (!isValid) {
        ...
        throw new Error(
          `"${field}" is not valid;${message} To learn more about catalog file format, visit: https://github.com/khulnasoft/devtools/blob/master/docs/architecture-decisions/adr002-default-catalog-file-format.md`,
        );
      }
    }
