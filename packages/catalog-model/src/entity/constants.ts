 ...
 * @public
 */
export const ANNOTATION_VIEW_URL = 'devtools.khulnasoft.com/view-url';
 ...
 * @public
 */
export const ANNOTATION_EDIT_URL = 'devtools.khulnasoft.com/edit-url';

/**
 * Annotation for specifying the API server of a Kubernetes cluster
 *
 * @deprecated Import this constant from `@devtools/plugin-kubernetes-common` instead
 * @public
 */
