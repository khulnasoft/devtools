    ...
    expect(
      getEntitySourceLocation({
        ...
        metadata: {
          ...
          namespace: 'default',
          annotations: {
            'devtools.khulnasoft.com/source-location': 'url:https://devtools.khulnasoft.com/foo.yaml',
            'devtools.khulnasoft.com/managed-by-location': 'url:https://spotify.com',
          },
        },
      }),
    ).toEqual({ target: 'https://devtools.khulnasoft.com/foo.yaml', type: 'url' });
  });
