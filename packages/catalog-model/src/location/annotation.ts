 ...
 * @public
 */
export const ANNOTATION_LOCATION = 'devtools.khulnasoft.com/managed-by-location';
 ...
 * @public
 */
export const ANNOTATION_SOURCE_LOCATION = 'devtools.khulnasoft.com/source-location';
