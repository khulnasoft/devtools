...
This package is an EXAMPLE of a Devtools backend.
...
Read more about the
[auth-backend](https://github.com/khulnasoft/devtools/blob/master/plugins/auth-backend/README.md)
and
[how to add a new provider](https://github.com/khulnasoft/devtools/blob/master/docs/auth/add-auth-provider.md)
