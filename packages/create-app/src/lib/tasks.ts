...
/**
 * Generate a templated devtools project
 *
...
/**
 * This fetches the yarn.lock seed file at https://github.com/khulnasoft/devtools/blob/master/packages/create-app/seed-yarn.lock
