...
jest.mock('./versions', () => ({
  packageVersions: {
    root: '1.2.3',
    '@devtools/cli': '1.0.0',
    '@devtools/backend-defaults': '1.0.0',
    '@devtools/backend-tasks': '1.0.0',
    '@devtools/catalog-model': '1.0.0',
    '@devtools/catalog-client': '1.0.0',
    '@devtools/config': '1.0.0',
    '@devtools/plugin-app-backend': '1.0.0',
    '@devtools/plugin-auth-backend': '1.0.0',
    '@devtools/plugin-auth-node': '1.0.0',
    '@devtools/plugin-auth-backend-module-github-provider': '1.0.0',
    '@devtools/plugin-auth-backend-module-guest-provider': '1.0.0',
    '@devtools/plugin-catalog-backend': '1.0.0',
    '@devtools/plugin-catalog-backend-module-logs': '1.0.0',
    '@devtools/plugin-catalog-backend-module-scaffolder-entity-model': '1.0.0',
    '@devtools/plugin-permission-common': '1.0.0',
    '@devtools/plugin-permission-node': '1.0.0',
    '@devtools/plugin-permission-backend': '1.0.0',
    '@devtools/plugin-permission-backend-module-allow-all-policy': '1.0.0',
    '@devtools/plugin-proxy-backend': '1.0.0',
    '@devtools/plugin-scaffolder-backend': '1.0.0',
    '@devtools/plugin-search-backend': '1.0.0',
    '@devtools/plugin-search-backend-module-catalog': '1.0.0',
    '@devtools/plugin-search-backend-module-pg': '1.0.0',
    '@devtools/plugin-search-backend-module-techdocs': '1.0.0',
    ...
    '@devtools/core-components': '1.0.0',
    '@devtools/core-plugin-api': '1.0.0',
    '@devtools/e2e-test-utils': '1.0.0',
    '@devtools/integration-react': '1.0.0',
    '@devtools/plugin-api-docs': '1.0.0',
    '@devtools/plugin-catalog': '1.0.0',
    '@devtools/plugin-catalog-common': '1.0.0',
    '@devtools/plugin-catalog-graph': '1.0.0',
    '@devtools/plugin-catalog-import': '1.0.0',
    '@devtools/plugin-catalog-react': '1.0.0',
    '@devtools/plugin-kubernetes': '1.0.0',
    '@devtools/plugin-kubernetes-backend': '1.0.0',
    '@devtools/plugin-org': '1.0.0',
    '@devtools/plugin-scaffolder': '1.0.0',
    '@devtools/plugin-scaffolder-backend-module-github': '1.0.0',
    '@devtools/plugin-permission-react': '1.0.0',
    ...
    '@devtools/plugin-user-settings': '1.0.0',
...
describe('tasks', () => {
  ...
  describe('templatingTask', () => {
    it('should generate a project populating context parameters', async () => {
      ...
      const context = {
        name: 'SuperCoolDevtoolsInstance',
        dbTypeSqlite: true,
      };
      ...
      await expect(fs.readJson('templatedApp/devtools.json')).resolves.toEqual(
        {
          version: '1.2.3',
        },
      );
      ...
      ).resolves.toContain('name: SuperCoolDevtoolsInstance');
  ...
  describe('fetchYarnLockSeedTask', () => {
    ...
    it('should fetch the yarn.lock seed file', async () => {
      worker.use(
        http.get(
          'https://raw.githubusercontent.com/khulnasoft/devtools/master/packages/create-app/seed-yarn.lock',
          () =>
