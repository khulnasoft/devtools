...
/* eslint-disable @devtools/no-relative-monorepo-imports */
...
export const packageVersions = {
  root,
  '@devtools/app-defaults': appDefaults,
  '@devtools/backend-defaults': backendDefaults,
  '@devtools/catalog-client': catalogClient,
  '@devtools/catalog-model': catalogModel,
  '@devtools/cli': cli,
  '@devtools/config': config,
  '@devtools/core-app-api': coreAppApi,
  '@devtools/core-components': coreComponents,
  '@devtools/core-plugin-api': corePluginApi,
  '@devtools/e2e-test-utils': e2eTestUtils,
  '@devtools/errors': errors,
  '@devtools/integration-react': integrationReact,
  '@devtools/repo-tools': repoTools,
  '@devtools/plugin-api-docs': pluginApiDocs,
  '@devtools/plugin-app-backend': pluginAppBackend,
  '@devtools/plugin-auth-backend': pluginAuthBackend,
  '@devtools/plugin-auth-backend-module-github-provider':
    pluginAuthBackendModuleGithubProvider,
  '@devtools/plugin-auth-backend-module-guest-provider':
    pluginAuthBackendModuleGuestProvider,
  '@devtools/plugin-auth-node': pluginAuthNode,
  '@devtools/plugin-catalog': pluginCatalog,
  '@devtools/plugin-catalog-common': pluginCatalogCommon,
  '@devtools/plugin-catalog-react': pluginCatalogReact,
  '@devtools/plugin-catalog-backend': pluginCatalogBackend,
  '@devtools/plugin-catalog-backend-module-logs':
  ...
  '@devtools/plugin-catalog-graph': pluginCatalogGraph,
  '@devtools/plugin-catalog-import': pluginCatalogImport,
  '@devtools/plugin-kubernetes': pluginKubernetes,
  '@devtools/plugin-kubernetes-backend': pluginKubernetesBackend,
  '@devtools/plugin-org': pluginOrg,
  '@devtools/plugin-permission-backend': pluginPermissionBackend,
  '@devtools/plugin-permission-backend-module-allow-all-policy':
    pluginPermissionBackendModulePolicyAllowAll,
  '@devtools/plugin-permission-common': pluginPermissionCommon,
  '@devtools/plugin-permission-node': pluginPermissionNode,
  '@devtools/plugin-permission-react': pluginPermissionReact,
  '@devtools/plugin-proxy-backend': pluginProxyBackend,
  '@devtools/plugin-scaffolder': pluginScaffolder,
  '@devtools/plugin-scaffolder-backend': pluginScaffolderBackend,
  '@devtools/plugin-scaffolder-backend-module-github':
    pluginScaffolderBackendModuleGithub,
  '@devtools/plugin-search': pluginSearch,
  '@devtools/plugin-search-react': pluginSearchReact,
  '@devtools/plugin-search-backend': pluginSearchBackend,
  '@devtools/plugin-search-backend-module-catalog':
    pluginSearchBackendModuleCatalog,
  '@devtools/plugin-search-backend-module-pg': pluginSearchBackendModulePg,
  '@devtools/plugin-search-backend-module-techdocs':
    pluginSearchBackendModuleTechdocs,
  '@devtools/plugin-search-backend-node': pluginSearchBackendNode,
  '@devtools/plugin-techdocs': pluginTechdocs,
  '@devtools/plugin-techdocs-react': pluginTechdocsReact,
  '@devtools/plugin-techdocs-module-addons-contrib':
    pluginTechdocsModuleAddonsContrib,
  '@devtools/plugin-techdocs-backend': pluginTechdocsBackend,
  '@devtools/plugin-user-settings': pluginUserSettings,
  '@devtools/test-utils': testUtils,
