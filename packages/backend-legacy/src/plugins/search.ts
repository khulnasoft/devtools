...
import { ToolDocumentCollatorFactory } from '@devtools/plugin-search-backend-module-explore';
import { createRouter } from '@devtools/plugin-search-backend';
import { ElasticSearchSearchEngine } from '@devtools/plugin-search-backend-module-elasticsearch';
import { PgSearchEngine } from '@devtools/plugin-search-backend-module-pg';
import {
  IndexBuilder,
  SearchEngine,
  LunrSearchEngine,
} from '@devtools/plugin-search-backend-node';
import { DefaultTechDocsCollatorFactory } from '@devtools/plugin-search-backend-module-techdocs';
