...
import { ErrorPanel, Progress, ErrorPage } from '@devtools/core-components';
import {
  MemoryRouter,
  useInRouterContext,
  BrowserRouter,
...
/**
 * Creates a set of default components to pass along to {@link @devtools/core-app-api#createSpecializedApp}.
 *
 * @public
 */
