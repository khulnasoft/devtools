...
import { AppNodeSpec } from '@devtools/frontend-plugin-api';
...
import { TestApiRegistry, withLogCollector } from '@devtools/test-utils';
...
function createV1ExtensionInput(
  ...
  return {
    $$type: '@devtools/ExtensionInput' as const,
    extensionData,
    config: {
