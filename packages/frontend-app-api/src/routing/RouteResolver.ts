...
import { isRouteRef } from '@backstage/frontend-plugin-api/src/routing/RouteRef';
// eslint-disable-next-line @backstage/no-relative-monorepo-imports
import {
  isSubRouteRef,
  toInternalSubRouteRef,
} from '@backstage/frontend-plugin-api/src/routing/SubRouteRef';
// eslint-disable-next-line @backstage/no-relative-monorepo-imports
import { isExternalRouteRef } from '@backstage/frontend-plugin-api/src/routing/ExternalRouteRef';
