...
import { RouteRef, coreExtensionData } from '@devtools/frontend-plugin-api';
...
export function extractRouteInfoFromAppNode(node: AppNode): {
  ...
  routeObjects: DevtoolsRouteObject[];
} {
  ...
  const routeObjects = new Array<DevtoolsRouteObject>();
