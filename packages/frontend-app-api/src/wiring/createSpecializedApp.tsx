...
import { ApiFactoryRegistry, ApiResolver } from '@devtools/core-app-api';
...
import { DevtoolsRouteObject } from '../routing/types';
...
class RouteResolutionApiProxy implements RouteResolutionApi {
  ...
  #routeObjects: DevtoolsRouteObject[] | undefined;
 ...
 * `createApp` from `@devtools/frontend-defaults` instead.
 *
 * @public
 */
