...
import { DevtoolsCredentials, DevtoolsPrincipalTypes } from './AuthService';

/**
 * Provides handling of credentials in an ongoing request.
 *
 * See the {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/http-auth | service documentation} for more details.
 *
 * @public
 */
export interface HttpAuthService {
  ...
  credentials<TAllowed extends keyof DevtoolsPrincipalTypes = 'unknown'>(
    ...
    options?: {
       ...
       * restriction, a {@link @devtools/errors#NotAllowedError} is thrown.
       *
   ...
   * credentials (such as a Devtools token).
   *
