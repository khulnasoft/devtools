 ...
 *
 * See the {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/discovery | service documentation} for more details.
 *
 * @remarks
 *
...
export interface DiscoveryService {
   ...
   * communication within a Devtools backend deployment.
   *
   ...
   * it is reachable from the Devtools frontend and other external services. The returned
   ...
   * to an operator of the Devtools backend.
   *
   * For example, asking for the URL for `catalog` may return something
   * like `https://devtools.example.com/api/catalog`
   */
