...
/**
 * Represents a user principal (for example when a user Devtools token issued
 ...
 * token was given to a request, or the caller was a Devtools backend plugin).
 * @public
 */
 ...
 * {@link DevtoolsCredentials} object.
 *
 * @public
 */
 ...
 *
 * See the {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/auth | service documentation} for more details.
 *
 * @public
 */
export interface AuthService {
  ...
  authenticate(
    ...
    options?: {
       ...
       * tokens will lead to a {@link @devtools/errors#NotAllowedError} being
       * thrown.
       */
