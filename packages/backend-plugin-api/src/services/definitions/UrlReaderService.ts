 ...
 *
 * See the {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/url-reader | service documentation} for more details.
 *
 * @public
 */
...
export type UrlReaderServiceReadUrlOptions = {
   ...
   * {@link @devtools/errors#NotModifiedError} indicating that the response
   ...
   * will throw a {@link @devtools/errors#NotModifiedError} indicating that the
