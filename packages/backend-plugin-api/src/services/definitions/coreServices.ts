...
export namespace coreServices {
   ...
   * and {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/auth | the service docs}
   ...
   * and {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/user-info | the service docs}
   * for more information.
   *
   * @public
   */
   ...
   * and {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/cache | the service docs}
   * for more information.
   *
   * @public
   */
   ...
   * and {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/root-config | the service docs}
   * for more information.
   *
   * @public
   */
   ...
   * and {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/discovery | the service docs}
   * for more information.
   *
   * @public
   */
   ...
   * and {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/http-auth | the service docs}
   * for more information.
   *
   * @public
   */
   ...
   * and {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/http-router | the service docs}
   * for more information.
   *
   * @public
   */
   ...
   * and {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/logger | the service docs}
   * for more information.
   *
   * @public
   */
   ...
   * and {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/plugin-metadata | the service docs}
   * for more information.
   *
   * @public
   */
   ...
   * and {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/root-http-router | the service docs}
   * for more information.
   *
   * @public
   */
   ...
   * and {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/root-lifecycle | the service docs}
   * for more information.
   *
   * @public
   */
   ...
   * and {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/root-logger | the service docs}
   * for more information.
   *
   * @public
   */
   ...
   * and {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/scheduler | the service docs}
   * for more information.
   *
   * @public
   */
   ...
   * and {@link https://devtools.khulnasoft.com/docs/backend-system/core-services/url-reader | the service docs}
   * for more information.
   *
   * @public
   */
