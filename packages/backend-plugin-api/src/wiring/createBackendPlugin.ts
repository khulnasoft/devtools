 ...
 *
 * @public
 * @see {@link https://devtools.khulnasoft.com/docs/backend-system/architecture/plugins | The architecture of plugins}
 * @see {@link https://devtools.khulnasoft.com/docs/backend-system/architecture/naming-patterns | Recommended naming patterns}
 */
...
export function createBackendPlugin(
  ...
  return {
    $$type: '@devtools/BackendFeature' as const,
    version: 'v1',
