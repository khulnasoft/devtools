...
describe('createBackendFeatureLoader', () => {
  it('should create an empty feature loader', () => {
    ...
    expect(result.$$type).toEqual('@devtools/BackendFeature');
  ...
  it('should create a feature loader that loads a few features', async () => {
    ...
    expect(pluginX.$$type).toBe('@devtools/BackendFeature');
    expect(serviceFactory.$$type).toBe('@devtools/BackendFeature');
    expect(pluginY.$$type).toBe('@devtools/BackendFeature');
