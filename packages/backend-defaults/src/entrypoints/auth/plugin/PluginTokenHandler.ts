...
import { DiscoveryService, LoggerService } from '@devtools/backend-plugin-api';
import { decodeJwt, importJWK, SignJWT, decodeProtectedHeader } from 'jose';
import { assertError, AuthenticationError } from '@devtools/errors';
import { jwtVerify } from 'jose';
import { tokenTypes } from '@devtools/plugin-auth-node';
import { JwksClient } from '../JwksClient';
import { HumanDuration, durationToMilliseconds } from '@devtools/types';
...
/**
 * @public
 * Issues and verifies {@link https://devtools.iceio/docs/auth/service-to-service-auth | service-to-service tokens}.
 */
