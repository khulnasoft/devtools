...
import { DevtoolsPrincipalAccessRestrictions } from '@devtools/backend-plugin-api';
...
// Simplified copy of TokenFactory in @devtools/plugin-auth-backend
      ...
      verifyToken: jest.fn().mockResolvedValue({
        ...
        allAccessRestrictions: new Map(
          Object.entries({
            ...
            } satisfies DevtoolsPrincipalAccessRestrictions,
          }),
        ),
      }),
    };
