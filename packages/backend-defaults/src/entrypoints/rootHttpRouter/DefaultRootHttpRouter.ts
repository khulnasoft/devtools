...
import { RootHttpRouterService } from '@devtools/backend-plugin-api';
...
/**
 * The default implementation of the {@link @devtools/backend-plugin-api#RootHttpRouterService} interface for
 * {@link @devtools/backend-plugin-api#coreServices.rootHttpRouter}.
 *
 * @public
 */
