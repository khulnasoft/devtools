...
import { DevtoolsUserPrincipal } from '@devtools/backend-plugin-api';
import {
  mockServices,
...
import { InternalDevtoolsCredentials } from '../auth/types';
...
describe('DefaultUserInfoService', () => {
  ...
  it('makes the expected call when no ent in the token', async () => {
    ...
    } as InternalDevtoolsCredentials<DevtoolsUserPrincipal>;
