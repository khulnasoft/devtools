...
/**
 * Implements a {@link @devtools/backend-plugin-api#UrlReaderService} for files through the GitHub v3 APIs, such as
...
export class GithubUrlReader implements UrlReaderService {
  ...
  private async doSearch(
    ...
    function pathToUrl(path: string): string {
      ...
      // pathname starts as /khulnasoft/devtools/blob/master/<path>
