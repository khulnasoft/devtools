...
import { ForwardedError, NotModifiedError } from '@devtools/errors';
...
/**
 * Implements a {@link @devtools/backend-plugin-api#UrlReaderService} for AWS CodeCommit.
 *
 * @public
 */
export class AwsCodeCommitUrlReader implements UrlReaderService {
  ...
  private static async buildCredentials(
    ...
    if (roleArn) {
      return fromTemporaryCredentials({
        ...
        params: {
          RoleSessionName: 'devtools-aws-code-commit-url-reader',
          RoleArn: roleArn,
  ...
  private async buildCodeCommitClient(
    ...
    const codeCommit = new CodeCommitClient({
      customUserAgent: 'devtools-aws-codecommit-url-reader',
      region: region,
