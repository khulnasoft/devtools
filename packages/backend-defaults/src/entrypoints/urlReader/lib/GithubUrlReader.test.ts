...
import { NotFoundError, NotModifiedError } from '@devtools/errors';
import {
  GhBlobResponse,
...
describe('GithubUrlReader', () => {
  ...
  describe('read', () => {
    it('should use the headers from the credentials provider to the fetch request when doing read', async () => {
      ...
      worker.use(
        rest.get(
          'https://ghe.github.com/api/v3/repos/devtools/mock/contents/main',
          (req, res, ctx) => {
      ...
      await gheProcessor.readUrl(
        'https://github.com/khulnasoft/mock/tree/blob/main',
      );
    });
  });
  ...
  describe('readTree', () => {
    const repoBuffer = fs.readFileSync(
      path.resolve(__dirname, '__fixtures__/devtools-mock-etag123.tar.gz'),
    );

    const reposGithubApiResponse = {
      id: 123,
      full_name: 'devtools/mock',
      default_branch: 'main',
      branches_url:
        'https://api.github.com/repos/devtools/mock/branches{/branch}',
      archive_url:
        'https://api.github.com/repos/devtools/mock/{archive_format}{/ref}',
    ...
    const reposGheApiResponse = {
      ...
      default_branch: 'main',
      branches_url:
        'https://ghe.github.com/api/v3/repos/devtools/mock/branches{/branch}',
      archive_url:
        'https://ghe.github.com/api/v3/repos/devtools/mock/{archive_format}{/ref}',
    } as Partial<GhRepoResponse>;
    ...
    beforeEach(() => {
      worker.use(
        rest.get('https://api.github.com/repos/devtools/mock', (_, res, ctx) =>
          res(
            ctx.status(200),
        ...
        rest.get(
          'https://api.github.com/repos/devtools/mock/commits/main/status',
          (req, res, ctx) => {
        ...
        rest.get(
          'https://api.github.com/repos/devtools/mock/tarball/etag123abc',
          (_, res, ctx) =>
            res(
              ctx.status(200),
              ctx.set('Content-Type', 'application/x-gzip'),
              ctx.set(
                'content-disposition',
                'attachment; filename=devtools-mock-etag123.tar.gz',
              ),
              ctx.body(repoBuffer),
            ),
        ),
        rest.get(
          'https://api.github.com/repos/devtools/mock/commits/branchDoesNotExist/status',
          (_, res, ctx) => res(ctx.status(404)),
        ),
        rest.get(
          'https://ghe.github.com/api/v3/repos/devtools/mock/tarball/etag123abc',
          (_, res, ctx) =>
            res(
              ctx.status(200),
              ctx.set('Content-Type', 'application/x-gzip'),
        ...
        rest.get(
          'https://ghe.github.com/api/v3/repos/devtools/mock',
          (_, res, ctx) =>
            res(
              ctx.status(200),
              ctx.set('Content-Type', 'application/json'),
        ...
        rest.get(
          'https://ghe.github.com/api/v3/repos/devtools/mock/commits/main/status',
          (req, res, ctx) => {
            if (req.url.searchParams.get('per_page') === '0') {
              return res(
                ctx.status(200),
    ...
    it('returns the wanted files from an archive', async () => {
      const response = await githubProcessor.readTree(
        'https://github.com/khulnasoft/mock/tree/main',
      );
    ...
    it('creates a directory with the wanted files', async () => {
      const response = await githubProcessor.readTree(
        'https://github.com/khulnasoft/mock',
      );
    ...
    it('should use the headers from the credentials provider to the fetch request', async () => {
      ...
      await gheProcessor.readTree(
        'https://ghe.github.com/khulnasoft/mock/tree/main',
      );
    });
    ...
    it('includes the subdomain in the github url', async () => {
      const response = await gheProcessor.readTree(
        'https://ghe.github.com/khulnasoft/mock/tree/main/docs',
      );
    ...
    it('returns the wanted files from an archive with a subpath', async () => {
      const response = await githubProcessor.readTree(
        'https://github.com/khulnasoft/mock/tree/main/docs',
      );
    ...
    it('throws a NotModifiedError when given a etag in options', async () => {
      const fnGithub = async () => {
        await githubProcessor.readTree('https://github.com/khulnasoft/mock', {
          etag: 'etag123abc',
        });
      };
    ...
    it('should throw error on missing branch', async () => {
      const fnGithub = async () => {
        await githubProcessor.readTree(
          'https://github.com/khulnasoft/mock/tree/branchDoesNotExist',
        );
      };
  ...
  describe('search', () => {
    ...
    const githubTreeContents: GhTreeResponse['tree'] = [
      {
        path: 'mkdocs.yml',
        type: 'blob',
        url: 'https://api.github.com/repos/devtools/mock/git/blobs/1',
      },
      {
        path: 'docs',
        type: 'tree',
        url: 'https://api.github.com/repos/devtools/mock/git/trees/2',
      },
      {
        path: 'docs/index.md',
        type: 'blob',
        url: 'https://api.github.com/repos/devtools/mock/git/blobs/3',
      },
    ];
    ...
    const gheTreeContents: GhTreeResponse['tree'] = [
      {
        path: 'mkdocs.yml',
        type: 'blob',
        url: 'https://ghe.github.com/api/v3/repos/devtools/mock/git/blobs/1',
      },
      {
        path: 'docs',
        type: 'tree',
        url: 'https://ghe.github.com/api/v3/repos/devtools/mock/git/trees/2',
      },
      {
        path: 'docs/index.md',
        type: 'blob',
        url: 'https://ghe.github.com/api/v3/repos/devtools/mock/git/blobs/3',
      },
    ];
    ...
    beforeEach(() => {
      const githubResponse = {
        ...
        archive_url:
          'https://api.github.com/repos/devtools/mock/{archive_format}{/ref}',
        trees_url:
          'https://api.github.com/repos/devtools/mock/git/trees{/sha}',
      } as Partial<GhRepoResponse>;
      ...
      const gheResponse = {
        ...
        archive_url:
          'https://ghe.github.com/api/v3/repos/devtools/mock/{archive_format}{/ref}',
        trees_url:
          'https://ghe.github.com/api/v3/repos/devtools/mock/git/trees{/sha}',
      } as Partial<GhRepoResponse>;
    ...
    beforeEach(() => {
      ...
      worker.use(
        rest.get(
          'https://api.github.com/repos/devtools/mock/git/blobs/1',
          (_, res, ctx) =>
            res(
              ctx.status(200),
              ctx.set('Content-Type', 'application/json'),
        ...
        rest.get(
          'https://api.github.com/repos/devtools/mock/git/blobs/3',
          (_, res, ctx) =>
            res(
              ctx.status(200),
              ctx.set('Content-Type', 'application/json'),
        ...
        rest.get(
          'https://ghe.github.com/api/v3/repos/devtools/mock/git/blobs/1',
          (_, res, ctx) =>
            res(
              ctx.status(200),
              ctx.set('Content-Type', 'application/json'),
        ...
        rest.get(
          'https://ghe.github.com/api/v3/repos/devtools/mock/git/blobs/3',
          (_, res, ctx) =>
            res(
              ctx.status(200),
              ctx.set('Content-Type', 'application/json'),
    ...
    async function runTests(reader: GithubUrlReader, baseUrl: string) {
      const r1 = await reader.search(
        `${baseUrl}/devtools/mock/tree/main/**/*`,
      );
      ...
      const r3 = await reader.search(`${baseUrl}/devtools/mock/tree/main/o`);
      expect(r3.files.length).toBe(0);

      const r4 = await reader.search(
        `${baseUrl}/devtools/mock/tree/main/*docs*`,
      );
      expect(r4.files.length).toBe(1);
      expect(r4.files[0].url).toBe(
        `${baseUrl}/devtools/mock/tree/main/mkdocs.yml`,
      );
      ...
      const r5 = await reader.search(
        `${baseUrl}/devtools/mock/tree/main/*/index.*`,
      );
      expect(r5.files.length).toBe(1);
      expect(r5.files[0].url).toBe(
        `${baseUrl}/devtools/mock/tree/main/docs/index.md`,
      );
    ...
    it('succeeds on github when going via repo listing', async () => {
      worker.use(
        rest.get(
          'https://api.github.com/repos/devtools/mock/git/trees/etag123abc',
          (_, res, ctx) =>
            res(
              ctx.status(200),
              ctx.set('Content-Type', 'application/json'),
    ...
    it('succeeds on ghe when going via repo listing', async () => {
      worker.use(
        rest.get(
          'https://ghe.github.com/api/v3/repos/devtools/mock/git/trees/etag123abc',
          (_, res, ctx) =>
            res(
              ctx.status(200),
              ctx.set('Content-Type', 'application/json'),
    ...
    it('throws NotModifiedError when same etag', async () => {
      await expect(
        githubProcessor.search(
          'https://githib.com/devtools/mock/tree/main/**/*',
          { etag: 'etag123abc' },
        ),
      ).rejects.toThrow(NotModifiedError);
    });
    ...
    it('throws NotFoundError when missing branch', async () => {
      await expect(
        githubProcessor.search(
          'https://githib.com/devtools/mock/tree/branchDoesNotExist/**/*',
        ),
