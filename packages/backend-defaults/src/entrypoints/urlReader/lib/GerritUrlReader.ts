...
/**
 * Implements a {@link @devtools/backend-plugin-api#UrlReaderService} for files in Gerrit.
 *
 * @remarks
 ...
 * Devtools without Gitiles since all API calls goes directly to Gerrit.
