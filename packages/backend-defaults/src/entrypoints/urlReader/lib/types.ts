...
/**
 * A predicate that decides whether a specific {@link @devtools/backend-plugin-api#UrlReaderService} can handle a
 * given URL.
 *
 * @public
 */
 ...
 * {@link @devtools/backend-plugin-api#UrlReaderService}s along with a predicate for when it should be used.
 *
 * @public
 */
