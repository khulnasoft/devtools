...
// NOTE(freben): Intentionally uses node-fetch because of https://github.com/khulnasoft/devtools/issues/28190
...
/**
 * Implements a {@link @devtools/backend-plugin-api#UrlReaderService} for files on GitLab.
 *
 * @public
 */
  ...
  async readUrl(
    ...
    try {
      response = await fetch(builtUrl, {
        ...
        // https://github.com/khulnasoft/devtools/issues/8242
