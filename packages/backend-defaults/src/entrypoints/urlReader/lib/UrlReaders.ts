...
/**
 * Creation options for {@link @devtools/backend-plugin-api#UrlReaderService}.
 *
 * @public
 */
...
/**
 * Helps construct {@link @devtools/backend-plugin-api#UrlReaderService}s.
 *
 * @public
 */
export class UrlReaders {
  /**
   * Creates a custom {@link @devtools/backend-plugin-api#UrlReaderService} wrapper for your own set of factories.
   */
  ...
  /**
   * Creates a {@link @devtools/backend-plugin-api#UrlReaderService} wrapper that includes all the default factories
   * from this package.
   *
