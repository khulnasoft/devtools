...
export interface GetEntityFacetsRequest {
   ...
   * @remarks
   *
   * Example: For an input of `['kind', 'metadata.annotations.devtools.khulnasoft.com/orphan']`, then the
   ...
   *       { "key": "API", "count": 13 }
   *     ],
   *     "metadata.annotations.devtools.khulnasoft.com/orphan": [
   *       { "key": "true", "count": 2 }
   *     ]
   *   }
   * }
...
/**
 * A client for interacting with the Devtools software catalog through its API.
 *
 * @public
 */
