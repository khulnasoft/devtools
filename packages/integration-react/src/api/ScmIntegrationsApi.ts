...
import { ApiRef, createApiRef } from '@devtools/core-plugin-api';

/**
 * Factory class for creating {@link @devtools/integration#ScmIntegrationRegistry} instances.
 *
 * @public
 */
export class ScmIntegrationsApi {
  /**
   * Instantiates an {@link @devtools/integration#ScmIntegrationRegistry}.
   *
