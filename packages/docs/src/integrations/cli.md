...
By default, the CLI uses the public instance at [enclosed.khulnasoft.com](https://enclosed.khulnasoft.com). If you are running your own instance of Enclosed, you can configure the CLI to use your server.
...
```bash
npm uninstall -g @khulnasoft.com/enclosed
```

### Using yarn

```bash
yarn global remove @khulnasoft.com/enclosed
```

### Using pnpm

```bash
pnpm remove -g @khulnasoft.com/enclosed
```
