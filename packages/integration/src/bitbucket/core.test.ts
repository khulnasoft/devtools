...
describe('bitbucket core', () => {
  ...
  describe('getBitbucketDownloadUrl', () => {
    it('add path param if a path is specified for Bitbucket Server', async () => {
      ...
      worker.use(
        rest.get(
          'https://api.bitbucket.mycompany.net/rest/api/1.0/projects/devtools/repos/mock/default-branch',
          (_, res, ctx) =>
            res(
              ctx.status(200),
      ...
      const result = await getBitbucketDownloadUrl(
        'https://bitbucket.mycompany.net/projects/devtools/repos/mock/browse/docs',
        config,
      );
      expect(result).toEqual(
        'https://api.bitbucket.mycompany.net/rest/api/1.0/projects/devtools/repos/mock/archive?format=tgz&at=main&prefix=devtools-mock&path=docs',
      );
    });
    ...
    it('does not double encode the filepath', async () => {
      ...
      const result = await getBitbucketDownloadUrl(
        'https://bitbucket.mycompany.net/projects/devtools/repos/mock/browse/%2Fdocs?at=some-branch',
        config,
      );
      expect(result).toEqual(
        'https://api.bitbucket.mycompany.net/rest/api/1.0/projects/devtools/repos/mock/archive?format=tgz&at=some-branch&prefix=devtools-mock&path=%2Fdocs',
      );
    });
    ...
    it('do not add path param if no path is specified for Bitbucket Server', async () => {
      ...
      const result = await getBitbucketDownloadUrl(
        'https://bitbucket.mycompany.net/projects/devtools/repos/mock/browse',
        config,
      );

      expect(result).toEqual(
        'https://api.bitbucket.mycompany.net/rest/api/1.0/projects/devtools/repos/mock/archive?format=tgz&at=main&prefix=devtools-mock',
      );
    });
    ...
    it('get by branch for Bitbucket Server', async () => {
      ...
      const result = await getBitbucketDownloadUrl(
        'https://bitbucket.mycompany.net/projects/devtools/repos/mock/browse/docs?at=some-branch',
        config,
      );
      expect(result).toEqual(
        'https://api.bitbucket.mycompany.net/rest/api/1.0/projects/devtools/repos/mock/archive?format=tgz&at=some-branch&prefix=devtools-mock&path=docs',
      );
    });
    ...
    it('do not add path param for Bitbucket Cloud', async () => {
      ...
      const result = await getBitbucketDownloadUrl(
        'https://bitbucket.org/devtools/mock/src/master',
        config,
      );
      expect(result).toEqual(
        'https://bitbucket.org/devtools/mock/get/master.tar.gz',
      );
    });
  });
  ...
  describe('getBitbucketDefaultBranch', () => {
    it('return default branch for Bitbucket Cloud', async () => {
      ...
      worker.use(
        rest.get(
          'https://api.bitbucket.org/2.0/repositories/devtools/mock',
          (_, res, ctx) =>
            res(
              ctx.status(200),
              ctx.set('Content-Type', 'application/json'),
      ...
      const defaultBranch = await getBitbucketDefaultBranch(
        'https://bitbucket.org/devtools/mock/src/main',
        config,
      );
    ...
    it('return default branch for Bitbucket Server', async () => {
      ...
      const defaultBranch = await getBitbucketDefaultBranch(
        'https://bitbucket.mycompany.net/projects/devtools/repos/mock/browse/README.md',
        config,
      );
      expect(defaultBranch).toEqual('main');
    });
    ...
    it('return default branch for Bitbucket Server for bitbucket version 5.11', async () => {
      ...
      worker.use(
        ...
        rest.get(
          'https://api.bitbucket.mycompany.net/rest/api/1.0/projects/devtools/repos/mock/branches/default',
          (_, res, ctx) =>
            res(
              ctx.status(200),
              ctx.set('Content-Type', 'application/json'),
