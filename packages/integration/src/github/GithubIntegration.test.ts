  ...
  it('resolveUrl', () => {
    ...
    expect(
      integration.resolveUrl({
        url: '../a.yaml',
        base: 'https://github.com/khulnasoft/devtools/blob/master/test/README.md',
        lineNumber: 17,
      }),
    ).toBe('https://github.com/khulnasoft/devtools/tree/master/a.yaml#L17');
    ...
    ).toBe('https://github.com/khulnasoft/devtools/tree/master/test/');
  });
  ...
  it('resolve edit URL', () => {
    ...
    expect(
      integration.resolveEditUrl(
        'https://github.com/khulnasoft/devtools/blob/master/README.md',
      ),
    ).toBe('https://github.com/khulnasoft/devtools/edit/master/README.md');
  });
...
describe('replaceGithubUrlType', () => {
  it('should replace with expected type', () => {
    ...
    expect(
      replaceGithubUrlType(
        'https://github.com/khulnasoft/devtools/edit/tree/README.md',
        'blob',
      ),
    ).toBe('https://github.com/khulnasoft/devtools/blob/tree/README.md');
  });
});
