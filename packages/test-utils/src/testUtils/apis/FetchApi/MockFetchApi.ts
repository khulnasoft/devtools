...
export interface MockFetchApiOptions {
   ...
   * simulating what
   * {@link @devtools/core-app-api#FetchMiddlewares.resolvePluginProtocol}
   * does.
   *
   * @defaultValue undefined
   * @remarks
   ...
   * what {@link @devtools/core-app-api#FetchMiddlewares.injectIdentityAuth}
   * does.
   *
   * @defaultValue undefined
   * @remarks
...
/**
 * A test helper implementation of {@link @devtools/core-plugin-api#FetchApi}.
 *
 * @public
 */
export class MockFetchApi implements FetchApi {
  ...
  /**
   * Creates a mock {@link @devtools/core-plugin-api#FetchApi}.
   */
  constructor(options?: MockFetchApiOptions) {
    this.implementation = build(options);
  }

  /** {@inheritdoc @devtools/core-plugin-api#FetchApi.fetch} */
