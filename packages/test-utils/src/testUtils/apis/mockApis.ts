...
import {
  PermissionApi,
  permissionApiRef,
} from '@devtools/plugin-permission-react';
...
export namespace mockApis {
  ...
  /**
   * Mock implementation of {@link @devtools/core-plugin-api#AnalyticsApi}.
   *
   * @public
   */
  ...
  /**
   * Mock implementations of {@link @devtools/core-plugin-api#AnalyticsApi}.
   *
   * @public
   */
  ...
  /**
   * Fake implementation of {@link @devtools/core-plugin-api#ConfigApi}
  ...
  /**
   * Mock helpers for {@link @devtools/core-plugin-api#ConfigApi}.
   *
   * @see {@link @devtools/core-plugin-api#mockApis.config}
   * @public
   */
  export namespace config {
    /**
     * Creates a factory for a fake implementation of
     * {@link @devtools/core-plugin-api#ConfigApi} with optional
     ...
     * {@link @devtools/core-plugin-api#ConfigApi}. All methods are
  ...
  /**
   * Fake implementation of {@link @devtools/core-plugin-api#DiscoveryApi}. By
  ...
  /**
   * Mock implementations of {@link @devtools/core-plugin-api#DiscoveryApi}.
   *
   * @public
   */
  ...
  /**
   * Fake implementation of {@link @devtools/core-plugin-api#IdentityApi}. By
  ...
  /**
   * Mock implementations of {@link @devtools/core-plugin-api#IdentityApi}.
   *
   * @public
   */
   ...
   * {@link @devtools/plugin-permission-react#PermissionApi}. By default allows
   * all actions.
   *
   * @public
   */
   ...
   * {@link @devtools/plugin-permission-react#PermissionApi}.
   *
   * @public
   */
  ...
  /**
   * Fake implementation of {@link @devtools/core-plugin-api#StorageApi}.
  ...
  /**
   * Mock implementations of {@link @devtools/core-plugin-api#StorageApi}.
   *
   * @public
   */
  ...
  /**
   * Fake implementation of {@link @devtools/core-plugin-api/alpha#TranslationApi}.
  ...
  /**
   * Mock implementations of {@link @devtools/core-plugin-api/alpha#TranslationApi}.
   *
   * @public
   */
