...
describe('mockApis', () => {
  ...
  describe('identity', () => {
    it('can create an instance', async () => {
      ...
      await expect(empty.getDevtoolsIdentity()).resolves.toEqual({
        type: 'user',
      ...
      await expect(notEmpty.getDevtoolsIdentity()).resolves.toEqual({
        type: 'user',
        userEntityRef: 'a',
        ownershipEntityRefs: ['b'],
      });
    ...
    it('can create a mock and make assertions on it', async () => {
      ...
      await expect(notEmpty.signOut()).resolves.toBeUndefined();
      expect(notEmpty.getDevtoolsIdentity).toHaveBeenCalledTimes(1);
