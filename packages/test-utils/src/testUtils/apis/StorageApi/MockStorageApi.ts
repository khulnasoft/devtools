...
import { StorageApi, StorageValueSnapshot } from '@devtools/core-plugin-api';
import { JsonValue, Observable } from '@devtools/types';
import ObservableImpl from 'zen-observable';

/**
 * Type for map holding data in {@link MockStorageApi}
 * @deprecated Use {@link @devtools/test-utils#mockApis.(storage:namespace)} instead
 * @public
 */
