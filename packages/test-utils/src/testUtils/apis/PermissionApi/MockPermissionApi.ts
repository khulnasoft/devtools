...
import { PermissionApi } from '@devtools/plugin-permission-react';
import {
 ...
 * {@link @devtools/plugin-permission-react#PermissionApi}. Supply a
 * requestHandler function to override the mock result returned for a given
 * request.
 * @deprecated Use {@link @devtools/test-utils#mockApis.(permission:namespace)} instead
 * @public
 */
