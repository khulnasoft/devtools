...
import { themes, UnifiedThemeProvider } from '@devtools/theme';
import MockIcon from '@material-ui/icons/AcUnit';
import { AppIcons, createSpecializedApp } from '@devtools/core-app-api';
import {
  AppComponents,
  attachComponentData,
  BootErrorPageProps,
...
/**
 * Creates a Wrapper component that wraps a component inside a Devtools test app,
...
/**
 * Wraps a component inside a Devtools test app, providing a mocked theme
...
/**
 * Renders a component inside a Devtools test app, providing a mocked theme
 * and app context, along with mocked APIs.
 *
