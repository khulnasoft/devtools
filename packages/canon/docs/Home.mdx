...
<Text style={{ marginTop: '64px', marginBottom: '24px' }}>
  Welcome to the Canon, the new design library for Devtools plugins. This
  project is still under active development but we will make sure to document
  the API as we go. We are aiming to improve the general UI of Devtools and
  plugins across Devtools. This new library will take time to build but we are
