...
import { createSpecializedBackend } from '@devtools/backend-app-api';
import { ConfigSources } from '@devtools/config-loader';
...
import { DevtoolsPackageJson, PackageRole } from '@devtools/cli-node';
...
describe('backend-dynamic-feature-service', () => {
  ...
  describe('loadPlugins', () => {
    ...
    type TestCase = {
      ...
      alpha?: {
        packageManifest: DevtoolsPackageJson;
        indexFile: {
          relativePath: string[];
          content: string;
        };
    ...
    it.each<TestCase>([
      ...
      },
      {
        ...
        indexFile: {
          relativePath: ['dist', 'index.cjs.js'],
          content: `const feature = { $$type: '@devtools/BackendFeature' }; exports["default"] = feature;`,
        },
        expectedLogs(location) {
          return {
            infos: [
      ...
      },
      {
        ...
        alpha: {
          ...
          indexFile: {
            ...
            content: `const alpha = { $$type: '@devtools/BackendFeature' }; exports["default"] = alpha;`,
          },
        },
        expectedLogs(location) {
          return {
      ...
      },
      {
        ...
        indexFile: {
          relativePath: ['dist', 'index.cjs.js'],
          content: `const alpha = () => { return { $$type: '@devtools/BackendFeature' } };
             alpha.$$type = '@devtools/BackendFeatureFactory';
