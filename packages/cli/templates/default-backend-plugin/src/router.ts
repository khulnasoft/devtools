...
export async function createRouter({
  ...
  //
  // If you want to define a schema for your API we recommend using Devtools's
  // OpenAPI tooling: https://devtools.khulnasoft.com/docs/next/openapi/01-getting-started
