...
export function registerRepoCommand(program: Command) {
  const command = program
    ...
    .description('Command that run across an entire Devtools project');
  ...
  command
    ...
    .option(
      ...
      'Set the success cache location, (default: node_modules/.cache/devtools-cli)',
    )
...
export function registerScriptCommand(program: Command) {
  ...
  command
    .command('test')
    .allowUnknownOption(true) // Allows the command to run, but we still need to parse raw args
    .helpOption(', --devtools-cli-help') // Let Jest handle help
    .description('Run tests, forwarding args to Jest, defaulting to watch mode')
...
export function registerMigrateCommand(program: Command) {
  ...
  command
    ...
    .description(
      'Migrates all packages to use @devtools/cli/config/eslint-factory',
    )
    .action(
...
export function registerCommands(program: Command) {
  ...
  program
    ...
    .option(
      ...
      'Bump to a specific Devtools release line or version',
      'main',
    )
    .option('--skip-install', 'Skips yarn install step')
    .option('--skip-migrate', 'Skips migration of any moved packages')
    .description('Bump Devtools packages to the latest versions')
  ...
  program
    ...
    .description(
      'Migrate any plugins that have been moved to the @devtools-community namespace automatically',
    )
  ...
  program
    ...
    .action(removed("use 'devtools-cli new' instead"));
  program
  ...
  program
    .command('plugin:diff')
    .allowUnknownOption(true)
    .action(removed("use 'devtools-cli fix' instead"));
  program
    .command('test')
    .allowUnknownOption(true)
    .action(
      removed(
        "use 'devtools-cli repo test' or 'devtools-cli package test' instead",
      ),
    );
  program
    .command('clean')
    .allowUnknownOption(true)
    .action(removed("use 'devtools-cli package clean' instead"));
  program
