...
const PREFIX = `module.exports = require('@devtools/cli/config/eslint-factory')`;

export async function command() {
  const packages = await PackageGraph.listTargetPackages();

  const oldConfigs = [
    require.resolve('@devtools/cli/config/eslint.js'),
    require.resolve('@devtools/cli/config/eslint.backend.js'),
  ];
