...
*/
import { version as backendPluginApi } from '@backstage/backend-plugin-api/package.json';
import { version as backendTestUtils } from '@backstage/backend-test-utils/package.json';
import { version as catalogClient } from '@backstage/catalog-client/package.json';
import { version as cli } from '../../package.json';
...
import { version as errors } from '@backstage/errors/package.json';
...
import { version as backendDefaults } from '@backstage/backend-defaults/package.json';
