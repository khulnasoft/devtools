...
export const packageVersions: Record<string, string> = {
  ...
  '@devtools/backend-plugin-api': backendPluginApi,
  '@devtools/backend-test-utils': backendTestUtils,
  ...
  '@devtools/dev-utils': devUtils,
  '@devtools/errors': errors,
  '@devtools/test-utils': testUtils,
  '@devtools/theme': theme,
  '@devtools/plugin-scaffolder-node': scaffolderNode,
  '@devtools/plugin-scaffolder-node-test-utils': scaffolderNodeTestUtils,
  '@devtools/plugin-auth-backend': authBackend,
  '@devtools/plugin-auth-backend-module-guest-provider':
    authBackendModuleGuestProvider,
  '@devtools/plugin-catalog-node': catalogNode,
};
