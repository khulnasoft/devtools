...
describe('frontendPlugin factory', () => {
  ...
  it('should create a frontend plugin', async () => {
    ...
    expectLogsToMatch(output, [
      'Creating frontend plugin devtools-plugin-test',
...
import { createApp } from '@devtools/app-defaults';
import { TestPage } from 'devtools-plugin-test';
...
`);
  ...
  it('should create a frontend plugin with more options and codeowners', async () => {
    ...
    await expect(
      ...
      dependencies: {
        '@internal/devtools-plugin-test': '^1.0.0',
      },
    });
...
import { createApp } from '@devtools/app-defaults';
import { TestPage } from '@internal/devtools-plugin-test';
