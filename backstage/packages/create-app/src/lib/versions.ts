...
import { version as appDefaults } from '@backstage/app-defaults/package.json';
...
import { version as integrationReact } from '@backstage/integration-react/package.json';
