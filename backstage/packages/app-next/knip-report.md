...
| @backstage/plugin-app-visualizer                 | package.json | error    |
...
| @backstage/plugin-user-settings                  | package.json | error    |
| @backstage/frontend-plugin-api                   | package.json | error    |
...
| @backstage/plugin-techdocs                       | package.json | error    |
