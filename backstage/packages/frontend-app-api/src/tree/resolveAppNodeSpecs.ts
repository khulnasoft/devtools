...
} from '@backstage/frontend-plugin-api/src/wiring/createFrontendModule';
// eslint-disable-next-line @backstage/no-relative-monorepo-imports
import { toInternalExtension } from '@backstage/frontend-plugin-api/src/wiring/resolveExtensionDefinition';
