...
import { toInternalRouteRef as toInternalNewRouteRef } from '@backstage/frontend-plugin-api/src/routing/RouteRef';
// eslint-disable-next-line @backstage/no-relative-monorepo-imports
import { toInternalSubRouteRef as toInternalNewSubRouteRef } from '@backstage/frontend-plugin-api/src/routing/SubRouteRef';
// eslint-disable-next-line @backstage/no-relative-monorepo-imports
import { toInternalExternalRouteRef as toInternalNewExternalRouteRef } from '@backstage/frontend-plugin-api/src/routing/ExternalRouteRef';
