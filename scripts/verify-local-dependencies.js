...
const roleRules = [
  ...
  },
  {
    ...
    targetRole: 'frontend-plugin',
      ...
      '@devtools/frontend-defaults',
      '@devtools/frontend-app-api',
      '@devtools/frontend-test-utils',
      '@devtools/plugin-api-docs',
      '@devtools/plugin-techdocs-addons-test-utils',
    ],
  ...
  {
    sourceRole: ['frontend-plugin', 'web-library'],
    targetName: ['@devtools/core-app-api', '@devtools/frontend-app-api'],
    except: [
  ...
  },
  {
    ...
    targetName: ['@devtools/backend-app-api'],
    except: [
      // These are legitimate
...
async function main(args) {
  ...
  for (const pkg of packages) {
     ...
     */
    const sourceRole = pkg.packageJson.devtools?.role;
    if (typeof sourceRole === 'string') {
      for (const [targetName] of Object.entries(
        ...
        const targetRole = targetPackageJson.devtools?.role;
