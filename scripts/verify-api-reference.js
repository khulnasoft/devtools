...
async function main() {
  ...
  // This makes sure we see the package description of the @devtools/types package
  ...
  if (!indexContent.includes('types used within Devtools')) {
    throw new Error(
      'Could not find package documentation for @devtools/types in the API reference index. ' +
