...
Devtools uses [Jest](https://facebook.github.io/jest/) for all our unit testing
needs.
...
it('Works with midCharIx', () => {
  ...
  expect(ellipsis('Devtools is amazing', 4, 10)).toBe('...e is...');
});
```
...
The Devtools application has several core providers at its root. To run your
test wrapped in a "sample" Devtools application, you can use our utility
functions:
...
You can find it [here](https://devtools.khulnasoft.com/docs/tooling/cli/build-system#debugging-jest-tests)
