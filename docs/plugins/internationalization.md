...
The Devtools core function provides internationalization for plugins. The underlying library is [`i18next`](https://www.i18next.com/) with some additional Devtools typescript magic for type safety with keys.
...
```ts
import { createTranslationRef } from '@devtools/core-plugin-api/alpha';
...
import { createTranslationResource } from '@devtools/core-plugin-api/alpha';
import { userSettingsTranslationRef } from '@devtools/plugin-user-settings/alpha';
