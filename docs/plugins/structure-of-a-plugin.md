...
plugins in a potentially big Devtools app.
...
We have the `ExampleComponent` to show an example Devtools page component. The
...
## Connecting the plugin to the Devtools app

There are two things needed for a Devtools app to start making use of a plugin.
...
If your plugin needs to communicate with services outside the Devtools
...
plugin that we provide for the Devtools backend.
[Read more](https://github.com/khulnasoft/devtools/blob/master/plugins/proxy-backend/README.md)
