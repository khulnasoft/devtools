...
> those, you can clone
> [simple-devtools-app](https://github.com/johnson-jesse/simple-devtools-app)
> which this document builds on.
>
> This document does not cover authoring a plugin for sharing with the Devtools
...
> here >
> [simple-devtools-app-plugin](https://github.com/johnson-jesse/simple-devtools-app-plugin).
...
1. If you see errors starting, refer to
   [Auth Configuration](https://devtools.khulnasoft.com/docs/auth/) for more information on
...
import { identityApiRef, useApi } from '@devtools/core-plugin-api';
```
...
https://github.com/khulnasoft/devtools/tree/master/contrib

6. Here is the entire file for reference
   [ExampleComponent.tsx](https://github.com/khulnasoft/devtools/tree/master/contrib/docs/tutorials/quickstart-app-plugin/ExampleComponent.md)
...
import { Table, TableColumn, Progress } from '@devtools/core-components';
import { githubAuthApiRef, useApi } from '@devtools/core-plugin-api';
...
Using Devtools's own component library, let's define a custom table. This
...
9. Here is the entire file for reference
   [ExampleFetchComponent.tsx](https://github.com/khulnasoft/devtools/tree/master/contrib/docs/tutorials/quickstart-app-plugin/ExampleFetchComponent.md)
...
> for an in-depth look at publishing and including that for the entire Devtools
> community. [TODO](#).
