...
description: Guide for how to migrate a Devtools project to use Yarn 4
---

Devtools projects created with `@devtools/create-app` now use [Yarn 4](https://yarnpkg.com/), you may have a previous version of Devtools that is still using [Yarn 1](https://classic.yarnpkg.com/) that you'll want to migrate, this tutorial will help you with this task.
