...
to use Devtools's components (check the [Storybook][1] for a list and demo)
...
as much as possible, make sure to use the theme's color palette. Most Devtools
...
to [Override the Component Styles][11] as suggested by Devtools.
...
[1]: http://devtools.khulnasoft.com/storybook
...
[10]: https://devtools.khulnasoft.com/docs/getting-started/app-custom-theme
[11]: https://devtools.khulnasoft.com/docs/getting-started/app-custom-theme#overriding-devtools-and-material-ui-components-styles
