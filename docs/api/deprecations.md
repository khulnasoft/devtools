...
various parts of Devtools. It is not an exhaustive list as most deprecation
...
`Released 2021-11-12 in @devtools/core-plugin-api v0.1.13`
...
`Released 2021-12-16 in @devtools/core-plugin-api v0.3.1`

There are four auth Utility API references in `@devtools/core-plugin-api` that
...
```ts
// `ProfileInfoApi & DevtoolsIdentityApi & SessionApi` are required for sign-in
...
from the
[DefaultProviderSettings](https://github.com/khulnasoft/devtools/blob/a3ec122170e0205fd3f9c307b98b1c5e4f55bf5f/plugins/user-settings/src/components/AuthProviders/DefaultProviderSettings.tsx#L35).
