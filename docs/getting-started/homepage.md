---
id: homepage
title: Devtools homepage - Setup and Customization
description: Documentation on setting up and customizing Devtools homepage
---

## Homepage

Having a good Devtools homepage can significantly improve the discoverability of the platform. You want your users to find all the things they need right from the homepage and never have to remember direct URLs in Devtools. The [Home plugin](https://github.com/khulnasoft/devtools/tree/master/plugins/home) introduces a system for composing a homepage for Devtools in order to surface relevant info and provide convenient shortcuts for common tasks. It's designed with composability in mind with an open ecosystem that allows anyone to contribute with any component, to be included in any homepage.
...
- Your Devtools app to have a dedicated homepage instead of Software Catalog.
...
- You have created your own standalone Devtools app using [`@devtools/create-app`](./index.md#1-create-your-devtools-app) and not using a fork of the [devtools](https://github.com/khulnasoft/devtools) repository.
- You do not have an existing homepage, and by default you are redirected to Software Catalog when you open Devtools.

Now, let's get started by installing the home plugin and creating a simple homepage for your Devtools app.
...
yarn --cwd packages/app add @devtools/plugin-home
```
...
```tsx title="packages/app/src/App.tsx"
/* highlight-add-start */
import { HomepageCompositionRoot } from '@devtools/plugin-home';
...
Let's update the route for "Home" in the Devtools sidebar to point to the new homepage. We'll also add a Sidebar item to quickly open Catalog.
...
The code for the Devtools sidebar is most likely inside your [`packages/app/src/components/Root/Root.tsx`](https://github.com/khulnasoft/devtools/blob/master/packages/app/src/components/Root/Root.tsx).
...
There is a default homepage template ([storybook link](https://devtools.khulnasoft.com/storybook/?path=/story/plugins-home-templates--default-template)) which we will use to set up our homepage. Checkout the [blog post announcement](https://devtools.khulnasoft.com/blog/2022/01/25/devtools-homepage-templates) about the Devtools homepage templates for more information.
...
[collection of Homepage components](https://devtools.khulnasoft.com/storybook?path=/story/plugins-home-components)
in storybook. If you don't find a component that suits your needs but want to
contribute, check the
[Contributing documentation](https://github.com/khulnasoft/devtools/blob/master/plugins/home/README.md#contributing).

> If you want to use one of the available homepage templates you can find the
> [templates](https://devtools.khulnasoft.com/storybook/?path=/story/plugins-home-templates)
...
import { HomePageCompanyLogo } from '@devtools/plugin-home';
