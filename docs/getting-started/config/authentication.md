...
Let's restart Devtools from the terminal once more, by stopping it with `Ctrl+C`, and starting it with `yarn dev`. You should now be able to log into Devtools and see items in your Catalog.
