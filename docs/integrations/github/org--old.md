...
to `@devtools/plugin-catalog-backend-module-github` to your backend package.
...
import { GithubOrgEntityProvider } from '@devtools/plugin-catalog-backend-module-github';
...
If Devtools is configured to use GitHub Apps authentication you must grant
...
import { GithubOrgReaderProcessor } from '@devtools/plugin-catalog-backend-module-github';
