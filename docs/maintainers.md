...
In addition to the [publicly-documented commands](https://github.com/khulnasoft/devtools#available-commands), the following commands are aimed at DevDocs maintainers:
...
git clone https://github.com/khulnasoft/devtools-nginx-config.git /etc/nginx
...
To reach out, please ping [@khulnasoft/devtools](https://github.com/orgs/freeCodeCamp/teams/devdocs).

Interested in helping maintain DevDocs? Come talk to us on [Discord](https://discord.gg/PRyKn3Vbay) :)

In addition, we appreciate the major contributions made by [these great people](https://github.com/khulnasoft/devtools/graphs/contributors).
