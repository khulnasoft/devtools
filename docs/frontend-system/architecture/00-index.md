...
Regardless of whether you are setting up your own devtools instance,
...
This is the app instance itself that you create and use as the root of your Devtools frontend application. It does not have any direct functionality in and of itself, but is simply responsible for wiring things together.
