...
Devtools catalog. This allows us to build specific plugins around them.

## Decision

Devtools should eventually support the following core entities:
...
the Devtools catalog. This can later be extended to APIs, Resources and other
...
APIs are a first class citizen in the Devtools model and the primary way to
...
We will continue fleshing out support for the Component entity in the Devtools
catalog.
