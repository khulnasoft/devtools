...
## Streamlining Custom Action Creation with Devtools CLI

The creation of custom actions in Devtools has never been easier thanks to the Devtools CLI. This tool streamlines the setup process, allowing you to focus on your actions' unique functionality.

Start by using the `yarn devtools-cli new` command to generate a scaffolder module. This command sets up the necessary boilerplate code, providing a smooth start:

```
$ yarn devtools-cli new
...
> scaffolder-module - An module exporting custom actions for @devtools/plugin-scaffolder-backend
```

You can find a [list](../../tooling/cli/03-commands.md) of all commands provided by the Devtools CLI.
...
[built-in actions](https://github.com/khulnasoft/devtools/blob/master/plugins/scaffolder-backend/src/scaffolder/actions/builtin)
for reference.
...
```ts title="With JSON Schema"
import { TemplateExample } from '@devtools/plugin-scaffolder-node';
...
- `ctx.checkpoint` - _Experimental_ allows to
  implement [idempotency of the actions](https://github.com/khulnasoft/devtools/tree/master/beps/0004-scaffolder-task-idempotency)
...
```ts
import { createBuiltinActions } from '@devtools/plugin-scaffolder-backend';
...
Here is a list of Open Source custom actions that you can add to your Devtools
scaffolder backend:

| Name                     | Package                                                                                                                                         | Owner                                                        |
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| Yeoman                   | [plugin-scaffolder-backend-module-yeoman](https://www.npmjs.com/package/@devtools/plugin-scaffolder-backend-module-yeoman)                     | [Devtools](https://devtools.khulnasoft.com)                            |
| Cookiecutter             | [plugin-scaffolder-backend-module-cookiecutter](https://www.npmjs.com/package/@devtools/plugin-scaffolder-backend-module-cookiecutter)         | [Devtools](https://devtools.khulnasoft.com)                            |
| Rails                    | [plugin-scaffolder-backend-module-rails](https://www.npmjs.com/package/@devtools/plugin-scaffolder-backend-module-rails)                       | [Devtools](https://devtools.khulnasoft.com)                            |
...
| Scaffolder Git Actions   | [plugin-scaffolder-git-actions](https://www.npmjs.com/package/@mdude2314/devtools-plugin-scaffolder-git-actions)                               | [Drew Hill](https://github.com/arhill05)                     |
...
| JSON Merge Actions       | [plugin-scaffolder-json-merge-actions](https://www.npmjs.com/package/@mdude2314/devtools-plugin-scaffolder-json-merge-actions)                 | [Drew Hill](https://github.com/arhill05)                     |
| NPM Actions              | [plugin-scaffolder-npm-actions](https://www.npmjs.com/package/@mdude2314/devtools-plugin-scaffolder-npm-actions)                               | [Drew Hill](https://github.com/arhill05)                     |
| Slack Actions            | [plugin-scaffolder-backend-module-slack](https://www.npmjs.com/package/@mdude2314/devtools-plugin-scaffolder-backend-module-slack)             | [Drew Hill](https://github.com/arhill05)                     |
| Microsoft Teams Actions  | [plugin-scaffolder-backend-module-ms-teams](https://www.npmjs.com/package/@grvpandey11/devtools-plugin-scaffolder-backend-module-ms-teams)     | [Gaurav Pandey](https://github.com/grvpandey11)              |
