...
and resources leads to a better Devtools experience.

_This description originates from
[this RFC](https://github.com/khulnasoft/devtools/issues/390). Note that some of
the concepts are not yet supported in Devtools._

## Core Entities

We model software in the Devtools catalogue using these three core entities
...
Devtools model and the primary way to discover existing functionality in the
ecosystem.
...
going to be the primary way interaction between components, Devtools supports
