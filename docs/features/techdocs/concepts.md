...
title: Concepts
# prettier-ignore
description: Documentation on concepts that are introduced with Spotify's docs-like-code solution in Devtools
---
...
Storage and Local Filesystem. You can configure them in your Devtools app.
...
However any logic that satisfies the Build Strategy interface can be implemented, using the Devtools
...
[TechDocs Core](https://github.com/khulnasoft/mkdocs-techdocs-core)
...
[TechDocs CLI](https://github.com/khulnasoft/techdocs-cli)
...
sites with the Devtools UI.

[TechDocs Reader](https://github.com/khulnasoft/devtools/blob/master/plugins/techdocs/src/reader/README.md)
...
[Transformers API docs](https://github.com/khulnasoft/devtools/blob/master/plugins/techdocs/src/reader/README.md)

## TechDocs Addons

Addons (introduced in Devtools v1.2) are client-side, React-based extensions
