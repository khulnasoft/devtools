...
[techdocs-container](https://github.com/khulnasoft/techdocs-container) is using
the MkDocs [Material Theme](https://github.com/squidfunk/mkdocs-material).

#### What is the mkdocs-techdocs-core plugin?

The [mkdocs-techdocs-core](https://github.com/khulnasoft/mkdocs-techdocs-core)
...
#### What should be the value of `devtools.khulnasoft.com/techdocs-ref` when using external build and storage?

The value of
[`devtools.khulnasoft.com/techdocs-ref`](../software-catalog/well-known-annotations.md#devtoolsiotechdocs-ref)
...
`catalog-info.yaml`) for Devtools to know that TechDocs is enabled for the
entity.
