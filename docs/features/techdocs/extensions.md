...
- `techdocsPreparerExtensionPoint`
  - Register a custom docs [PreparerBase extension](https://devtools.khulnasoft.com/docs/reference/plugin-techdocs-node.preparerbase/)
...
- `techdocsBuildsExtensionPoint`
  ...
  - Allows overriding the [DocsBuildStrategy](https://devtools.khulnasoft.com/docs/reference/plugin-techdocs-node.docsbuildstrategy/)
- `techdocsPublisherExtensionPoint`
  - Register a custom docs publisher
- `techdocsGeneratorExtensionPoint`
  - Register a custom [TechdocsGenerator](https://devtools.khulnasoft.com/docs/reference/plugin-techdocs-node.techdocsgenerator/)

Extension points are exported from `@devtools/plugin-techdocs-backend`.
...
import { techdocsBuildsExtensionPoint } from '@devtools/plugin-techdocs-backend';
