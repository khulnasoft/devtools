...
Using the `app-config.yaml` in the Devtools app, you can configure TechDocs
...
techdocs:
  ...
  generator:
    ...
    # You want to change this to 'local' if you are running Devtools using your own custom Docker setup and want to avoid running
    # into Docker in Docker situation. Read more here
    # https://devtools.khulnasoft.com/docs/features/techdocs/getting-started/#disabling-docker-in-docker-situation-optional
  ...
  # Read more about the "Basic" and "Recommended" setups here https://devtools.khulnasoft.com/docs/features/techdocs/architecture
  # Read more about build strategies here: https://devtools.khulnasoft.com/docs/features/techdocs/concepts#techdocs-build-strategy
  ...
  publisher:
    ...
    awsS3:
      ...
      # https://www.npmjs.com/package/@devtools/integration-aws-node
