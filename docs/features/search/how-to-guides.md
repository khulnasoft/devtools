...
[SearchApi](https://github.com/khulnasoft/devtools/blob/db2666b980853c281b8fe77905d7639c5d255f13/plugins/search/src/apis.ts#L35),
...
1. Implement the `SearchApi`
   [interface](https://github.com/khulnasoft/devtools/blob/db2666b980853c281b8fe77905d7639c5d255f13/plugins/search/src/apis.ts#L31)
...
- Entities of kind `Location`, which are often not useful to Devtools users.
...
provided by `@devtools/plugin-catalog-backend` offers some configuration too!
...
how highlighted terms look you can follow Devtools's guide on how to
[Customize the look-and-feel of your App](https://devtools.khulnasoft.com/docs/getting-started/app-custom-theme)
...
export const myLightTheme: UnifiedTheme = createUnifiedTheme({
  ...
  components: {
    ...
    DevtoolsHighlightedSearchResultText: {
      styleOverrides: {
        highlight: {
          color: 'inherit',
...
const app : DevtoolsApp = createApp({
  ...
  themes: [{
    id: 'my-light-theme',
    title: 'Light Theme',
...
import { createSearchResultListItemExtension } from '@devtools/plugin-search-react';
...
For more details, see the [createSearchResultListItemExtension](https://devtools.khulnasoft.com/docs/reference/plugin-search-react.createsearchresultlistitemextension) API reference.
...
import { SearchBar, SearchResult } from '@devtools/plugin-search-react';

// Your search result item extension
import { YourSearchResultListItem } from '@devtools/your-plugin';

// Extensions provided by other plugin developers
import { ToolSearchResultListItem } from '@devtools/plugin-explore';
...
import { DocsIcon, CatalogIcon } from '@devtools/core-components';
import { SearchBar, SearchResult } from '@devtools/plugin-search-react';
...
There are other more specific search results layout components that also accept result item extensions, check their documentation: [SearchResultList](https://devtools.khulnasoft.com/storybook/?path=/story/plugins-search-searchresultlist--with-result-item-extensions) and [SearchResultGroup](https://devtools.khulnasoft.com/storybook/?path=/story/plugins-search-searchresultgroup--with-result-item-extensions).
