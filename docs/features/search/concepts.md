...
description: Documentation on Devtools Search Concepts
---

Devtools Search lets you find the right information you are looking for in the
Devtools ecosystem.
...
between your Devtools instance and a Search Engine of your choice. More
...
Out of the box, Devtools Search comes pre-packaged with an in-memory search
...
factories which you can use out-of-the-box to start searching across Devtools
quickly.
...
search experience in your Devtools instance.
...
There are many ways a search index could be built and maintained, but Devtools
...
Search pages are very custom things. Not every Devtools instance will want the
...
page component defined in your Devtools App.
