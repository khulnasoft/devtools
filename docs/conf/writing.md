---
id: writing
title: Writing Devtools Configuration Files
description: Documentation on Writing Devtools Configuration Files
---
...
the rest of the Devtools application.

The particular configuration that is available to each Devtools app depends on
...
picked up by the serve tasks of `@devtools/cli` for local development, and are
...
integrations:
  github:
    - host: github.com
      apps:
        - $include: secrets.${DEVTOOLS_ENVIRONMENT}.yaml
```
