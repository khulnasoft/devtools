...
See the [`docs` folder](https://github.com/khulnasoft/devtools/tree/devdocs/docs) to learn how to add new documentations.
...
If the latest [documentation versions report](https://github.com/khulnasoft/devtools/issues?utf8=%E2%9C%93&q=Documentation+versions+report+is%3Aissue+author%3Adevdocs-bot+sort%3Acreated-desc) wrongly shows a documentation to be up-to-date, please open an issue or a PR to fix it.
