...
This file describes the various style and design conventions that are used in the Devtools main repository. While you may choose to use these conventions in your own Devtools projects, it is not required.
...
1. Rely on `@devtools/errors` for custom error types.
   ```ts
