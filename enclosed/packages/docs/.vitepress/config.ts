...
const createAbsoluteUrl = (path: string) => `https://enclosed.khulnasoft.com/${path.replace(/(^\/$)/g, '')}`;
...
export default defineConfig({
  ...
  head: [
    ['meta', { name: 'author', content: 'Md Sulaiman' }],
    ...
    ['meta', { name: 'og:url', content: 'https://enclosed.khulnasoft.com' }],
  ...
  themeConfig: {
    ...
    nav: [
      { text: 'Enclosed App', link: 'https://enclosed.khulnasoft.com' },
    ],
    ...
    footer: {
      copyright: 'Copyright © 2024-present Md Sulaiman',
    },

    editLink: {
      pattern: 'https://github.com/khulnasoft/devtools/edit/main/packages/docs/src/:path',
      text: 'Edit this page on GitHub',
    },

    socialLinks: [
      { icon: { svg: githubIcon }, link: 'https://github.com/khulnasoft/devtools', ariaLabel: 'GitHub' },
