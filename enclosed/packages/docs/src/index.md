...
Ready to start using Enclosed? You can [try it out online](https://enclosed.khulnasoft.com) or [self-host](./self-hosting/docker) your instance for maximum control. Dive into our documentation to learn more about how Enclosed works and how you can take full advantage of its features.
