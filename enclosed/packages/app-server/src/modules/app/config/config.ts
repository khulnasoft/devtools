...
export const configDefinition = {
  ...
  authentication: {
    ...
    authUsers: {
      doc: 'The list of users allowed to authenticate. Comma-separated list of email and bcrypt password hash, like: `email1:passwordHash1,email2:passwordHash2`. Easily generate the value for this env variable here: https://devtools.khulnasoft.com/enclosed-docs/self-hosting/users-authentication-key-generator',
      schema: z
        .string()
        .transform((value) => {
          if (!value) {
