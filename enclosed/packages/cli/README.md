...
This package contains the CLI for [Enclosed](https://enclosed.khulnasoft.com), an open-source project that aims to provide a simple and secure way to share e2e encrypted notes.
