...
# Build the apps
RUN pnpm --filter @khulnasoft.com/crypto run build && \
    pnpm --filter @khulnasoft.com/enclosed-lib run build && \
    pnpm --filter @khulnasoft.com/enclosed-client run build && \
    pnpm --filter @khulnasoft.com/enclosed-server run build:node
