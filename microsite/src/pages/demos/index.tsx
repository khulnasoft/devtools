  ...
  const demoItems: IDemoItem[] = [
    {
      ...
      content: (
        <>
          <p>
            Watch the videos below to get an introduction to Devtools and to
            see how we use different plugins to customize{' '}
            <Link to="https://engineering.atspotify.com/2020/04/21/how-we-use-devtools-at-spotify/">
              our internal version of Devtools at Spotify
            </Link>
          </p>
          <p>
            To see how other companies have already started using Devtools,
            ...
            more, join our{' '}
            <Link to="https://github.com/khulnasoft/community">
              Community Sessions
            </Link>
          </p>
          <p>
            To explore the UI and basic features of Devtools firsthand, go to:{' '}
            <Link to="https://demo.devtools.khulnasoft.com">demo.devtools.khulnasoft.com</Link>. (Tip:{' '}
    ...
    },
    {
      ...
      content:
        'Devtools is an open source framework for building developer portals. We’ve been using our homegrown version at Spotify for years — so it’s already packed with features. (We have over 120 internal plugins, built by 60 different teams.) In this live demo recording, Stefan Ålund, product manager for Devtools, tells the origin story of Devtools and gives you a tour of how we use it here at Spotify.',
      ...
      content: (
        <>
          <p>
            ...
            <Link to="https://devtools.khulnasoft.com/plugins">Cost Insights plugin</Link>{' '}
            for Devtools, managing cloud costs becomes just another part of an
            ...
            <Link to="https://devtools.khulnasoft.com/blog/2020/10/22/cost-insights-plugin">
      ...
      content: (
        <>
          <p>
            ...
            one can ever find it. Devtools follows a “docs like code” approach:
            ...
            <Link to="https://devtools.khulnasoft.com/blog/2020/09/08/announcing-tech-docs">
              TechDocs
            </Link>
            .
          </p>
    ...
    },
    {
      ...
      content:
        'Instead of manually updating a spreadsheet, what if you had a beautiful dashboard that could give you an instant, interactive picture of your entire org’s tech stack? That’s how we do it at Spotify. With our Tech Insights plugin for Devtools, anyone at Spotify can see which version of which software anyone else at Spotify is using — and a whole a lot more. From managing migrations to fighting tech entropy, Devtools makes managing our tech health actually kind of pleasant.',
      actionItemLink:
    ...
    },
    {
      ...
      content:
        'You’re a Spotify engineer about to build a new microservice (or any component) using Spring Boot. Where do you start? Search for a quick start guide online? Create an empty repo on GitHub? Copy and paste an old project? Nope. Just go to Devtools, and you’ll be up and running in two minutes — with a “Hello World” app, CI, and documentation all automatically set up and configured in a standardized way.',
    ...
    },
    {
      ...
      content:
        'We manage a lot of data pipelines (also known as workflows) here at Spotify. So, of course, we made a great workflows plugin for our version of Devtools. All our workflow tools — including a scheduler, log inspector, data lineage graph, and configurable alerts — are integrated into one simple interface.',
