...
const Community = () => {
  ...
  const communityListItems: ICollectionItem[] = [
    {
      ...
      label: 'Discord',
      link: 'https://discord.gg/devtools-687207715902193673',
    },
    {
      content: 'Get into contributing with the',
      label: 'Good First Issues',
      link: 'https://github.com/khulnasoft/devtools/contribute',
    },
    {
      content: 'Subscribe to the',
      label: 'Community newsletter',
      link: 'https://info.devtools.spotify.com/newsletter_subscribe',
    },
  ];
  ...
  const officialInitiatives: ICollectionItem[] = [
    {
      ...
      link: 'https://github.com/khulnasoft/community/tree/main/devtools-community-sessions#devtools-community-sessions',
      label: 'Join a session',
    },
    {
      title: 'Newsletter',
      content:
        "The official monthly Devtools newsletter. Don't miss the latest news from your favorite project!",
      link: 'https://info.devtools.spotify.com/newsletter_subscribe',
      label: 'Subscribe',
    },
  ];
  ...
  const trainingNCertifications: ICollectionItem[] = [
    {
      title: 'Introduction to Devtools: Developer Portals Made Easy (LFS142x)',
      content:
        'This is a course produced and curated by the Linux Foundation. This course introduces you to Devtools and how to get started with the project.',
      link: 'https://training.linuxfoundation.org/training/introduction-to-devtools-developer-portals-made-easy-lfs142x/',
      label: 'Learn more',
    },
  ];
  ...
  const partners: { name: string; url: string; logo: string }[] = [
    {
      ...
      url: 'https://frontside.com/devtools/',
    ...
    {
      name: 'ThoughtWorks',
      url: 'https://www.thoughtworks.com/about-us/partnerships/technology/devtools-by-spotify',
    ...
    {
      name: 'StatusNeo',
      url: 'https://statusneo.com/devtools',
      ...
      <div className={clsx(communityStyles.communityPage)}>
        <BannerSection diagonalBottomBorder greyBackground>
          <BannerSectionGrid>
            <ContentBlock
              ...
              title={<h1>Devtools Community</h1>}
            >
              Join the vibrant community around Devtools through social media
        ...
        <BannerSection diagonalBorder greenBottomGradientBackground>
          <BannerSectionGrid
            header={
              <>
                <h2 className="text--primary">Offical Devtools initiatives</h2>
