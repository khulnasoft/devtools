      ...
      <div className={homeStyles.homePage}>
        <BannerSection diagonalBottomBorder greyBackground>
                ...
                {!hiddenNewsletterBanner && (
                  ...
                  >
                    <div className="text--left bannerContent">
                      🗞️ Want to stay up to date with Devtools? Sign up for our{' '}
                      <Link
                        to="https://info.devtools.spotify.com/newsletter_subscribe"
          ...
          >
            <ContentBlock
              ...
              actionButtons={[
                {
                  link: 'https://github.com/khulnasoft/devtools#getting-started',
                  label: 'GITHUB',
                },
                {
                  link: 'https://info.devtools.spotify.com/office-hours',
                  label: 'OFFICE HOURS',
                },
              ]}
            >
              Powered by a centralized software catalog, Devtools restores
            ...
            <div className={homeStyles.svgContainer}>
              ...
              <img
                ...
                src={`${siteConfig.baseUrl}animations/devtools-logos-hero-8.gif`}
                alt="Animated Devtools Logo"
              />
            </div>
          </BannerSectionGrid>
        </BannerSection>
        ...
        <BannerSection diagonalBorder>
          <BannerSectionGrid>
            <ContentBlock
              ...
              topImgSrc={`${siteConfig.baseUrl}animations/devtools-speed-paradox-7.gif`}
            >
            ...
            <ContentBlock
              ...
              topImgSrc={`${siteConfig.baseUrl}animations/devtools-standards-paradox-4.gif`}
            >
              By centralizing services and standardizing your tooling, Devtools
        ...
        <BannerSection diagonalBorder greenGradientBackground>
          <div className={homeStyles.catalogContainer}>
            <div className="catalogTitle">
              <img
                src={`${siteConfig.baseUrl}animations/devtools-software-catalog-icon-1.gif`}
                alt="Software Catalog Planet GIF"
              />

              <h2 className="text--primary">Devtools Software Catalog</h2>
            ...
            <ContentBlock
              ...
              hasBulletLine
            >
              Devtools makes it easy for one team to manage 10 services — and
            ...
            <ContentBlock title="Metadata on tap" hasBulletLine>
              All that information can be shared with plugins inside Devtools
              to enable other management features, like resource monitoring and
              testing
            </ContentBlock>

            <ContentBlock title="Not just services" hasBulletLine>
              Libraries, websites, ML models — you name it, Devtools knows all
        ...
        <BannerSection diagonalBorder greenCallToActionGradientBackground>
          <div className="padding--lg text--center">
            ...
            <Link
              to="https://devtools.khulnasoft.com/docs/features/software-catalog/"
        ...
        <BannerSection diagonalBorder greenBottomGradientBackground>
          <div className={homeStyles.softwareTemplatesContainer}>
            <div className="softwareTemplatesTitle">
              <img
                src={`${siteConfig.baseUrl}animations/devtools-software-templates-icon-5.gif`}
                alt="Software Templates Rocket GIF"
              />

              <h2 className="text--primary">Devtools Software Templates</h2>
        ...
        <BannerSection diagonalBorder greenCallToActionGradientBackground>
          <div className="padding--lg text--center">
            ...
            <Link
              to="https://devtools.khulnasoft.com/docs/features/software-templates"
              className="button button--secondary"
            >
              CONTRIBUTE
            </Link>
        ...
        <BannerSection diagonalBorder greenBottomGradientBackground>
          <div className={homeStyles.softwareTemplatesContainer}>
            <div className="softwareTemplatesTitle">
              <img
                src={`${siteConfig.baseUrl}animations/devtools-techdocs-icon-1.gif`}
                alt="Devtools TechDocs File Copy GIF"
              />

              <h2 className="text--primary">Devtools TechDocs</h2>
            ...
            <picture className="softwareTemplatesImg">
              ...
              <img
                ...
                alt="Devtools TechDocs Markdown to HTML"
              />
            </picture>

            <ContentBlock title="Free documentation" hasBulletLine>
              Whenever you use a Devtools Software Template, your project
            ...
            <ContentBlock title="Easy to find and use" hasBulletLine>
              Since all your documentation is in Devtools, finding any TechDoc
        ...
        <BannerSection diagonalBorder greenCallToActionGradientBackground>
          <div className="padding--lg text--center">
            ...
            <Link
              to="https://devtools.khulnasoft.com/docs/features/techdocs/"
              className="button button--secondary"
            >
              DOCS
            </Link>
        ...
        <BannerSection diagonalBorder greenGradientBackground>
          <div className={homeStyles.softwareTemplatesContainer}>
            <div className="softwareTemplatesTitle">
              <img
                src={`${siteConfig.baseUrl}animations/devtools-search-platform-icon-1.gif`}
                alt="Search Platform Telescope GIF"
              />

              <h2 className="text--primary">Devtools Search Platform</h2>
            ...
            <ContentBlock title="Way more than a text box" hasBulletLine>
              Devtools Search more than just a box you type questions into —
        ...
        <BannerSection diagonalBorder greenCallToActionGradientBackground>
          <div className="padding--lg text--center">
            <h1>Learn more about Devtools Search</h1>

            <Link
              to="https://devtools.khulnasoft.com/docs/features/search/"
              className="button button--secondary"
            >
              READ
            </Link>
        ...
        <BannerSection diagonalBorder greenBottomGradientBackground>
          <BannerSectionGrid
            ...
            header={
              <>
                <img
                  src={`${siteConfig.baseUrl}animations/devtools-kubernetes-icon-1.gif`}
                  alt="Devtools Kubernetes Flag GIF"
                />

                <h2 className="text--primary">Devtools Kubernetes</h2>
          ...
          >
            <ContentBlock
              ...
              hasBulletLine
            >
              Devtools features the first Kubernetes monitoring tool designed
            ...
            <ContentBlock title="Pick a cloud, any cloud" hasBulletLine>
              Since Devtools uses the Kubernetes API, it's cloud agnostic — so
        ...
        <BannerSection diagonalBorder greenCallToActionGradientBackground>
          <div className="padding--lg text--center">
            ...
            <Link
              to="https://devtools.khulnasoft.com/blog/2021/01/12/new-devtools-feature-kubernetes-for-service-owners"
              className="button button--secondary"
            >
              READ
            </Link>
        ...
        <BannerSection diagonalBorder greenBottomGradientBackground>
          <div className={homeStyles.softwareTemplatesContainer}>
            <div className="softwareTemplatesTitle">
              <img
                src={`${siteConfig.baseUrl}animations/devtools-plugin-icon-2.gif`}
                alt="Plugins Building Blocks GIF"
              />

              <h2 className="text--primary">
                Customize Devtools with plugins
              </h2>
            ...
            <ContentBlock title="Add functionality" hasBulletLine>
              ...
              <Link to="https://devtools.khulnasoft.com/blog/2020/04/06/lighthouse-plugin">
                Lighthouse{' '}
              </Link>
              plugin. Wondering about recommended frameworks? Add the{' '}
              <Link to="https://devtools.khulnasoft.com/blog/2020/05/14/tech-radar-plugin">
                Tech Radar{' '}
              </Link>
              plugin.
            </ContentBlock>
            ...
            >
              ...
              Devtools to be a perfect fit for your infrastructure
            </ContentBlock>

            <ContentBlock title="Share with the community" hasBulletLine>
              Building <Link to="/plugins">open source plugins</Link>{' '}
              contributes to the entire Devtools ecosystem, which benefits
              everyone
            </ContentBlock>
          </div>
        </BannerSection>
