...
![Devtools in 2021: 75+ public adopters, 500+ contributors, almost 2,000 forks, 9,000+ contributions, 4,000+ Discord members](assets/21-12-20/devtools-wrapped-2021.png)

What a year 2021 has been for the Devtools project and community. As the year comes to a close, we can look back at some of the happenings, the successes, and welcome all the newcomers to our growing community.
...
In 2021 we’ve seen the project and community grow in every dimension, reaching over 75 public adopters, over 500 contributors from around the world all bringing new ideas and perspectives. We’ve had so many of you sharing and demoing your hard work in our monthly community sessions, added new plugins, built new features and really started to see Devtools have an impact for engineering teams across so many of our users.
...
![Accelerated growth of Public Devtools Adopters, from July 2020–December 2021.](assets/21-12-20/public-devtools-adopters-2021.png)

In January, Devtools had 17 public adopters. By September, [we had 50][50]. And the curve only got steeper from there.
...
### Where in the world is the Devtools community?
...
Picking up from the end of 2020, the video shows every single contribution to the Devtools source code over this past year. The visualization was built using [Gource.io][gource]:
...
We reached [50+ plugins][plugins] built by the community this year, including official plugins (**Snyk**, **FireHydrant**), highly requested plugins (**PagerDuty**, **Prometheus**), and plugins based on new ideas and functionality (**XCMetrics**, **[Tech Insights][techrfc]**) — all tailor-made for Devtools.

### In the spotlight

This year Devtools was center stage at both community-organized events and at major conferences.

- **New (and [expanded][09]) Community Sessions**
- **Devtools Users Unconference + [Open Mic][openmic]**
- **KubeCon + CloudNativeCon [Europe][europe] & [North America][na]**
- **GitHub Universe 2021 [Keynote][day2]**

Find more talks, podcasts, blog posts, and Devtools in the news [here][news].

## Goodbye, 2021. Hello, 2022!

Lastly, thanks to everyone in the global Devtools community who contributed to the open source project in 2021.

This was the first year Spotify hosted [Devtools Community Sessions][meetups], and it’s been a great source of inspiration, motivation, and joy getting to know all the people behind the contributions. We look forward to seeing all your faces again in 2022 — and hopefully many new ones as well.

Until then, [grab this Devtools Zoom background][zoom] to use at the next Community Session.

![Devtools Zoom Background](assets/21-12-20/Devtools-background-02-2021.png)

See you then! Happy holidays from everyone on the Devtools team at Spotify!

[metrics]: https://devtools.spotify.com/blog/measuring-devtools-proof-of-value-at-expedia/
[10]: https://devtools.spotify.com/blog/community-session/10-box-and-spotify-paid-plugins/
[dazn]: https://devtools.spotify.com/blog/adopter-spotlight/dazn/
[md]: https://github.com/khulnasoft/devtools/blob/master/ADOPTERS.md
[rugvip]: https://github.com/Rugvip
[50]: https://devtools.khulnasoft.com/blog/2021/09/30/50-public-adopters
[gource]: https://gource.io
[contributing]: https://github.com/khulnasoft/devtools/blob/master/CONTRIBUTING.md
[blam]: https://github.com/benjdlambert
[k8s]: https://github.com/khulnasoft/devtools/issues/2857
[search]: https://devtools.khulnasoft.com/blog/2021/06/24/announcing-devtools-search-platform
[home]: https://github.com/khulnasoft/devtools/blob/master/plugins/home/README.md
[auth]: https://devtools.spotify.com/blog/authorization-framework-rfc/
[scaffolder]: https://devtools.khulnasoft.com/blog/2021/07/26/software-templates-are-now-in-beta
[techdocs]: https://devtools.khulnasoft.com/blog/2021/09/16/the-techdocs-beta-has-landed
[api]: https://devtools.khulnasoft.com/docs/reference/
[cncf]: https://github.com/cncf/toc/pull/717
[plugins]: https://devtools.khulnasoft.com/plugins
[techrfc]: https://github.com/khulnasoft/devtools/issues/7576
[09]: https://devtools.spotify.com/blog/community-session/09-prometheus-homepage-templates/
[openmic]: https://devtools-openmic.com
[europe]: https://www.youtube.com/watch?v=aIURaocR5D8
[na]: https://devtools.spotify.com/blog/kubecon-na-2021/
[day2]: https://www.youtube.com/watch?v=7yQJlYvpoYs&t=269s
[news]: https://github.com/khulnasoft/community#newsletters
[meetups]: https://github.com/khulnasoft/community#meetups
