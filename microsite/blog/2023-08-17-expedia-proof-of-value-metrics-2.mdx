---
# prettier-ignore
title: "Expedia Group shares Devtools proof of value metrics 2.0"
author: Guillermo Manzo, Expedia Group
authorURL: https://www.linkedin.com/in/guillermomanzo
---

![devtools header](assets/2023-08-17/header.png)

_Editor's Note: In this post, Expedia Group provides a follow-up to their initial Q4 2021 [post on how they measure Devtools proof of value](https://devtools.spotify.com/blog/measuring-devtools-proof-of-value-at-expedia/).
We're grateful to the Expedia Group team for sharing their processes, revised proof of value metrics, and adaptations to their approach over time in hopes of providing a successful framework for the rest of the Devtools community._
...
In August 2020, we adopted Devtools to enhance our foundational platform capabilities and reduce developer friction in the process. Its framework proved scalable for us and as EG's platform evolved, so did our application of Devtools. Since our [initial share about our Devtools deployment](https://devtools.spotify.com/blog/measuring-devtools-proof-of-value-at-expedia/), we've continued to follow our process of:
...
In the diagram below, you can see how we distilled these processes into Devtools PoV metrics.

![devtools pov metrics](assets/2023-08-17/table.png)

To ground ourselves in the evolving developer and Devtools landscape at Expedia Group, we constantly ask ourselves, "How can we continue to show the value of Devtools to our customers and the Developer Community?" To fully answer this question, we adapted our initial proof of value metrics to reinforce our alignment to the current landscape of the Expedia Group developer journey.

## Expedia Group proof of value metrics 2.0

We are excited to share our PoV metrics because it affirms our investment in Devtools for Expedia Group's Devtools users and provides a compelling metrics-based answer on why more organizations should consider adopting it.

As our Devtools application matured, we updated our PoV metrics and aligned our 2023 roadmap to reflect these changes. Below, we highlight key wins from 2022 and outline our long-term vision for each metric.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>
            15%+ of internal developer tools are integrated within Devtools,
            reducing the amount of context-switching needed
          </li>
          <li>
            4000+ unique users using Devtools for ~20 min on average a day.
          </li>
        </ul>
      </td>
      <td>
        <ul>
          <li>
            End-to-end integration with EG paved road tools and Devtools to
            support increased developer productivity
          </li>
          <li>
            Drive broader adoption to have all EG employees using Devtools to
    ...
    <tr>
      ...
      <td>
        Intuitive search capabilities to surface relevant Devtools content like
        TechDocs, entities, tools, etc.
      </td>
      <td>
        <ul>
          <li>Enabled global search functionality throughout Devtools</li>
          <li>
            <p>Contributed to the open source Devtools Search platform</p>
          </li>
        </ul>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>
            All Devtools entities leveraging TechDocs to enable a centralized
          ...
          <li>
            ...
            and drive usability of documentation on Devtools
          </li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>Enhance Devtools through community engagement</td>
      <td>
        <ul>
          <li>
            Diverse contributions to Devtools open source focused on search and
            discovery - 10+
          </li>
      ...
      <td>
        <ul>
          <li>
            Continuous contributions to open-source Devtools, focused on plugin
          ...
          <li>
            ...
            and long-term confidence in adopting Devtools
          </li>
          <li>
            Event participation and storytelling around EG's Devtools journey
          </li>
        </ul>
      </td>
    </tr>
...
Measuring the value of Devtools will vary depending on your organization's needs and priorities. As an early adopter of Devtools, we hope the Expedia Group PoV metrics provide a helpful framework for understanding how Devtools can be used to improve developer productivity, collaboration, and knowledge sharing.

We look forward to sharing future updates with the community as we continue to embrace a continuous improvement approach to Devtools. If you missed it, you can read about where we started in our [initial proof of value metrics](https://devtools.spotify.com/blog/measuring-devtools-proof-of-value-at-expedia/) back in 2021.
