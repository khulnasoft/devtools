...
![devtools header](assets/22-05-13/techdocs-addon-header.gif)
...
[TechDocs](https://devtools.khulnasoft.com/docs/features/techdocs/) is a centralized platform for publishing, viewing, and discovering technical documentation across an entire organization. It's a solid foundation! But TechDocs doesn't solve higher order documentation needs on its own such as: How do you create and reinforce a culture of documentation? How do you build trust in the quality of technical documentation?

To address this need, we’re proud to introduce the [TechDocs Addon Framework](https://github.com/khulnasoft/devtools/issues/9636) — a way for us all to contribute and share additional features, TechDocs Addons, on top of the base docs-like-code experience. Using TechDocs Addons, you can customize the TechDocs experience to address some of these higher order needs.
...
- [Installing and using Addons](https://devtools.khulnasoft.com/docs/features/techdocs/addons#installing-and-using-addons): add an existing TechDocs Addon to your Devtools App
- [Creating an Addon](https://devtools.khulnasoft.com/docs/features/techdocs/addons#creating-an-addon): contribute a new Addon for others to use
- [TechDocs Addon page](https://devtools.khulnasoft.com/docs/features/techdocs/addons): read everything you need to know about TechDocs Addons
...
This next step is a bit more tricky and we would like to work with you all to make it happen. Take a look at [this issue](https://github.com/khulnasoft/devtools/issues/11110) in the GitHub repo, let us know what you think, and feel free to get involved.
