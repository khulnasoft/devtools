---
title: Introducing Tech Radar for Devtools
...
![image illustrating the Tech Radar plugin for Devtools](assets/5/lead.png)
...
## Using the Tech Radar in Devtools

To learn about how you can bring the Tech Radar to your Devtools installation, check out [the plugin README on GitHub][tech radar plugin].

## A personal note

I want to thank both the Devtools team and Spotify. Firstly, I've been working with our internal version of Devtools for over a year, and the developer experience since open sourcing has been even more of a joy to work with. Secondly, the 10% hack time that Spotify generously provides to all engineers enabled me to open source the Tech Radar plugin.

Since open sourcing it, the community has shown great interest in yet another powerful use case of Devtools. There was also an enthusiastic open source contributor who volunteered to migrate the plugin to TypeScript and React Hooks [in just 29 minutes](https://github.com/khulnasoft/devtools/issues/661) of opening the issue!

I can't wait to see how others benefit from the Tech Radar in their organizations!

[lighthouse website audits]: https://devtools.khulnasoft.com/blog/2020/04/06/lighthouse-plugin
[tech radar plugin]: https://github.com/khulnasoft/community-plugins/tree/main/workspaces/tech-radar/plugins/tech-radar
