...
Okay, everyone. Time to move on from all the 2022 reflections, Top 10 lists, and Wrapped(s), and turn our gaze in the other direction — towards 2023. As the Devtools team moves into the new year, we find ourselves asking those perennial questions: How can we continue to grow and enhance the Devtools community? How can we improve the experience for those adopting Devtools? How can we give the best support to Devtools contributors?
...
- Work with us to drive a better experience for Devtools adopters

# Climb the contribution ladder

Truth be told, we’ve been wanting to grow the maintainer team for some time, and have had multiple requests from contributors and contributing organizations wanting to become maintainers. But, so far, we just haven’t managed to get anything off the ground. What we see is that becoming a maintainer is too hard and the current ownership model doesn’t work. In short, we need to update Devtools governance.
...
Read more and join the already rich discussion in [RFC: Updated Devtools Governance](https://github.com/khulnasoft/devtools/issues/15317) and [RFC: Devtools Enhancement Proposals](https://github.com/khulnasoft/devtools/issues/15318). The RFC will be open until 13/02/2023.
...
Throughout all stages of adopting Devtools in an organization — initial discovery, evaluation and POC, and scaling to the wider org — we have identified opportunities where we want to make the journey for Devtools adopters faster and smoother.
...
- Contribute to the pages and documentation on [devtools.khulnasoft.com](https://devtools.khulnasoft.com/docs/overview/what-is-devtools)
- Pay it forward by making code contributions even during your adoption journey (if you are on one)
- Join the [Adoption](https://github.com/khulnasoft/community/tree/main/sigs/sig-adoption?utm_campaign=Newsletters%20Sent&utm_medium=email&_hsmi=241130993&_hsenc=p2ANqtz-9CAxtT8JSeJZPh41o3ZnDBi0VBFpbL6fEqXInr9HHOFhU3JAo8HekKg1JzE5rhGP5zOaHcsYDd1YxJWNHw-eSk5mLWkA&utm_content=241130993&utm_source=hs_email) SIG
