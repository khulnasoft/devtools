...
![devtools header](assets/2023-07-08/banner.png)
...
# Understanding complex systems at Stash with Devtools
...
To consolidate application health data, simplify support and clarify ownership for those on development teams as well as for those in non-engineering roles, we implemented an instance of Devtools as an internal service catalog we call Elevate.

Utilizing Devtools as a framework, Elevate aims to improve quality and domain expertise for all things code and process at Stash. The key to accomplishing this goal is to leverage the processes and integrations we already use at Stash, but centralize and surface the data in a way that is digestible for engineers and non-engineers alike.
...
metadata:
  ...
  annotations:
    devtools.khulnasoft.com/kubernetes-namespace: your-service
