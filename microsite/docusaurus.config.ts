...
const devtoolsTheme = themes.vsDark;
devtoolsTheme.plain.backgroundColor = '#232323';
...
const config: Config = {
  title: 'Devtools Software Catalog and Developer Platform',
  tagline: 'An open source framework for building developer portals',
  url: 'https://devtools.khulnasoft.com',
  baseUrl: '/',
  ...
  customFields: {
    ...
    repoUrl: 'https://github.com/khulnasoft/devtools',
  },
  onBrokenLinks: 'log',
      ...
      /** @type {import('@docusaurus/preset-classic').Options} */
      {
        docs: {
          editUrl: ({ docPath }) => {
            ...
            return `https://github.com/khulnasoft/devtools/edit/master/docs/${docPath}`;
          },
          path: '../docs',
    ...
    ctx =>
      PatchedRedirectPlugin(ctx, {
        ...
        redirects: [
          {
            from: '/docs',
            to: '/docs/overview/what-is-devtools',
          },
          {
          ...
          {
            from: '/docs/getting-started/running-devtools-locally',
  ...
  themeConfig: {
    ...
    navbar: {
      logo: {
        alt: 'Devtools Software Catalog and Developer Platform',
        src: 'img/logo.svg',
      },
      items: [
        {
      ...
      links: [
        {
          items: [
            {
              html: `
                <a href="/" aria-label="Devtools Home">
          ...
          items: [
            {
              ...
              to: 'https://discord.gg/devtools-687207715902193673',
            },
            {
              label: 'Contributing',
              to: 'https://github.com/khulnasoft/devtools/blob/master/CONTRIBUTING.md',
            },
            {
              label: 'Adopting',
              to: 'https://devtools.spotify.com',
            },
            {
    ...
    algolia: {
      ...
      indexName: 'crawler_Devtools Docusaurus 2',
      appId: 'JCMFNHCHI8',
      searchParameters: {},
    },
    prism: {
