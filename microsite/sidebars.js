...
module.exports = {
  docs: {
    ...
    'Getting Started': [
      ...
      'getting-started/keeping-devtools-updated',
    ],
    'Core Features': [
      {
        type: 'category',
    ...
    Tutorials: [
      ...
      'tutorials/using-devtools-proxy-within-plugin',
